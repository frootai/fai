...
```bash
npx frootai install csharp-mcp-development
```
...
| Type | Name | Purpose |
|------|------|---------|
| Agent | `frootai-csharp-mcp-expert` | Csharp mcp expert specialist |
| Agent | `frootai-csharp-expert` | Csharp expert specialist |
| Instruction | `csharp-mcp-development` | Csharp mcp development standards |
| Instruction | `csharp-waf` | Csharp waf standards |
| Skill | `frootai-mcp-csharp-scaffold` | Mcp csharp scaffold capability |
| Skill | `frootai-mcp-csharp-generator` | Mcp csharp generator capability |
...
`csharp` `dotnet` `mcp` `aspnet` `sdk` `model-context-protocol` `tool-server`
...
2. Edit files in `plugins/csharp-mcp-development/`
