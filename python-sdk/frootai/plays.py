...
_PLAYS_DATA = [
    ...
    {"id": "04", "name": "Call Center Voice AI", "description": "Voice-enabled AI customer service with real-time speech-to-text, intent routing, and voice synthesis.", "complexity": "High", "status": "Skeleton", "layer": "O_ORCH", "infra": ["Communication Services", "AI Speech", "Azure OpenAI"], "tuning": ["speech_config", "voice_persona", "intent_routing"], "modules": ["O1"]},
    {"id": "05", "name": "IT Ticket Resolution", "description": "Auto-classify, route, and resolve IT tickets using LLM analysis and knowledge base lookup.", "complexity": "Medium", "status": "Skeleton", "layer": "O_OPS", "infra": ["Azure OpenAI", "Container Apps", "Logic Apps"], "tuning": ["classification_prompts", "routing_rules", "confidence_threshold"], "modules": ["O4", "O5"]},
    {"id": "06", "name": "Document Intelligence", "description": "Extract structured data from documents using Azure Document Intelligence + GPT-4o for complex reasoning.", "complexity": "Medium", "status": "Skeleton", "layer": "R", "infra": ["Document Intelligence", "Azure OpenAI", "Blob Storage"], "tuning": ["extraction_prompts", "field_schemas", "confidence_threshold"], "modules": ["R1"]},
    {"id": "07", "name": "Multi-Agent Service", "description": "Supervisor agent orchestrating specialist sub-agents with handoff protocols and shared state.", "complexity": "High", "status": "Skeleton", "layer": "O_ORCH", "infra": ["Container Apps", "Azure OpenAI", "Cosmos DB", "Dapr"], "tuning": ["supervisor_routing", "handoff_rules", "agent_capabilities"], "modules": ["O1", "O2", "O3"]},
    {"id": "08", "name": "Copilot Studio Bot", "description": "Low-code enterprise bot built with Copilot Studio, Dataverse knowledge, and Teams integration.", "complexity": "Low", "status": "Skeleton", "layer": "O_ORCH", "infra": ["Copilot Studio", "Dataverse", "Teams"], "tuning": ["topic_design", "knowledge_sources", "auth_config"], "modules": ["O1"]},
    {"id": "09", "name": "AI Search Portal", "description": "Enterprise search portal with semantic ranking, hybrid retrieval, and faceted navigation.", "complexity": "Medium", "status": "Skeleton", "layer": "R", "infra": ["AI Search", "App Service", "Log Analytics"], "tuning": ["hybrid_weights", "scoring_profiles", "semantic_config"], "modules": ["R1", "R2"]},
    {"id": "10", "name": "Content Moderation", "description": "AI Content Safety pipeline with configurable severity thresholds and custom blocklists.", "complexity": "Low", "status": "Skeleton", "layer": "O_OPS", "infra": ["Content Safety", "API Management"], "tuning": ["severity_levels", "blocklists", "custom_categories"], "modules": ["O5", "O6"]},
