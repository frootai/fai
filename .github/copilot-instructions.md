...
- **Distribution:** VS Code v2.0.0, MCP v3.5.0, Python SDK v4.0.0, Python MCP v3.5.0, Docker v3.5.0 — all synced with 100 plays + AI primitives + FAI Protocol
