---
description: "Root coding instructions for Visual Product Search (Play 88)"
applyTo: "**/*"
---

# Visual Product Search — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Visual Product Search solution play (Play 88). It implements a production-grade Visual Product Search system on Azure using the FAI Protocol for AI primitive unification.
