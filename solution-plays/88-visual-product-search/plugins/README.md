# Visual Product Search — Plugin Extensions

This folder contains optional plugin extensions for Visual Product Search.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 88-visual-product-search`
