...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Image-Based Discovery |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Image-Based Discovery |
...
```markdown
## Tuning Report — Visual Product Search
