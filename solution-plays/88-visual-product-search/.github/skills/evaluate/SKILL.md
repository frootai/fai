---
name: "evaluate"
description: "Evaluate Visual Product Search (Play 88) quality using Azure AI Evaluation SDK"
---

# Evaluate — Visual Product Search

## Overview
This skill runs the evaluation pipeline for the Visual Product Search solution play, measuring quality metrics against production thresholds.
