---
description: "Azure coding patterns and best practices for Visual Product Search"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Visual Product Search
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "88-visual-product-search")
    # ... processing logic
