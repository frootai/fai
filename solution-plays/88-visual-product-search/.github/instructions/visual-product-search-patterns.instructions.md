---
description: "Domain-specific coding patterns for Visual Product Search (Play 88)"
applyTo: "**/*.{py,ts,js}"
---

# Visual Product Search — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Visual Product Search architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Visual Product Search."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:88-visual-product-search:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
