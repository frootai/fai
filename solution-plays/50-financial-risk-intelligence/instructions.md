---
description: "Root coding instructions for Financial Risk Intelligence (Play 50)"
applyTo: "**/*"
---

# Financial Risk Intelligence — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Financial Risk Intelligence solution play (Play 50). It implements a production-grade Financial Risk Intelligence system on Azure using the FAI Protocol for AI primitive unification.
