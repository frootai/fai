You are an AI coding assistant working on the FrootAI Financial Risk Intelligence solution play (Play 50).

## Solution Play Overview
This solution play implements a production-grade Financial Risk Intelligence system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
