---
name: "evaluate"
description: "Evaluate Financial Risk Intelligence (Play 50) quality using Azure AI Evaluation SDK"
---

# Evaluate — Financial Risk Intelligence

## Overview
This skill runs the evaluation pipeline for the Financial Risk Intelligence solution play, measuring quality metrics against production thresholds.
