...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-financial-risk-intelligence-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="50-financial-risk-intelligence"

echo "═══ Deploying Financial Risk Intelligence ═══"
...
echo "═══ Financial Risk Intelligence deployed successfully ═══"
