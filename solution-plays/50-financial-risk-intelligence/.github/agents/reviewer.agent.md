...
- [ ] Solution follows the **Financial AI Agent** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Cosmos DB, Azure Event Hubs, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Financial Risk Intelligence
