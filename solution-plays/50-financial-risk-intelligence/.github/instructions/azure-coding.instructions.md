---
description: "Azure coding patterns and best practices for Financial Risk Intelligence"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Financial Risk Intelligence
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "50-financial-risk-intelligence")
    # ... processing logic
