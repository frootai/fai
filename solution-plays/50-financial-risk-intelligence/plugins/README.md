# Financial Risk Intelligence — Plugin Extensions

This folder contains optional plugin extensions for Financial Risk Intelligence.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 50-financial-risk-intelligence`
