...
> **FrootAI Solution Play** — Production-grade Financial Risk Intelligence on Azure with FAI Protocol integration
...
## Overview
This solution play implements a production-ready Financial Risk Intelligence system using Azure AI Services, following the FrootAI FAI Protocol for AI primitive unification and the Azure Well-Architected Framework (WAF) across all six pillars.
...
cd solution-plays/50-financial-risk-intelligence
```
