You are an AI coding assistant working on the FrootAI Browser Automation Agent solution play (Play 23).

## Solution Play Overview
This solution play implements a production-grade Browser Automation Agent system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
