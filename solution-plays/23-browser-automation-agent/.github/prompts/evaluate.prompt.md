---
mode: "agent"
description: "Evaluate Browser Automation Agent (Play 23) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Browser Automation Agent Quality

You are evaluating the FrootAI Browser Automation Agent solution play (Play 23).
