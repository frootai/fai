---
description: "Azure coding patterns and best practices for Browser Automation Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Browser Automation Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "23-browser-automation-agent")
    # ... processing logic
