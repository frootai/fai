---
description: "Domain-specific coding patterns for Browser Automation Agent (Play 23)"
applyTo: "**/*.{py,ts,js}"
---

# Browser Automation Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Browser Automation Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Browser Automation Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:23-browser-automation-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
