...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-browser-automation-agent-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="23-browser-automation-agent"

echo "═══ Deploying Browser Automation Agent ═══"
...
echo "═══ Browser Automation Agent deployed successfully ═══"
