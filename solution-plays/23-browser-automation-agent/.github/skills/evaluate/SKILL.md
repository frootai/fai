---
name: "evaluate"
description: "Evaluate Browser Automation Agent (Play 23) quality using Azure AI Evaluation SDK"
---

# Evaluate — Browser Automation Agent

## Overview
This skill runs the evaluation pipeline for the Browser Automation Agent solution play, measuring quality metrics against production thresholds.
