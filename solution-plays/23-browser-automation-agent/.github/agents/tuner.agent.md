...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for AI Web Task Execution |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for AI Web Task Execution |
...
```markdown
## Tuning Report — Browser Automation
