...
- [ ] Solution follows the **AI Web Task Execution** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI (GPT-4o Vision), Azure Container Apps, Playwright MCP, Azure Key Vault, Azure Monitor
...
```markdown
## Review Report — Browser Automation
