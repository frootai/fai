# Browser Automation Agent — Plugin Extensions

This folder contains optional plugin extensions for Browser Automation Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 23-browser-automation-agent`
