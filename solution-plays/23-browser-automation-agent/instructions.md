---
description: "Root coding instructions for Browser Automation Agent (Play 23)"
applyTo: "**/*"
---

# Browser Automation Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Browser Automation Agent solution play (Play 23). It implements a production-grade Browser Automation Agent system on Azure using the FAI Protocol for AI primitive unification.
