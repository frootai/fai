---
description: "Root coding instructions for Ai Compliance Engine (Play 35)"
applyTo: "**/*"
---

# Ai Compliance Engine — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Compliance Engine solution play (Play 35). It implements a production-grade Ai Compliance Engine system on Azure using the FAI Protocol for AI primitive unification.
