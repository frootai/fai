---
description: "Domain-specific coding patterns for Ai Compliance Engine (Play 35)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Compliance Engine — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Compliance Engine architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Compliance Engine."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:35-ai-compliance-engine:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
