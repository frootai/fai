---
description: "Azure coding patterns and best practices for Ai Compliance Engine"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Compliance Engine
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "35-ai-compliance-engine")
    # ... processing logic
