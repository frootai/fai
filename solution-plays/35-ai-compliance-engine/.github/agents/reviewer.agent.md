...
- [ ] Solution follows the **Regulatory Automation** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Policy, Azure Key Vault, Azure Monitor, Azure Cosmos DB, Azure AI Search
...
```markdown
## Review Report — AI Compliance Engine
