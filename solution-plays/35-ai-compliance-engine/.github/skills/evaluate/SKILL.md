---
name: "evaluate"
description: "Evaluate Ai Compliance Engine (Play 35) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Compliance Engine

## Overview
This skill runs the evaluation pipeline for the Ai Compliance Engine solution play, measuring quality metrics against production thresholds.
