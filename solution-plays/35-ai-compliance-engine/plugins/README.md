# Ai Compliance Engine — Plugin Extensions

This folder contains optional plugin extensions for Ai Compliance Engine.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 35-ai-compliance-engine`
