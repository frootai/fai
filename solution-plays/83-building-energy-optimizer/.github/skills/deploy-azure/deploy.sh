...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-building-energy-optimizer-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="83-building-energy-optimizer"

echo "═══ Deploying Building Energy Optimizer ═══"
...
echo "═══ Building Energy Optimizer deployed successfully ═══"
