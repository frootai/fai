---
name: "evaluate"
description: "Evaluate Building Energy Optimizer (Play 83) quality using Azure AI Evaluation SDK"
---

# Evaluate — Building Energy Optimizer

## Overview
This skill runs the evaluation pipeline for the Building Energy Optimizer solution play, measuring quality metrics against production thresholds.
