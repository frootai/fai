You are an AI coding assistant working on the FrootAI Building Energy Optimizer solution play (Play 83).

## Solution Play Overview
This solution play implements a production-grade Building Energy Optimizer system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
