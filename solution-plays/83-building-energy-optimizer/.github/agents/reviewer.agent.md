...
- [ ] Solution follows the **Smart Building Digital Twin** pattern correctly
- [ ] All required Azure services are provisioned: Azure Digital Twins, Azure IoT Hub, Azure OpenAI, Azure Functions, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Building Energy Optimizer
