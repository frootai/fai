---
description: "Domain-specific coding patterns for Building Energy Optimizer (Play 83)"
applyTo: "**/*.{py,ts,js}"
---

# Building Energy Optimizer — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Building Energy Optimizer architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Building Energy Optimizer."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:83-building-energy-optimizer:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
