---
description: "Azure coding patterns and best practices for Building Energy Optimizer"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Building Energy Optimizer
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "83-building-energy-optimizer")
    # ... processing logic
