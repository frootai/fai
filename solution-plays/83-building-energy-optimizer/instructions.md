---
description: "Root coding instructions for Building Energy Optimizer (Play 83)"
applyTo: "**/*"
---

# Building Energy Optimizer — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Building Energy Optimizer solution play (Play 83). It implements a production-grade Building Energy Optimizer system on Azure using the FAI Protocol for AI primitive unification.
