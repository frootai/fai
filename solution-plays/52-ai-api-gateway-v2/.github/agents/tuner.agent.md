...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Smart Model Routing |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Smart Model Routing |
...
```markdown
## Tuning Report — AI API Gateway v2
