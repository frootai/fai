---
description: "Domain-specific coding patterns for Ai Api Gateway V2 (Play 52)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Api Gateway V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Api Gateway V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Api Gateway V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:52-ai-api-gateway-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
