---
description: "Azure coding patterns and best practices for Ai Api Gateway V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Api Gateway V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "52-ai-api-gateway-v2")
    # ... processing logic
