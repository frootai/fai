---
mode: "agent"
description: "Evaluate Ai Api Gateway V2 (Play 52) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Api Gateway V2 Quality

You are evaluating the FrootAI Ai Api Gateway V2 solution play (Play 52).
