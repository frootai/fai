---
name: "evaluate"
description: "Evaluate Ai Api Gateway V2 (Play 52) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Api Gateway V2

## Overview
This skill runs the evaluation pipeline for the Ai Api Gateway V2 solution play, measuring quality metrics against production thresholds.
