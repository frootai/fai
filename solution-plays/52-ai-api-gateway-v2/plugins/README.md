# Ai Api Gateway V2 — Plugin Extensions

This folder contains optional plugin extensions for Ai Api Gateway V2.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 52-ai-api-gateway-v2`
