---
description: "Root coding instructions for Ai Api Gateway V2 (Play 52)"
applyTo: "**/*"
---

# Ai Api Gateway V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Api Gateway V2 solution play (Play 52). It implements a production-grade Ai Api Gateway V2 system on Azure using the FAI Protocol for AI primitive unification.
