# Low Code Ai Builder — Plugin Extensions

This folder contains optional plugin extensions for Low Code Ai Builder.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 31-low-code-ai-builder`
