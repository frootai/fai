---
description: "Root coding instructions for Low Code Ai Builder (Play 31)"
applyTo: "**/*"
---

# Low Code Ai Builder — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Low Code Ai Builder solution play (Play 31). It implements a production-grade Low Code Ai Builder system on Azure using the FAI Protocol for AI primitive unification.
