---
name: "evaluate"
description: "Evaluate Low Code Ai Builder (Play 31) quality using Azure AI Evaluation SDK"
---

# Evaluate — Low Code Ai Builder

## Overview
This skill runs the evaluation pipeline for the Low Code Ai Builder solution play, measuring quality metrics against production thresholds.
