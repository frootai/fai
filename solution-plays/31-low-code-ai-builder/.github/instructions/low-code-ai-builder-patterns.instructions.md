---
description: "Domain-specific coding patterns for Low Code Ai Builder (Play 31)"
applyTo: "**/*.{py,ts,js}"
---

# Low Code Ai Builder — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Low Code Ai Builder architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Low Code Ai Builder."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:31-low-code-ai-builder:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
