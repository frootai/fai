---
description: "Azure coding patterns and best practices for Low Code Ai Builder"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Low Code Ai Builder
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "31-low-code-ai-builder")
    # ... processing logic
