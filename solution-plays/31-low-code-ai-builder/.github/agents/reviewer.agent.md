...
- [ ] Solution follows the **Visual Pipeline Designer** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Container Apps, Azure Cosmos DB, Azure Static Web Apps, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Low-Code AI Builder
