---
description: "Azure coding patterns and best practices for Multimodal Search V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Multimodal Search V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "95-multimodal-search-v2")
    # ... processing logic
