---
description: "Domain-specific coding patterns for Multimodal Search V2 (Play 95)"
applyTo: "**/*.{py,ts,js}"
---

# Multimodal Search V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Multimodal Search V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Multimodal Search V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:95-multimodal-search-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
