...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Cross-Modal Search |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Cross-Modal Search |
...
```markdown
## Tuning Report — Multimodal Search Engine v2
