...
- **WAF Pillars**: security, performance-efficiency, reliability, cost-optimization
...
- [ ] Solution follows the **Cross-Modal Search** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Search, Azure AI Vision, Azure AI Speech, Azure OpenAI, Azure Container Apps, Azure Monitor
...
```markdown
## Review Report — Multimodal Search Engine v2
