---
name: "evaluate"
description: "Evaluate Multimodal Search V2 (Play 95) quality using Azure AI Evaluation SDK"
---

# Evaluate — Multimodal Search V2

## Overview
This skill runs the evaluation pipeline for the Multimodal Search V2 solution play, measuring quality metrics against production thresholds.
