---
description: "Root coding instructions for Multimodal Search V2 (Play 95)"
applyTo: "**/*"
---

# Multimodal Search V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Multimodal Search V2 solution play (Play 95). It implements a production-grade Multimodal Search V2 system on Azure using the FAI Protocol for AI primitive unification.
