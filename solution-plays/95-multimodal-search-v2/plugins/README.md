# Multimodal Search V2 — Plugin Extensions

This folder contains optional plugin extensions for Multimodal Search V2.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 95-multimodal-search-v2`
