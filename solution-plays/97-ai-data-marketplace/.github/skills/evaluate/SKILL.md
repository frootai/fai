---
name: "evaluate"
description: "Evaluate Ai Data Marketplace (Play 97) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Data Marketplace

## Overview
This skill runs the evaluation pipeline for the Ai Data Marketplace solution play, measuring quality metrics against production thresholds.
