---
description: "Domain-specific coding patterns for Ai Data Marketplace (Play 97)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Data Marketplace — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Data Marketplace architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Data Marketplace."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:97-ai-data-marketplace:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
