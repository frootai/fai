---
description: "Azure coding patterns and best practices for Ai Data Marketplace"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Data Marketplace
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "97-ai-data-marketplace")
    # ... processing logic
