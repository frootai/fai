---
mode: "agent"
description: "Evaluate Ai Data Marketplace (Play 97) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Data Marketplace Quality

You are evaluating the FrootAI Ai Data Marketplace solution play (Play 97).
