...
- [ ] Solution follows the **Data Discovery & Monetization** pattern correctly
- [ ] All required Azure services are provisioned: Azure Machine Learning, Azure Blob Storage, Azure API Management, Azure Cosmos DB, Azure Functions, Azure Monitor
...
```markdown
## Review Report — AI Data Marketplace
