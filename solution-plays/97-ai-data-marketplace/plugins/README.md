# Ai Data Marketplace — Plugin Extensions

This folder contains optional plugin extensions for Ai Data Marketplace.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 97-ai-data-marketplace`
