---
description: "Root coding instructions for Ai Podcast Generator (Play 94)"
applyTo: "**/*"
---

# Ai Podcast Generator — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Podcast Generator solution play (Play 94). It implements a production-grade Ai Podcast Generator system on Azure using the FAI Protocol for AI primitive unification.
