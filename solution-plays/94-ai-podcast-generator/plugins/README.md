# Ai Podcast Generator — Plugin Extensions

This folder contains optional plugin extensions for Ai Podcast Generator.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 94-ai-podcast-generator`
