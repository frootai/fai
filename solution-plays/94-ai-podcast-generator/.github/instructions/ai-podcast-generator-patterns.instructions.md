---
description: "Domain-specific coding patterns for Ai Podcast Generator (Play 94)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Podcast Generator — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Podcast Generator architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Podcast Generator."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:94-ai-podcast-generator:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
