---
description: "Azure coding patterns and best practices for Ai Podcast Generator"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Podcast Generator
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "94-ai-podcast-generator")
    # ... processing logic
