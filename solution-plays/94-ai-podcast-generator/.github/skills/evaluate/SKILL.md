---
name: "evaluate"
description: "Evaluate Ai Podcast Generator (Play 94) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Podcast Generator

## Overview
This skill runs the evaluation pipeline for the Ai Podcast Generator solution play, measuring quality metrics against production thresholds.
