...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Text-to-Podcast Pipeline |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Text-to-Podcast Pipeline |
...
```markdown
## Tuning Report — AI Podcast Generator
