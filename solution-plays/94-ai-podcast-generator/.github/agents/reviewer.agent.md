...
- **WAF Pillars**: security, cost-optimization, performance-efficiency, responsible-ai
...
- [ ] Solution follows the **Text-to-Podcast Pipeline** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Speech, Azure OpenAI, Azure Blob Storage, Azure CDN, Azure Functions, Azure Monitor
...
```markdown
## Review Report — AI Podcast Generator
