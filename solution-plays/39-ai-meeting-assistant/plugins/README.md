# Ai Meeting Assistant — Plugin Extensions

This folder contains optional plugin extensions for Ai Meeting Assistant.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 39-ai-meeting-assistant`
