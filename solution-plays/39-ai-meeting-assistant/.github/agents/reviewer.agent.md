...
- [ ] Solution follows the **Meeting Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Speech, Azure OpenAI, Microsoft Graph, Azure Container Apps, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — AI Meeting Assistant
