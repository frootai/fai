---
description: "Domain-specific coding patterns for Ai Meeting Assistant (Play 39)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Meeting Assistant — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Meeting Assistant architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Meeting Assistant."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:39-ai-meeting-assistant:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
