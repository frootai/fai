---
description: "Azure coding patterns and best practices for Ai Meeting Assistant"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Meeting Assistant
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "39-ai-meeting-assistant")
    # ... processing logic
