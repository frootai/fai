---
name: "evaluate"
description: "Evaluate Ai Meeting Assistant (Play 39) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Meeting Assistant

## Overview
This skill runs the evaluation pipeline for the Ai Meeting Assistant solution play, measuring quality metrics against production thresholds.
