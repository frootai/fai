---
description: "Root coding instructions for Ai Meeting Assistant (Play 39)"
applyTo: "**/*"
---

# Ai Meeting Assistant — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Meeting Assistant solution play (Play 39). It implements a production-grade Ai Meeting Assistant system on Azure using the FAI Protocol for AI primitive unification.
