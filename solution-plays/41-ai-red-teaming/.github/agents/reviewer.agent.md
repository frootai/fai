...
- [ ] Solution follows the **Adversarial Testing** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Foundry, Azure Content Safety, Azure OpenAI, Azure Monitor, Azure Cosmos DB, Azure Key Vault
