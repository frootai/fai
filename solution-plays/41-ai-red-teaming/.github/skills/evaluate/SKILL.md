---
name: "evaluate"
description: "Evaluate Ai Red Teaming (Play 41) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Red Teaming

## Overview
This skill runs the evaluation pipeline for the Ai Red Teaming solution play, measuring quality metrics against production thresholds.
