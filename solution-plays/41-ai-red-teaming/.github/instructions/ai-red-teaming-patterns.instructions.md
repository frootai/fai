---
description: "Domain-specific coding patterns for Ai Red Teaming (Play 41)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Red Teaming — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Red Teaming architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Red Teaming."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:41-ai-red-teaming:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
