---
description: "Azure coding patterns and best practices for Ai Red Teaming"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Red Teaming
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "41-ai-red-teaming")
    # ... processing logic
