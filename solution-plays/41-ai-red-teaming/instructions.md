---
description: "Root coding instructions for Ai Red Teaming (Play 41)"
applyTo: "**/*"
---

# Ai Red Teaming — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Red Teaming solution play (Play 41). It implements a production-grade Ai Red Teaming system on Azure using the FAI Protocol for AI primitive unification.
