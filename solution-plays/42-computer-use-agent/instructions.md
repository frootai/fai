---
description: "Root coding instructions for Computer Use Agent (Play 42)"
applyTo: "**/*"
---

# Computer Use Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Computer Use Agent solution play (Play 42). It implements a production-grade Computer Use Agent system on Azure using the FAI Protocol for AI primitive unification.
