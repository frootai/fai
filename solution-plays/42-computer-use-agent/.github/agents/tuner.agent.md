...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Vision-Based Desktop Automation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Vision-Based Desktop Automation |
...
```markdown
## Tuning Report — Computer Use Agent
