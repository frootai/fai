---
name: "evaluate"
description: "Evaluate Computer Use Agent (Play 42) quality using Azure AI Evaluation SDK"
---

# Evaluate — Computer Use Agent

## Overview
This skill runs the evaluation pipeline for the Computer Use Agent solution play, measuring quality metrics against production thresholds.
