---
name: "tune"
description: "Tune Computer Use Agent (Play 42) configuration for production readiness"
---

# Tune — Computer Use Agent

## Overview
This skill tunes the Computer Use Agent solution play configuration for optimal production performance, cost efficiency, and quality.
