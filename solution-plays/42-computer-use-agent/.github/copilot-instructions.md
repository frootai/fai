You are an AI coding assistant working on the FrootAI Computer Use Agent solution play (Play 42).

## Solution Play Overview
This solution play implements a production-grade Computer Use Agent system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
