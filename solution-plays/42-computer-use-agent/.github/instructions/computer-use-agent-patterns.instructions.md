---
description: "Domain-specific coding patterns for Computer Use Agent (Play 42)"
applyTo: "**/*.{py,ts,js}"
---

# Computer Use Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Computer Use Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Computer Use Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:42-computer-use-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
