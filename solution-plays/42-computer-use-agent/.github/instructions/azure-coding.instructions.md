---
description: "Azure coding patterns and best practices for Computer Use Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Computer Use Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "42-computer-use-agent")
    # ... processing logic
