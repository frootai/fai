---
description: "Root coding instructions for Accessibility Learning Agent (Play 76)"
applyTo: "**/*"
---

# Accessibility Learning Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Accessibility Learning Agent solution play (Play 76). It implements a production-grade Accessibility Learning Agent system on Azure using the FAI Protocol for AI primitive unification.
