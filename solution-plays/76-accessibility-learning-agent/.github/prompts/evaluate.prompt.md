---
mode: "agent"
description: "Evaluate Accessibility Learning Agent (Play 76) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Accessibility Learning Agent Quality

You are evaluating the FrootAI Accessibility Learning Agent solution play (Play 76).
