---
description: "Domain-specific coding patterns for Accessibility Learning Agent (Play 76)"
applyTo: "**/*.{py,ts,js}"
---

# Accessibility Learning Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Accessibility Learning Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Accessibility Learning Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:76-accessibility-learning-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
