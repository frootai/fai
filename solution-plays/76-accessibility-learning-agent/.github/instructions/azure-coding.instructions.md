---
description: "Azure coding patterns and best practices for Accessibility Learning Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Accessibility Learning Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "76-accessibility-learning-agent")
    # ... processing logic
