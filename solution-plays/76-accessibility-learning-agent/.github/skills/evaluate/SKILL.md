---
name: "evaluate"
description: "Evaluate Accessibility Learning Agent (Play 76) quality using Azure AI Evaluation SDK"
---

# Evaluate — Accessibility Learning Agent

## Overview
This skill runs the evaluation pipeline for the Accessibility Learning Agent solution play, measuring quality metrics against production thresholds.
