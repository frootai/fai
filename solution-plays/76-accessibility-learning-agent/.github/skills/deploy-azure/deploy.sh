...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-accessibility-learning-agent-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="76-accessibility-learning-agent"

echo "═══ Deploying Accessibility Learning Agent ═══"
...
echo "═══ Accessibility Learning Agent deployed successfully ═══"
