# Accessibility Learning Agent — Plugin Extensions

This folder contains optional plugin extensions for Accessibility Learning Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 76-accessibility-learning-agent`
