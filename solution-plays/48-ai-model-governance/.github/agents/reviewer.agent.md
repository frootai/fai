...
- **WAF Pillars**: security, operational-excellence, reliability, responsible-ai
...
- [ ] Solution follows the **Model Lifecycle Management** pattern correctly
- [ ] All required Azure services are provisioned: Azure Machine Learning, Azure AI Foundry, Azure DevOps, Azure Cosmos DB, Azure Monitor, Azure Policy
...
```markdown
## Review Report — AI Model Governance
