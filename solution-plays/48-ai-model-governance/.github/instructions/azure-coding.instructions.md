---
description: "Azure coding patterns and best practices for Ai Model Governance"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Model Governance
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "48-ai-model-governance")
    # ... processing logic
