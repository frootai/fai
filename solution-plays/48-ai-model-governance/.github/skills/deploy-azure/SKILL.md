---
name: "deploy-azure"
description: "Deploy Ai Model Governance (Play 48) infrastructure and application to Azure"
---

# Deploy Azure — Ai Model Governance

## Overview
This skill deploys the Ai Model Governance solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=48
```
...
az deployment group create \
  ...
  --name "deploy-play-48-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-48* --query properties.outputs -o json)
