---
name: "evaluate"
description: "Evaluate Ai Model Governance (Play 48) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Model Governance

## Overview
This skill runs the evaluation pipeline for the Ai Model Governance solution play, measuring quality metrics against production thresholds.
