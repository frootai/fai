---
description: "Root coding instructions for Ai Model Governance (Play 48)"
applyTo: "**/*"
---

# Ai Model Governance — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Model Governance solution play (Play 48). It implements a production-grade Ai Model Governance system on Azure using the FAI Protocol for AI primitive unification.
