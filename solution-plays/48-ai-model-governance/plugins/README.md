# Ai Model Governance — Plugin Extensions

This folder contains optional plugin extensions for Ai Model Governance.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 48-ai-model-governance`
