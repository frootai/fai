---
description: "Root coding instructions for Customer Churn Predictor (Play 91)"
applyTo: "**/*"
---

# Customer Churn Predictor — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Customer Churn Predictor solution play (Play 91). It implements a production-grade Customer Churn Predictor system on Azure using the FAI Protocol for AI primitive unification.
