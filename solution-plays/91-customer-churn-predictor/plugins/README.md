# Customer Churn Predictor — Plugin Extensions

This folder contains optional plugin extensions for Customer Churn Predictor.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 91-customer-churn-predictor`
