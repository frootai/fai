---
name: "evaluate"
description: "Evaluate Customer Churn Predictor (Play 91) quality using Azure AI Evaluation SDK"
---

# Evaluate — Customer Churn Predictor

## Overview
This skill runs the evaluation pipeline for the Customer Churn Predictor solution play, measuring quality metrics against production thresholds.
