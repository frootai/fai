...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-customer-churn-predictor-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="91-customer-churn-predictor"

echo "═══ Deploying Customer Churn Predictor ═══"
...
echo "═══ Customer Churn Predictor deployed successfully ═══"
