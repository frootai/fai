...
- [ ] Solution follows the **Multi-Signal Churn Scoring** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Machine Learning, Azure Cosmos DB, Azure Communication Services, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Customer Churn Predictor
