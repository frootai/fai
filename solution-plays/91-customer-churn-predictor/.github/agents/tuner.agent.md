...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Multi-Signal Churn Scoring |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Multi-Signal Churn Scoring |
...
```markdown
## Tuning Report — Customer Churn Predictor
