---
description: "Azure coding patterns and best practices for Customer Churn Predictor"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Customer Churn Predictor
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "91-customer-churn-predictor")
    # ... processing logic
