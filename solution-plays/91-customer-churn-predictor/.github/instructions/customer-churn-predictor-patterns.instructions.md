---
description: "Domain-specific coding patterns for Customer Churn Predictor (Play 91)"
applyTo: "**/*.{py,ts,js}"
---

# Customer Churn Predictor — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Customer Churn Predictor architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Customer Churn Predictor."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:91-customer-churn-predictor:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
