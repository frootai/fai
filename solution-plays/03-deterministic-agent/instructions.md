---
description: "Root coding instructions for Deterministic Agent (Play 03)"
applyTo: "**/*"
---

# Deterministic Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Deterministic Agent solution play (Play 03). It implements a production-grade Deterministic Agent system on Azure using the FAI Protocol for AI primitive unification.
