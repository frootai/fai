---
name: "evaluate"
description: "Evaluate Deterministic Agent (Play 03) quality using Azure AI Evaluation SDK"
---

# Evaluate — Deterministic Agent

## Overview
This skill runs the evaluation pipeline for the Deterministic Agent solution play, measuring quality metrics against production thresholds.
