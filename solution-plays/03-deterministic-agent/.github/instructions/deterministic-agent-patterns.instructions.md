---
description: "Domain-specific coding patterns for Deterministic Agent (Play 03)"
applyTo: "**/*.{py,ts,js}"
---

# Deterministic Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Deterministic Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Deterministic Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:03-deterministic-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
