...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Zero-Temperature Agent |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Zero-Temperature Agent |
...
```markdown
## Tuning Report — Deterministic Agent
