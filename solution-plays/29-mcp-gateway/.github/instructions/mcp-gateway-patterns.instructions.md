---
description: "Domain-specific coding patterns for Mcp Gateway (Play 29)"
applyTo: "**/*.{py,ts,js}"
---

# Mcp Gateway — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Mcp Gateway architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Mcp Gateway."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:29-mcp-gateway:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
