...
- [ ] Solution follows the **Tool Proxy & Management** pattern correctly
- [ ] All required Azure services are provisioned: Azure API Management, Azure Container Apps, Azure Monitor, Azure Key Vault, Azure Redis Cache, Azure Cosmos DB
