---
name: "evaluate"
description: "Evaluate Mcp Gateway (Play 29) quality using Azure AI Evaluation SDK"
---

# Evaluate — Mcp Gateway

## Overview
This skill runs the evaluation pipeline for the Mcp Gateway solution play, measuring quality metrics against production thresholds.
