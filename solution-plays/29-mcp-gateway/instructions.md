---
description: "Root coding instructions for Mcp Gateway (Play 29)"
applyTo: "**/*"
---

# Mcp Gateway — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Mcp Gateway solution play (Play 29). It implements a production-grade Mcp Gateway system on Azure using the FAI Protocol for AI primitive unification.
