# Enterprise Ai Governance Hub — Plugin Extensions

This folder contains optional plugin extensions for Enterprise Ai Governance Hub.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 99-enterprise-ai-governance-hub`
