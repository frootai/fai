...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Central AI Control Plane |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Central AI Control Plane |
...
```markdown
## Tuning Report — Enterprise AI Governance Hub
