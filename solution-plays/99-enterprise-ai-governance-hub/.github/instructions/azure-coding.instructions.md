---
description: "Azure coding patterns and best practices for Enterprise Ai Governance Hub"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Enterprise Ai Governance Hub
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "99-enterprise-ai-governance-hub")
    # ... processing logic
