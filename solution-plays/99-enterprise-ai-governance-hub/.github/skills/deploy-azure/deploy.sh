...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-enterprise-ai-governance-hub-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="99-enterprise-ai-governance-hub"

echo "═══ Deploying Enterprise Ai Governance Hub ═══"
...
echo "═══ Enterprise Ai Governance Hub deployed successfully ═══"
