---
name: "evaluate"
description: "Evaluate Enterprise Ai Governance Hub (Play 99) quality using Azure AI Evaluation SDK"
---

# Evaluate — Enterprise Ai Governance Hub

## Overview
This skill runs the evaluation pipeline for the Enterprise Ai Governance Hub solution play, measuring quality metrics against production thresholds.
