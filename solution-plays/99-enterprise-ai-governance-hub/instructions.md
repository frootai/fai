---
description: "Root coding instructions for Enterprise Ai Governance Hub (Play 99)"
applyTo: "**/*"
---

# Enterprise Ai Governance Hub — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Enterprise Ai Governance Hub solution play (Play 99). It implements a production-grade Enterprise Ai Governance Hub system on Azure using the FAI Protocol for AI primitive unification.
