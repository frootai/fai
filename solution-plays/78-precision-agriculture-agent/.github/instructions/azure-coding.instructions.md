---
description: "Azure coding patterns and best practices for Precision Agriculture Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Precision Agriculture Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "78-precision-agriculture-agent")
    # ... processing logic
