---
description: "Domain-specific coding patterns for Precision Agriculture Agent (Play 78)"
applyTo: "**/*.{py,ts,js}"
---

# Precision Agriculture Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Precision Agriculture Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Precision Agriculture Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:78-precision-agriculture-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
