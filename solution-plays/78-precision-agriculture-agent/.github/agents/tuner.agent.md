...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Smart Farming |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Smart Farming |
...
```markdown
## Tuning Report — Precision Agriculture Agent
