...
- [ ] Solution follows the **Smart Farming** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure AI Vision, Azure OpenAI, Azure Digital Twins, Azure Machine Learning, Azure Monitor
...
```markdown
## Review Report — Precision Agriculture Agent
