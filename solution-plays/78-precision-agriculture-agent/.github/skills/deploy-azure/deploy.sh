...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-precision-agriculture-agent-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="78-precision-agriculture-agent"

echo "═══ Deploying Precision Agriculture Agent ═══"
...
echo "═══ Precision Agriculture Agent deployed successfully ═══"
