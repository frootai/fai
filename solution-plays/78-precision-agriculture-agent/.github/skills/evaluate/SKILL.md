---
name: "evaluate"
description: "Evaluate Precision Agriculture Agent (Play 78) quality using Azure AI Evaluation SDK"
---

# Evaluate — Precision Agriculture Agent

## Overview
This skill runs the evaluation pipeline for the Precision Agriculture Agent solution play, measuring quality metrics against production thresholds.
