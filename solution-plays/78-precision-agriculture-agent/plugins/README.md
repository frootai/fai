# Precision Agriculture Agent — Plugin Extensions

This folder contains optional plugin extensions for Precision Agriculture Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 78-precision-agriculture-agent`
