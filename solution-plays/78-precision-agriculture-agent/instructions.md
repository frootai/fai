---
description: "Root coding instructions for Precision Agriculture Agent (Play 78)"
applyTo: "**/*"
---

# Precision Agriculture Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Precision Agriculture Agent solution play (Play 78). It implements a production-grade Precision Agriculture Agent system on Azure using the FAI Protocol for AI primitive unification.
