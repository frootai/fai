---
description: "Root coding instructions for Knowledge Graph Rag (Play 28)"
applyTo: "**/*"
---

# Knowledge Graph Rag — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Knowledge Graph Rag solution play (Play 28). It implements a production-grade Knowledge Graph Rag system on Azure using the FAI Protocol for AI primitive unification.
