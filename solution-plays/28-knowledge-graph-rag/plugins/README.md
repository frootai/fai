# Knowledge Graph Rag — Plugin Extensions

This folder contains optional plugin extensions for Knowledge Graph Rag.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 28-knowledge-graph-rag`
