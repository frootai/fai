---
name: "evaluate"
description: "Evaluate Knowledge Graph Rag (Play 28) quality using Azure AI Evaluation SDK"
---

# Evaluate — Knowledge Graph Rag

## Overview
This skill runs the evaluation pipeline for the Knowledge Graph Rag solution play, measuring quality metrics against production thresholds.
