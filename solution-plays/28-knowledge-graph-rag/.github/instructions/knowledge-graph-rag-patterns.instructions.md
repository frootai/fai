---
description: "Domain-specific coding patterns for Knowledge Graph Rag (Play 28)"
applyTo: "**/*.{py,ts,js}"
---

# Knowledge Graph Rag — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Knowledge Graph Rag architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Knowledge Graph Rag."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:28-knowledge-graph-rag:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
