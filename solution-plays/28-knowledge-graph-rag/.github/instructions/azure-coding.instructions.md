---
description: "Azure coding patterns and best practices for Knowledge Graph Rag"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Knowledge Graph Rag
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "28-knowledge-graph-rag")
    # ... processing logic
