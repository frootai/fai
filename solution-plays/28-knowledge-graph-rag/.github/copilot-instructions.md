You are an AI coding assistant working on the FrootAI Knowledge Graph Rag solution play (Play 28).

## Solution Play Overview
This solution play implements a production-grade Knowledge Graph Rag system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
