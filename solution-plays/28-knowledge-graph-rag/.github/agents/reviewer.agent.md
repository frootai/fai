...
- [ ] Solution follows the **Graph-Enhanced Retrieval** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Cosmos DB (Gremlin API), Azure AI Search, Azure Container Apps, Azure Monitor
...
```markdown
## Review Report — Knowledge Graph RAG
