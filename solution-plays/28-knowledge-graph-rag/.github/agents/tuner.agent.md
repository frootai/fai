...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Graph-Enhanced Retrieval |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Graph-Enhanced Retrieval |
...
```markdown
## Tuning Report — Knowledge Graph RAG
