...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Natural Language Code Discovery |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Natural Language Code Discovery |
...
```markdown
## Tuning Report — Semantic Code Search
