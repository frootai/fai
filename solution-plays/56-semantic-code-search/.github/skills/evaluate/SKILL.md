---
name: "evaluate"
description: "Evaluate Semantic Code Search (Play 56) quality using Azure AI Evaluation SDK"
---

# Evaluate — Semantic Code Search

## Overview
This skill runs the evaluation pipeline for the Semantic Code Search solution play, measuring quality metrics against production thresholds.
