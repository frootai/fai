---
description: "Domain-specific coding patterns for Semantic Code Search (Play 56)"
applyTo: "**/*.{py,ts,js}"
---

# Semantic Code Search — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Semantic Code Search architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Semantic Code Search."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:56-semantic-code-search:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
