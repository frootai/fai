---
description: "Azure coding patterns and best practices for Semantic Code Search"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Semantic Code Search
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "56-semantic-code-search")
    # ... processing logic
