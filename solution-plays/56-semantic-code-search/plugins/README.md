# Semantic Code Search — Plugin Extensions

This folder contains optional plugin extensions for Semantic Code Search.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 56-semantic-code-search`
