---
description: "Root coding instructions for Semantic Code Search (Play 56)"
applyTo: "**/*"
---

# Semantic Code Search — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Semantic Code Search solution play (Play 56). It implements a production-grade Semantic Code Search system on Azure using the FAI Protocol for AI primitive unification.
