You are an AI coding assistant working on the FrootAI Research Paper Ai solution play (Play 77).

## Solution Play Overview
This solution play implements a production-grade Research Paper Ai system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
