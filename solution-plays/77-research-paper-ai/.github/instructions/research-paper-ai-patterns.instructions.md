---
description: "Domain-specific coding patterns for Research Paper Ai (Play 77)"
applyTo: "**/*.{py,ts,js}"
---

# Research Paper Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Research Paper Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Research Paper Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:77-research-paper-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
