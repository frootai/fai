---
description: "Azure coding patterns and best practices for Research Paper Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Research Paper Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "77-research-paper-ai")
    # ... processing logic
