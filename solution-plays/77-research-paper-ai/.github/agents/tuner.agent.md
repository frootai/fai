...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Academic Intelligence |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Academic Intelligence |
...
```markdown
## Tuning Report — Research Paper AI
