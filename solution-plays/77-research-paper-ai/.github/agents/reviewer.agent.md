...
- [ ] Solution follows the **Academic Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Cosmos DB, Microsoft Graph, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Research Paper AI
