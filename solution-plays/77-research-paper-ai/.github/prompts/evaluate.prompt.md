---
mode: "agent"
description: "Evaluate Research Paper Ai (Play 77) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Research Paper Ai Quality

You are evaluating the FrootAI Research Paper Ai solution play (Play 77).
