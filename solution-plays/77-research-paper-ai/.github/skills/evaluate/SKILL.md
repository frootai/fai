---
name: "evaluate"
description: "Evaluate Research Paper Ai (Play 77) quality using Azure AI Evaluation SDK"
---

# Evaluate — Research Paper Ai

## Overview
This skill runs the evaluation pipeline for the Research Paper Ai solution play, measuring quality metrics against production thresholds.
