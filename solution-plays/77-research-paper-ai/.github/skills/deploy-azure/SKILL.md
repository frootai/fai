---
name: "deploy-azure"
description: "Deploy Research Paper Ai (Play 77) infrastructure and application to Azure"
---

# Deploy Azure — Research Paper Ai

## Overview
This skill deploys the Research Paper Ai solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=77
```
...
az deployment group create \
  ...
  --name "deploy-play-77-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-77* --query properties.outputs -o json)
