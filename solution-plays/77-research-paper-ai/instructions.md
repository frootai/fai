---
description: "Root coding instructions for Research Paper Ai (Play 77)"
applyTo: "**/*"
---

# Research Paper Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Research Paper Ai solution play (Play 77). It implements a production-grade Research Paper Ai system on Azure using the FAI Protocol for AI primitive unification.
