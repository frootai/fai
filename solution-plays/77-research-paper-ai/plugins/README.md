# Research Paper Ai — Plugin Extensions

This folder contains optional plugin extensions for Research Paper Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 77-research-paper-ai`
