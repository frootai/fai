---
description: "Root coding instructions for Ai Search Portal (Play 09)"
applyTo: "**/*"
---

# Ai Search Portal — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Search Portal solution play (Play 09). It implements a production-grade Ai Search Portal system on Azure using the FAI Protocol for AI primitive unification.
