---
name: "evaluate"
description: "Evaluate Ai Search Portal (Play 09) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Search Portal

## Overview
This skill runs the evaluation pipeline for the Ai Search Portal solution play, measuring quality metrics against production thresholds.
