...
- [ ] Solution follows the **Hybrid Search** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Search, Azure OpenAI, Azure App Service, Azure Blob Storage, Azure Monitor
...
```markdown
## Review Report — AI Search Portal
