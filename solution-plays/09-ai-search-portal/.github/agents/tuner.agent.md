...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Hybrid Search |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Hybrid Search |
...
```markdown
## Tuning Report — AI Search Portal
