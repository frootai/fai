---
description: "Domain-specific coding patterns for Ai Search Portal (Play 09)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Search Portal — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Search Portal architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Search Portal."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:09-ai-search-portal:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
