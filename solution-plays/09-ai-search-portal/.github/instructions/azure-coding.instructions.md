---
description: "Azure coding patterns and best practices for Ai Search Portal"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Search Portal
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "09-ai-search-portal")
    # ... processing logic
