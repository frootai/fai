# Biodiversity Monitor — Plugin Extensions

This folder contains optional plugin extensions for Biodiversity Monitor.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 80-biodiversity-monitor`
