---
description: "Root coding instructions for Biodiversity Monitor (Play 80)"
applyTo: "**/*"
---

# Biodiversity Monitor — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Biodiversity Monitor solution play (Play 80). It implements a production-grade Biodiversity Monitor system on Azure using the FAI Protocol for AI primitive unification.
