---
mode: "agent"
description: "Review Biodiversity Monitor (Play 80) code and architecture"
tools: ["terminal", "file"]
---

# Review Biodiversity Monitor Implementation

You are reviewing the FrootAI Biodiversity Monitor solution play (Play 80).
...
```markdown
## Review Report — Play 80: Biodiversity Monitor
