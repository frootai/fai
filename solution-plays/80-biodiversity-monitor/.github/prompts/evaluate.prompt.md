---
mode: "agent"
description: "Evaluate Biodiversity Monitor (Play 80) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Biodiversity Monitor Quality

You are evaluating the FrootAI Biodiversity Monitor solution play (Play 80).
