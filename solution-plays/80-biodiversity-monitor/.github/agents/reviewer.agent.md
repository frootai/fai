...
- **WAF Pillars**: reliability, responsible-ai, cost-optimization, security
...
- [ ] Solution follows the **Conservation Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Vision, Azure OpenAI, Azure IoT Hub, Azure Cosmos DB, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Biodiversity Monitor
