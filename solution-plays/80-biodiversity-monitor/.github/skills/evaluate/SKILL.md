---
name: "evaluate"
description: "Evaluate Biodiversity Monitor (Play 80) quality using Azure AI Evaluation SDK"
---

# Evaluate — Biodiversity Monitor

## Overview
This skill runs the evaluation pipeline for the Biodiversity Monitor solution play, measuring quality metrics against production thresholds.
