---
description: "Domain-specific coding patterns for Biodiversity Monitor (Play 80)"
applyTo: "**/*.{py,ts,js}"
---

# Biodiversity Monitor — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Biodiversity Monitor architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Biodiversity Monitor."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:80-biodiversity-monitor:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
