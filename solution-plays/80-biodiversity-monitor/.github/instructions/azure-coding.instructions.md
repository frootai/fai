---
description: "Azure coding patterns and best practices for Biodiversity Monitor"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Biodiversity Monitor
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "80-biodiversity-monitor")
    # ... processing logic
