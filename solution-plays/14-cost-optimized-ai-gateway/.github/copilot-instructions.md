You are an AI coding assistant working on the FrootAI Cost Optimized Ai Gateway solution play (Play 14).

## Solution Play Overview
This solution play implements a production-grade Cost Optimized Ai Gateway system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
