---
name: "evaluate"
description: "Evaluate Cost Optimized Ai Gateway (Play 14) quality using Azure AI Evaluation SDK"
---

# Evaluate — Cost Optimized Ai Gateway

## Overview
This skill runs the evaluation pipeline for the Cost Optimized Ai Gateway solution play, measuring quality metrics against production thresholds.
