...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for API Gateway FinOps |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for API Gateway FinOps |
...
```markdown
## Tuning Report — Cost-Optimized AI Gateway
