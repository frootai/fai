...
- [ ] Solution follows the **API Gateway FinOps** pattern correctly
- [ ] All required Azure services are provisioned: Azure API Management, Azure OpenAI (multi-region), Azure Redis Cache, Azure Monitor, Azure Key Vault, Azure Functions
...
```markdown
## Review Report — Cost-Optimized AI Gateway
