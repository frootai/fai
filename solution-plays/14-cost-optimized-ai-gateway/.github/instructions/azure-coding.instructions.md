---
description: "Azure coding patterns and best practices for Cost Optimized Ai Gateway"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Cost Optimized Ai Gateway
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "14-cost-optimized-ai-gateway")
    # ... processing logic
