---
description: "Domain-specific coding patterns for Cost Optimized Ai Gateway (Play 14)"
applyTo: "**/*.{py,ts,js}"
---

# Cost Optimized Ai Gateway — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Cost Optimized Ai Gateway architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Cost Optimized Ai Gateway."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:14-cost-optimized-ai-gateway:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
