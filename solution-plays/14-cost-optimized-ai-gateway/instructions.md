---
description: "Root coding instructions for Cost Optimized Ai Gateway (Play 14)"
applyTo: "**/*"
---

# Cost Optimized Ai Gateway — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Cost Optimized Ai Gateway solution play (Play 14). It implements a production-grade Cost Optimized Ai Gateway system on Azure using the FAI Protocol for AI primitive unification.
