---
mode: "agent"
description: "Evaluate Synthetic Data Factory (Play 47) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Synthetic Data Factory Quality

You are evaluating the FrootAI Synthetic Data Factory solution play (Play 47).
