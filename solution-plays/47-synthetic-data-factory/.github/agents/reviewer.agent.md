...
- [ ] Solution follows the **Privacy-Safe Data Generation** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Machine Learning, Azure Blob Storage, Azure Key Vault, Azure Monitor, Azure Cosmos DB
...
```markdown
## Review Report — Synthetic Data Factory
