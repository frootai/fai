...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Privacy-Safe Data Generation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Privacy-Safe Data Generation |
...
```markdown
## Tuning Report — Synthetic Data Factory
