---
name: "evaluate"
description: "Evaluate Synthetic Data Factory (Play 47) quality using Azure AI Evaluation SDK"
---

# Evaluate — Synthetic Data Factory

## Overview
This skill runs the evaluation pipeline for the Synthetic Data Factory solution play, measuring quality metrics against production thresholds.
