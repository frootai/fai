---
name: "deploy-azure"
description: "Deploy Synthetic Data Factory (Play 47) infrastructure and application to Azure"
---

# Deploy Azure — Synthetic Data Factory

## Overview
This skill deploys the Synthetic Data Factory solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=47
```
...
az deployment group create \
  ...
  --name "deploy-play-47-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-47* --query properties.outputs -o json)
