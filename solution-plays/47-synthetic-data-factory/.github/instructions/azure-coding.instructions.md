---
description: "Azure coding patterns and best practices for Synthetic Data Factory"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Synthetic Data Factory
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "47-synthetic-data-factory")
    # ... processing logic
