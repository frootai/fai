---
description: "Domain-specific coding patterns for Synthetic Data Factory (Play 47)"
applyTo: "**/*.{py,ts,js}"
---

# Synthetic Data Factory — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Synthetic Data Factory architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Synthetic Data Factory."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:47-synthetic-data-factory:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
