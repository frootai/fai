You are an AI coding assistant working on the FrootAI Synthetic Data Factory solution play (Play 47).

## Solution Play Overview
This solution play implements a production-grade Synthetic Data Factory system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
