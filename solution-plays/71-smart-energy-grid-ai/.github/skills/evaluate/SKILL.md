---
name: "evaluate"
description: "Evaluate Smart Energy Grid Ai (Play 71) quality using Azure AI Evaluation SDK"
---

# Evaluate — Smart Energy Grid Ai

## Overview
This skill runs the evaluation pipeline for the Smart Energy Grid Ai solution play, measuring quality metrics against production thresholds.
