...
- **WAF Pillars**: reliability, performance-efficiency, cost-optimization, security, operational-excellence
...
- [ ] Solution follows the **Energy Digital Twin** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure OpenAI, Azure Stream Analytics, Azure Digital Twins, Azure Functions, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Smart Energy Grid AI
