---
description: "Azure coding patterns and best practices for Smart Energy Grid Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Smart Energy Grid Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "71-smart-energy-grid-ai")
    # ... processing logic
