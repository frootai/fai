---
description: "Root coding instructions for Smart Energy Grid Ai (Play 71)"
applyTo: "**/*"
---

# Smart Energy Grid Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Smart Energy Grid Ai solution play (Play 71). It implements a production-grade Smart Energy Grid Ai system on Azure using the FAI Protocol for AI primitive unification.
