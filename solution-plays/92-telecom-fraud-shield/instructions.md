---
description: "Root coding instructions for Telecom Fraud Shield (Play 92)"
applyTo: "**/*"
---

# Telecom Fraud Shield — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Telecom Fraud Shield solution play (Play 92). It implements a production-grade Telecom Fraud Shield system on Azure using the FAI Protocol for AI primitive unification.
