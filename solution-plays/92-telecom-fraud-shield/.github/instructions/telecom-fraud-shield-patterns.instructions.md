---
description: "Domain-specific coding patterns for Telecom Fraud Shield (Play 92)"
applyTo: "**/*.{py,ts,js}"
---

# Telecom Fraud Shield — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Telecom Fraud Shield architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Telecom Fraud Shield."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:92-telecom-fraud-shield:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
