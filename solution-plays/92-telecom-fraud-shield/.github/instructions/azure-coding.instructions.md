---
description: "Azure coding patterns and best practices for Telecom Fraud Shield"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Telecom Fraud Shield
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "92-telecom-fraud-shield")
    # ... processing logic
