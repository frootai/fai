---
name: "evaluate"
description: "Evaluate Telecom Fraud Shield (Play 92) quality using Azure AI Evaluation SDK"
---

# Evaluate — Telecom Fraud Shield

## Overview
This skill runs the evaluation pipeline for the Telecom Fraud Shield solution play, measuring quality metrics against production thresholds.
