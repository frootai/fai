...
- [ ] Solution follows the **Real-Time Telecom Fraud** pattern correctly
- [ ] All required Azure services are provisioned: Azure Event Hubs, Azure Stream Analytics, Azure OpenAI, Azure Cosmos DB, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Telecom Fraud Shield
