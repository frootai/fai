...
|-----------|----------|-------------------|-----|
| model | gpt-4o-mini | gpt-4o-mini | Best quality/cost balance for Real-Time Telecom Fraud |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Real-Time Telecom Fraud |
...
```markdown
## Tuning Report — Telecom Fraud Shield
