# Telecom Fraud Shield — Plugin Extensions

This folder contains optional plugin extensions for Telecom Fraud Shield.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 92-telecom-fraud-shield`
