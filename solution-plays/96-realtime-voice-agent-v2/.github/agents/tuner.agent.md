...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Bidirectional Voice |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Bidirectional Voice |
...
```markdown
## Tuning Report — Real-Time Voice Agent v2
