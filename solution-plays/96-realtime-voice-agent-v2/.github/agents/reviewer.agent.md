...
- [ ] Solution follows the **Bidirectional Voice** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Voice Live, Azure OpenAI, Azure Container Apps, Azure Functions, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Real-Time Voice Agent v2
