---
name: "evaluate"
description: "Evaluate Realtime Voice Agent V2 (Play 96) quality using Azure AI Evaluation SDK"
---

# Evaluate — Realtime Voice Agent V2

## Overview
This skill runs the evaluation pipeline for the Realtime Voice Agent V2 solution play, measuring quality metrics against production thresholds.
