---
description: "Azure coding patterns and best practices for Realtime Voice Agent V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Realtime Voice Agent V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "96-realtime-voice-agent-v2")
    # ... processing logic
