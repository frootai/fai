---
description: "Domain-specific coding patterns for Realtime Voice Agent V2 (Play 96)"
applyTo: "**/*.{py,ts,js}"
---

# Realtime Voice Agent V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Realtime Voice Agent V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Realtime Voice Agent V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:96-realtime-voice-agent-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
