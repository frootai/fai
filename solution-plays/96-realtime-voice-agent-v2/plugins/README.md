# Realtime Voice Agent V2 — Plugin Extensions

This folder contains optional plugin extensions for Realtime Voice Agent V2.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 96-realtime-voice-agent-v2`
