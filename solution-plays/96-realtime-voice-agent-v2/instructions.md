---
description: "Root coding instructions for Realtime Voice Agent V2 (Play 96)"
applyTo: "**/*"
---

# Realtime Voice Agent V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Realtime Voice Agent V2 solution play (Play 96). It implements a production-grade Realtime Voice Agent V2 system on Azure using the FAI Protocol for AI primitive unification.
