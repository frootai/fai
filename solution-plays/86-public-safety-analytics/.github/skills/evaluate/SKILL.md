---
name: "evaluate"
description: "Evaluate Public Safety Analytics (Play 86) quality using Azure AI Evaluation SDK"
---

# Evaluate — Public Safety Analytics

## Overview
This skill runs the evaluation pipeline for the Public Safety Analytics solution play, measuring quality metrics against production thresholds.
