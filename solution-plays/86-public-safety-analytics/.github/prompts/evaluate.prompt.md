---
mode: "agent"
description: "Evaluate Public Safety Analytics (Play 86) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Public Safety Analytics Quality

You are evaluating the FrootAI Public Safety Analytics solution play (Play 86).
