---
description: "Domain-specific coding patterns for Public Safety Analytics (Play 86)"
applyTo: "**/*.{py,ts,js}"
---

# Public Safety Analytics — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Public Safety Analytics architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Public Safety Analytics."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:86-public-safety-analytics:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
