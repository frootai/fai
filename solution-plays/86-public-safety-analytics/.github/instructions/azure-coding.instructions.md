---
description: "Azure coding patterns and best practices for Public Safety Analytics"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Public Safety Analytics
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "86-public-safety-analytics")
    # ... processing logic
