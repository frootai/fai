# Public Safety Analytics — Plugin Extensions

This folder contains optional plugin extensions for Public Safety Analytics.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 86-public-safety-analytics`
