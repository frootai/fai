// COMPLIANCE: CJIS + FedRAMP — Public safety data protection
// Deploy on Azure Government with CJIS Security Addendum

// Public Safety Analytics (Play 86) — Azure Infrastructure
...
param prefix string = 'public-safet'

@description('Tags applied to all resources')
param tags object = {
  project: 'frootai'
  play: '86'
  playName: 'Public Safety Analytics'
