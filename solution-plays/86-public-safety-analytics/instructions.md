---
description: "Root coding instructions for Public Safety Analytics (Play 86)"
applyTo: "**/*"
---

# Public Safety Analytics — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Public Safety Analytics solution play (Play 86). It implements a production-grade Public Safety Analytics system on Azure using the FAI Protocol for AI primitive unification.
