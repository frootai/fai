---
name: "evaluate"
description: "Evaluate Multi Agent Service (Play 07) quality using Azure AI Evaluation SDK"
---

# Evaluate — Multi Agent Service

## Overview
This skill runs the evaluation pipeline for the Multi Agent Service solution play, measuring quality metrics against production thresholds.
