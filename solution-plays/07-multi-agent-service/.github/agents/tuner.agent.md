...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Supervisor-Specialist |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Supervisor-Specialist |
...
```markdown
## Tuning Report — Multi-Agent Service
