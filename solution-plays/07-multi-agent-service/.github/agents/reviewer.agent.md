...
- [ ] Solution follows the **Supervisor-Specialist** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Container Apps, Azure Cosmos DB, Dapr, Azure Service Bus, Azure Monitor
...
```markdown
## Review Report — Multi-Agent Service
