---
description: "Azure coding patterns and best practices for Multi Agent Service"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Multi Agent Service
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "07-multi-agent-service")
    # ... processing logic
