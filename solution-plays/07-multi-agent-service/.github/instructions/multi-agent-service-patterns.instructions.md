---
description: "Domain-specific coding patterns for Multi Agent Service (Play 07)"
applyTo: "**/*.{py,ts,js}"
---

# Multi Agent Service — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Multi Agent Service architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Multi Agent Service."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:07-multi-agent-service:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
