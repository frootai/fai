---
mode: "agent"
description: "Evaluate Multi Agent Service (Play 07) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Multi Agent Service Quality

You are evaluating the FrootAI Multi Agent Service solution play (Play 07).
