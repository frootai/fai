---
mode: "agent"
description: "Test Multi Agent Service (Play 07) implementation"
tools: ["terminal", "file"]
---

# Test Multi Agent Service Implementation

You are testing the FrootAI Multi Agent Service solution play (Play 07).
