---
mode: "agent"
description: "Deploy Multi Agent Service (Play 07) to Azure"
tools: ["terminal", "file"]
---

# Deploy Multi Agent Service to Azure

You are deploying the FrootAI Multi Agent Service solution play (Play 07) to Azure.
