---
description: "Root coding instructions for Multi Agent Service (Play 07)"
applyTo: "**/*"
---

# Multi Agent Service — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Multi Agent Service solution play (Play 07). It implements a production-grade Multi Agent Service system on Azure using the FAI Protocol for AI primitive unification.
