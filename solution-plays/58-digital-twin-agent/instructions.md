---
description: "Root coding instructions for Digital Twin Agent (Play 58)"
applyTo: "**/*"
---

# Digital Twin Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Digital Twin Agent solution play (Play 58). It implements a production-grade Digital Twin Agent system on Azure using the FAI Protocol for AI primitive unification.
