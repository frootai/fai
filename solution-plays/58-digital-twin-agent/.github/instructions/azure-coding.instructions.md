---
description: "Azure coding patterns and best practices for Digital Twin Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Digital Twin Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "58-digital-twin-agent")
    # ... processing logic
