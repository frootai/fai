---
description: "Domain-specific coding patterns for Digital Twin Agent (Play 58)"
applyTo: "**/*.{py,ts,js}"
---

# Digital Twin Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Digital Twin Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Digital Twin Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:58-digital-twin-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
