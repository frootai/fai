---
name: "evaluate"
description: "Evaluate Digital Twin Agent (Play 58) quality using Azure AI Evaluation SDK"
---

# Evaluate — Digital Twin Agent

## Overview
This skill runs the evaluation pipeline for the Digital Twin Agent solution play, measuring quality metrics against production thresholds.
