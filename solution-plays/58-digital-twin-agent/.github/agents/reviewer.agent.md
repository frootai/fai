...
- [ ] Solution follows the **Physical System Simulation** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure Digital Twins, Azure OpenAI, Azure Functions, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Digital Twin Agent
