...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Physical System Simulation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Physical System Simulation |
...
```markdown
## Tuning Report — Digital Twin Agent
