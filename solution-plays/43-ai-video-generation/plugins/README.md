# Ai Video Generation — Plugin Extensions

This folder contains optional plugin extensions for Ai Video Generation.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 43-ai-video-generation`
