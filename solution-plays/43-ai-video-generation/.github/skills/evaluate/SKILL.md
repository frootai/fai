---
name: "evaluate"
description: "Evaluate Ai Video Generation (Play 43) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Video Generation

## Overview
This skill runs the evaluation pipeline for the Ai Video Generation solution play, measuring quality metrics against production thresholds.
