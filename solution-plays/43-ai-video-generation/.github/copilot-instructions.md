You are an AI coding assistant working on the FrootAI Ai Video Generation solution play (Play 43).

## Solution Play Overview
This solution play implements a production-grade Ai Video Generation system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
