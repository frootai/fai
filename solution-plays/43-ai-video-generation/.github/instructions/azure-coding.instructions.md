---
description: "Azure coding patterns and best practices for Ai Video Generation"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Video Generation
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "43-ai-video-generation")
    # ... processing logic
