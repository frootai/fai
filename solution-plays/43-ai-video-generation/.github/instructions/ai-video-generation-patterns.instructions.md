---
description: "Domain-specific coding patterns for Ai Video Generation (Play 43)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Video Generation — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Video Generation architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Video Generation."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:43-ai-video-generation:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
