...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Text-to-Video Pipeline |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Text-to-Video Pipeline |
...
```markdown
## Tuning Report — AI Video Generation
