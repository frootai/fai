...
- [ ] Solution follows the **Text-to-Video Pipeline** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Blob Storage, Azure Content Safety, Azure Functions, Azure CDN, Azure Media Services
...
```markdown
## Review Report — AI Video Generation
