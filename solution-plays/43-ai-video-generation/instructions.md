---
description: "Root coding instructions for Ai Video Generation (Play 43)"
applyTo: "**/*"
---

# Ai Video Generation — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Video Generation solution play (Play 43). It implements a production-grade Ai Video Generation system on Azure using the FAI Protocol for AI primitive unification.
