# Ai Translation Engine — Plugin Extensions

This folder contains optional plugin extensions for Ai Translation Engine.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 57-ai-translation-engine`
