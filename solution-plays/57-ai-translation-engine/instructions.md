---
description: "Root coding instructions for Ai Translation Engine (Play 57)"
applyTo: "**/*"
---

# Ai Translation Engine — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Translation Engine solution play (Play 57). It implements a production-grade Ai Translation Engine system on Azure using the FAI Protocol for AI primitive unification.
