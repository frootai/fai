---
description: "Azure coding patterns and best practices for Ai Translation Engine"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Translation Engine
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "57-ai-translation-engine")
    # ... processing logic
