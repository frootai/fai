---
description: "Domain-specific coding patterns for Ai Translation Engine (Play 57)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Translation Engine — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Translation Engine architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Translation Engine."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:57-ai-translation-engine:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
