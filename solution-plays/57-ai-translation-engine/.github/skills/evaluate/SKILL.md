---
name: "evaluate"
description: "Evaluate Ai Translation Engine (Play 57) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Translation Engine

## Overview
This skill runs the evaluation pipeline for the Ai Translation Engine solution play, measuring quality metrics against production thresholds.
