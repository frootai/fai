...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Context-Aware Translation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Context-Aware Translation |
...
```markdown
## Tuning Report — AI Translation Engine
