...
- [ ] Solution follows the **Context-Aware Translation** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Translator, Azure Cosmos DB, Azure Container Apps, Azure Blob Storage, Azure Monitor
...
```markdown
## Review Report — AI Translation Engine
