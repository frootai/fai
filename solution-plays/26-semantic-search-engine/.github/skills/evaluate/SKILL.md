---
name: "evaluate"
description: "Evaluate Semantic Search Engine (Play 26) quality using Azure AI Evaluation SDK"
---

# Evaluate — Semantic Search Engine

## Overview
This skill runs the evaluation pipeline for the Semantic Search Engine solution play, measuring quality metrics against production thresholds.
