...
- [ ] Solution follows the **Hybrid Vector Search** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Search, Azure OpenAI, Azure Blob Storage, Azure Container Apps, Azure Monitor
...
```markdown
## Review Report — Semantic Search Engine
