---
description: "Domain-specific coding patterns for Semantic Search Engine (Play 26)"
applyTo: "**/*.{py,ts,js}"
---

# Semantic Search Engine — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Semantic Search Engine architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Semantic Search Engine."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:26-semantic-search-engine:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
