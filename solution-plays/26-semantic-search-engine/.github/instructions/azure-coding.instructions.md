---
description: "Azure coding patterns and best practices for Semantic Search Engine"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Semantic Search Engine
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "26-semantic-search-engine")
    # ... processing logic
