---
description: "Root coding instructions for Semantic Search Engine (Play 26)"
applyTo: "**/*"
---

# Semantic Search Engine — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Semantic Search Engine solution play (Play 26). It implements a production-grade Semantic Search Engine system on Azure using the FAI Protocol for AI primitive unification.
