# Semantic Search Engine — Plugin Extensions

This folder contains optional plugin extensions for Semantic Search Engine.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 26-semantic-search-engine`
