---
mode: "agent"
description: "Test Ai Landing Zone (Play 02) implementation"
tools: ["terminal", "file"]
---

# Test Ai Landing Zone Implementation

You are testing the FrootAI Ai Landing Zone solution play (Play 02).
