---
description: "Azure coding patterns and best practices for Ai Landing Zone"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Landing Zone
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "02-ai-landing-zone")
    # ... processing logic
