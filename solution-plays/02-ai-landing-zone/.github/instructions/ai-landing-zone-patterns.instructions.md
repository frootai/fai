---
description: "Domain-specific coding patterns for Ai Landing Zone (Play 02)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Landing Zone — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Landing Zone architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Landing Zone."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:02-ai-landing-zone:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
