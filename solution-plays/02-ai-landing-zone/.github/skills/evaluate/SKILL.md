---
name: "evaluate"
description: "Evaluate Ai Landing Zone (Play 02) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Landing Zone

## Overview
This skill runs the evaluation pipeline for the Ai Landing Zone solution play, measuring quality metrics against production thresholds.
