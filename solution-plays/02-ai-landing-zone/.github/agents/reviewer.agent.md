...
- [ ] Solution follows the **Infrastructure** pattern correctly
- [ ] All required Azure services are provisioned: Azure VNet, Azure Private Endpoints, Azure Key Vault, Azure RBAC, Azure Policy, Azure Monitor, GPU Quota
