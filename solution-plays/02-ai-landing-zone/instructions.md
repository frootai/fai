---
description: "Root coding instructions for Ai Landing Zone (Play 02)"
applyTo: "**/*"
---

# Ai Landing Zone — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Landing Zone solution play (Play 02). It implements a production-grade Ai Landing Zone system on Azure using the FAI Protocol for AI primitive unification.
