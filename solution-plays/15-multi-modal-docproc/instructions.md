---
description: "Root coding instructions for Multi Modal Docproc (Play 15)"
applyTo: "**/*"
---

# Multi Modal Docproc — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Multi Modal Docproc solution play (Play 15). It implements a production-grade Multi Modal Docproc system on Azure using the FAI Protocol for AI primitive unification.
