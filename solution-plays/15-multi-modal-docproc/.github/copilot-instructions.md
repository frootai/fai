You are an AI coding assistant working on the FrootAI Multi Modal Docproc solution play (Play 15).

## Solution Play Overview
This solution play implements a production-grade Multi Modal Docproc system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
