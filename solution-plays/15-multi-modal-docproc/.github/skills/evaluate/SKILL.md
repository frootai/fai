---
name: "evaluate"
description: "Evaluate Multi Modal Docproc (Play 15) quality using Azure AI Evaluation SDK"
---

# Evaluate — Multi Modal Docproc

## Overview
This skill runs the evaluation pipeline for the Multi Modal Docproc solution play, measuring quality metrics against production thresholds.
