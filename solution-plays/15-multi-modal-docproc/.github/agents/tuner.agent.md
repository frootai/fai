...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Vision+Text Extraction |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Vision+Text Extraction |
...
```markdown
## Tuning Report — Multi-Modal DocProc
