---
description: "Azure coding patterns and best practices for Multi Modal Docproc"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Multi Modal Docproc
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "15-multi-modal-docproc")
    # ... processing logic
