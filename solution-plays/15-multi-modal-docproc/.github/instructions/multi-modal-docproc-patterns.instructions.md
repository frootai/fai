---
description: "Domain-specific coding patterns for Multi Modal Docproc (Play 15)"
applyTo: "**/*.{py,ts,js}"
---

# Multi Modal Docproc — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Multi Modal Docproc architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Multi Modal Docproc."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:15-multi-modal-docproc:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
