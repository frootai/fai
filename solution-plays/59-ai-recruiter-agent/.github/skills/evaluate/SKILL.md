---
name: "evaluate"
description: "Evaluate Ai Recruiter Agent (Play 59) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Recruiter Agent

## Overview
This skill runs the evaluation pipeline for the Ai Recruiter Agent solution play, measuring quality metrics against production thresholds.
