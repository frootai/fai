---
name: "tune"
description: "Tune Ai Recruiter Agent (Play 59) configuration for production readiness"
---

# Tune — Ai Recruiter Agent

## Overview
This skill tunes the Ai Recruiter Agent solution play configuration for optimal production performance, cost efficiency, and quality.
