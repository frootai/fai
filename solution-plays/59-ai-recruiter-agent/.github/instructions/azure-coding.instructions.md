---
description: "Azure coding patterns and best practices for Ai Recruiter Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Recruiter Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "59-ai-recruiter-agent")
    # ... processing logic
