---
description: "Domain-specific coding patterns for Ai Recruiter Agent (Play 59)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Recruiter Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Recruiter Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Recruiter Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:59-ai-recruiter-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
