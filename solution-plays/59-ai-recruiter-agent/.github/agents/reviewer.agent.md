...
- [ ] Solution follows the **Talent Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Cosmos DB, Azure Functions, Microsoft Graph, Azure Monitor
...
```markdown
## Review Report — AI Recruiter Agent
