---
mode: "agent"
description: "Evaluate Ai Recruiter Agent (Play 59) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Recruiter Agent Quality

You are evaluating the FrootAI Ai Recruiter Agent solution play (Play 59).
