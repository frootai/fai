---
description: "Root coding instructions for Ai Recruiter Agent (Play 59)"
applyTo: "**/*"
---

# Ai Recruiter Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Recruiter Agent solution play (Play 59). It implements a production-grade Ai Recruiter Agent system on Azure using the FAI Protocol for AI primitive unification.
