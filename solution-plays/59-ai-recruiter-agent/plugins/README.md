# Ai Recruiter Agent — Plugin Extensions

This folder contains optional plugin extensions for Ai Recruiter Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 59-ai-recruiter-agent`
