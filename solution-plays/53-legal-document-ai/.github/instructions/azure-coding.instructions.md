---
description: "Azure coding patterns and best practices for Legal Document Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Legal Document Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "53-legal-document-ai")
    # ... processing logic
