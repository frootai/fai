---
description: "Domain-specific coding patterns for Legal Document Ai (Play 53)"
applyTo: "**/*.{py,ts,js}"
---

# Legal Document Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Legal Document Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Legal Document Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:53-legal-document-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
