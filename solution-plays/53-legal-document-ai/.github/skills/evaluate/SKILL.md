---
name: "evaluate"
description: "Evaluate Legal Document Ai (Play 53) quality using Azure AI Evaluation SDK"
---

# Evaluate — Legal Document Ai

## Overview
This skill runs the evaluation pipeline for the Legal Document Ai solution play, measuring quality metrics against production thresholds.
