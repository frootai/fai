...
- [ ] Solution follows the **Contract Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Blob Storage, Azure Cosmos DB, Azure Key Vault, Azure Monitor
...
```markdown
## Review Report — Legal Document AI
