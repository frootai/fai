# Legal Document Ai — Plugin Extensions

This folder contains optional plugin extensions for Legal Document Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 53-legal-document-ai`
