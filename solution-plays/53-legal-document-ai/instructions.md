---
description: "Root coding instructions for Legal Document Ai (Play 53)"
applyTo: "**/*"
---

# Legal Document Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Legal Document Ai solution play (Play 53). It implements a production-grade Legal Document Ai system on Azure using the FAI Protocol for AI primitive unification.
