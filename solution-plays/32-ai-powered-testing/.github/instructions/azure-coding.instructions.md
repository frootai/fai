---
description: "Azure coding patterns and best practices for Ai Powered Testing"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Powered Testing
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "32-ai-powered-testing")
    # ... processing logic
