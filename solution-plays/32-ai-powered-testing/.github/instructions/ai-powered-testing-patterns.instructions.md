---
description: "Domain-specific coding patterns for Ai Powered Testing (Play 32)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Powered Testing — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Powered Testing architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Powered Testing."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:32-ai-powered-testing:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
