---
name: "evaluate"
description: "Evaluate Ai Powered Testing (Play 32) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Powered Testing

## Overview
This skill runs the evaluation pipeline for the Ai Powered Testing solution play, measuring quality metrics against production thresholds.
