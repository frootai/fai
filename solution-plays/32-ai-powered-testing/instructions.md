---
description: "Root coding instructions for Ai Powered Testing (Play 32)"
applyTo: "**/*"
---

# Ai Powered Testing — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Powered Testing solution play (Play 32). It implements a production-grade Ai Powered Testing system on Azure using the FAI Protocol for AI primitive unification.
