# Ai Powered Testing — Plugin Extensions

This folder contains optional plugin extensions for Ai Powered Testing.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 32-ai-powered-testing`
