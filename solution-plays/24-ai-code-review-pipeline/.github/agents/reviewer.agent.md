...
- [ ] Solution follows the **Automated PR Review** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, GitHub Actions, CodeQL, Azure DevOps, Azure Monitor
