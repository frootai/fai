---
name: "evaluate"
description: "Evaluate Ai Code Review Pipeline (Play 24) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Code Review Pipeline

## Overview
This skill runs the evaluation pipeline for the Ai Code Review Pipeline solution play, measuring quality metrics against production thresholds.
