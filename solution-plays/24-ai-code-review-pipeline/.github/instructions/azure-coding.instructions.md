---
description: "Azure coding patterns and best practices for Ai Code Review Pipeline"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Code Review Pipeline
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "24-ai-code-review-pipeline")
    # ... processing logic
