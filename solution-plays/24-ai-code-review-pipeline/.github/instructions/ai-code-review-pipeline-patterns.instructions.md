---
description: "Domain-specific coding patterns for Ai Code Review Pipeline (Play 24)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Code Review Pipeline — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Code Review Pipeline architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Code Review Pipeline."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:24-ai-code-review-pipeline:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
