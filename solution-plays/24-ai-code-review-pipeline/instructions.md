---
description: "Root coding instructions for Ai Code Review Pipeline (Play 24)"
applyTo: "**/*"
---

# Ai Code Review Pipeline — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Code Review Pipeline solution play (Play 24). It implements a production-grade Ai Code Review Pipeline system on Azure using the FAI Protocol for AI primitive unification.
