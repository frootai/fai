---
description: "Azure coding patterns and best practices for Ai Infrastructure Optimizer"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Infrastructure Optimizer
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "66-ai-infrastructure-optimizer")
    # ... processing logic
