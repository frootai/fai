---
description: "Domain-specific coding patterns for Ai Infrastructure Optimizer (Play 66)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Infrastructure Optimizer — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Infrastructure Optimizer architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Infrastructure Optimizer."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:66-ai-infrastructure-optimizer:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
