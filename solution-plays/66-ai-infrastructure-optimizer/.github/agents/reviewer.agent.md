...
- **WAF Pillars**: cost-optimization, operational-excellence, reliability, performance-efficiency
...
- [ ] Solution follows the **FinOps Automation** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Monitor, Azure Advisor, Azure Cost Management, Azure Functions, Azure Key Vault
...
```markdown
## Review Report — AI Infrastructure Optimizer
