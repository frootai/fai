...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-ai-infrastructure-optimizer-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="66-ai-infrastructure-optimizer"

echo "═══ Deploying Ai Infrastructure Optimizer ═══"
...
echo "═══ Ai Infrastructure Optimizer deployed successfully ═══"
