---
name: "evaluate"
description: "Evaluate Ai Infrastructure Optimizer (Play 66) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Infrastructure Optimizer

## Overview
This skill runs the evaluation pipeline for the Ai Infrastructure Optimizer solution play, measuring quality metrics against production thresholds.
