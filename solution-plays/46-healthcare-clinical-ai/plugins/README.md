# Healthcare Clinical Ai — Plugin Extensions

This folder contains optional plugin extensions for Healthcare Clinical Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 46-healthcare-clinical-ai`
