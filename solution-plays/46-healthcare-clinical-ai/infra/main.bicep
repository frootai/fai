// COMPLIANCE: HIPAA + HITRUST — BAA required, PHI encrypted, audit logging enabled
// Deploy on Azure commercial with HIPAA BAA in place

// Healthcare Clinical Ai (Play 46) — Azure Infrastructure
...
param prefix string = 'healthcare-c'

@description('Tags applied to all resources')
param tags object = {
  project: 'frootai'
  play: '46'
  playName: 'Healthcare Clinical Ai'
