---
description: "Azure coding patterns and best practices for Healthcare Clinical Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Healthcare Clinical Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "46-healthcare-clinical-ai")
    # ... processing logic
