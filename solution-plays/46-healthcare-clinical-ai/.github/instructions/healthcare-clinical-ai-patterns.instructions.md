---
description: "Domain-specific coding patterns for Healthcare Clinical Ai (Play 46)"
applyTo: "**/*.{py,ts,js}"
---

# Healthcare Clinical Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Healthcare Clinical Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Healthcare Clinical Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:46-healthcare-clinical-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
