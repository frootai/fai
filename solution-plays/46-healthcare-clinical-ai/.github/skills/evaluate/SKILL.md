---
name: "evaluate"
description: "Evaluate Healthcare Clinical Ai (Play 46) quality using Azure AI Evaluation SDK"
---

# Evaluate — Healthcare Clinical Ai

## Overview
This skill runs the evaluation pipeline for the Healthcare Clinical Ai solution play, measuring quality metrics against production thresholds.
