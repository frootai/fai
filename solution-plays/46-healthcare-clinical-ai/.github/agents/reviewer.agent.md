...
- **WAF Pillars**: security, reliability, responsible-ai, cost-optimization, operational-excellence, performance-efficiency
...
- [ ] Solution follows the **HIPAA-Compliant Clinical Agent** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Health Data Services (FHIR), Azure AI Search, Azure Content Safety, Azure Key Vault, Azure Monitor
...
### 3. WAF Compliance Review (6 pillars)
...
```markdown
## Review Report — Healthcare Clinical AI
