---
description: "Root coding instructions for Healthcare Clinical Ai (Play 46)"
applyTo: "**/*"
---

# Healthcare Clinical Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Healthcare Clinical Ai solution play (Play 46). It implements a production-grade Healthcare Clinical Ai system on Azure using the FAI Protocol for AI primitive unification.
