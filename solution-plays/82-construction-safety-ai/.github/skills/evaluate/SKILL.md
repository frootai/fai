---
name: "evaluate"
description: "Evaluate Construction Safety Ai (Play 82) quality using Azure AI Evaluation SDK"
---

# Evaluate — Construction Safety Ai

## Overview
This skill runs the evaluation pipeline for the Construction Safety Ai solution play, measuring quality metrics against production thresholds.
