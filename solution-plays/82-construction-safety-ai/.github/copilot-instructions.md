You are an AI coding assistant working on the FrootAI Construction Safety Ai solution play (Play 82).

## Solution Play Overview
This solution play implements a production-grade Construction Safety Ai system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
