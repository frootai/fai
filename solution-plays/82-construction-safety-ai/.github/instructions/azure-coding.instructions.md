---
description: "Azure coding patterns and best practices for Construction Safety Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Construction Safety Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "82-construction-safety-ai")
    # ... processing logic
