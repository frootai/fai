---
description: "Domain-specific coding patterns for Construction Safety Ai (Play 82)"
applyTo: "**/*.{py,ts,js}"
---

# Construction Safety Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Construction Safety Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Construction Safety Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:82-construction-safety-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
