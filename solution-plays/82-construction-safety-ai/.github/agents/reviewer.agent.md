...
- [ ] Solution follows the **Real-Time Site Monitoring** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Vision, Azure IoT Hub, Azure OpenAI, Azure Container Apps, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Construction Safety AI
