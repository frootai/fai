...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Real-Time Site Monitoring |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Real-Time Site Monitoring |
...
```markdown
## Tuning Report — Construction Safety AI
