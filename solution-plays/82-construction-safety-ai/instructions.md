---
description: "Root coding instructions for Construction Safety Ai (Play 82)"
applyTo: "**/*"
---

# Construction Safety Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Construction Safety Ai solution play (Play 82). It implements a production-grade Construction Safety Ai system on Azure using the FAI Protocol for AI primitive unification.
