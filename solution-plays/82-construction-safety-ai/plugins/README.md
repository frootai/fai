# Construction Safety Ai — Plugin Extensions

This folder contains optional plugin extensions for Construction Safety Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 82-construction-safety-ai`
