---
description: "Root coding instructions for Fine Tuning Workflow (Play 13)"
applyTo: "**/*"
---

# Fine Tuning Workflow — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Fine Tuning Workflow solution play (Play 13). It implements a production-grade Fine Tuning Workflow system on Azure using the FAI Protocol for AI primitive unification.
