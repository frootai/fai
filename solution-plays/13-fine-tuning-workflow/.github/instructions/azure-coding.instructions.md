---
description: "Azure coding patterns and best practices for Fine Tuning Workflow"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Fine Tuning Workflow
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "13-fine-tuning-workflow")
    # ... processing logic
