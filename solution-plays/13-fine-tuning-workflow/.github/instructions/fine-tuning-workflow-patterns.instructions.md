---
description: "Domain-specific coding patterns for Fine Tuning Workflow (Play 13)"
applyTo: "**/*.{py,ts,js}"
---

# Fine Tuning Workflow — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Fine Tuning Workflow architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Fine Tuning Workflow."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:13-fine-tuning-workflow:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
