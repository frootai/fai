You are an AI coding assistant working on the FrootAI Fine Tuning Workflow solution play (Play 13).

## Solution Play Overview
This solution play implements a production-grade Fine Tuning Workflow system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
