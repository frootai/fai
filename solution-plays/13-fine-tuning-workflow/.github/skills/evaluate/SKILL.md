---
name: "evaluate"
description: "Evaluate Fine Tuning Workflow (Play 13) quality using Azure AI Evaluation SDK"
---

# Evaluate — Fine Tuning Workflow

## Overview
This skill runs the evaluation pipeline for the Fine Tuning Workflow solution play, measuring quality metrics against production thresholds.
