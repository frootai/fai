---
name: "evaluate"
description: "Evaluate Ai Sales Assistant (Play 64) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Sales Assistant

## Overview
This skill runs the evaluation pipeline for the Ai Sales Assistant solution play, measuring quality metrics against production thresholds.
