...
- [ ] Solution follows the **CRM Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Cosmos DB, Microsoft Graph, Azure AI Search, Azure Functions, Azure Monitor
...
```markdown
## Review Report — AI Sales Assistant
