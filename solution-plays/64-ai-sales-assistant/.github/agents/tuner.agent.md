...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for CRM Intelligence |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for CRM Intelligence |
...
```markdown
## Tuning Report — AI Sales Assistant
