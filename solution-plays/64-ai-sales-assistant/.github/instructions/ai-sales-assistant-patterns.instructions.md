---
description: "Domain-specific coding patterns for Ai Sales Assistant (Play 64)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Sales Assistant — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Sales Assistant architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Sales Assistant."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:64-ai-sales-assistant:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
