---
description: "Azure coding patterns and best practices for Ai Sales Assistant"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Sales Assistant
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "64-ai-sales-assistant")
    # ... processing logic
