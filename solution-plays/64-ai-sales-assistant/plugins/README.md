# Ai Sales Assistant — Plugin Extensions

This folder contains optional plugin extensions for Ai Sales Assistant.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 64-ai-sales-assistant`
