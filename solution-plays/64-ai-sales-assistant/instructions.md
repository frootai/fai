---
description: "Root coding instructions for Ai Sales Assistant (Play 64)"
applyTo: "**/*"
---

# Ai Sales Assistant — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Sales Assistant solution play (Play 64). It implements a production-grade Ai Sales Assistant system on Azure using the FAI Protocol for AI primitive unification.
