---
description: "Root coding instructions for Predictive Maintenance Ai (Play 68)"
applyTo: "**/*"
---

# Predictive Maintenance Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Predictive Maintenance Ai solution play (Play 68). It implements a production-grade Predictive Maintenance Ai system on Azure using the FAI Protocol for AI primitive unification.
