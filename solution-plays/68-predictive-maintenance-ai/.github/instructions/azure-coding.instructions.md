---
description: "Azure coding patterns and best practices for Predictive Maintenance Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Predictive Maintenance Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "68-predictive-maintenance-ai")
    # ... processing logic
