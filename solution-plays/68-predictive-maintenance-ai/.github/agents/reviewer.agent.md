...
- [ ] Solution follows the **IoT Failure Prediction** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure OpenAI, Azure Machine Learning, Azure Stream Analytics, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Predictive Maintenance AI
