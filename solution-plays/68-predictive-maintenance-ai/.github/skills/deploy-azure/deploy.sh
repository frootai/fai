...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-predictive-maintenance-ai-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="68-predictive-maintenance-ai"

echo "═══ Deploying Predictive Maintenance Ai ═══"
...
echo "═══ Predictive Maintenance Ai deployed successfully ═══"
