---
name: "evaluate"
description: "Evaluate Predictive Maintenance Ai (Play 68) quality using Azure AI Evaluation SDK"
---

# Evaluate — Predictive Maintenance Ai

## Overview
This skill runs the evaluation pipeline for the Predictive Maintenance Ai solution play, measuring quality metrics against production thresholds.
