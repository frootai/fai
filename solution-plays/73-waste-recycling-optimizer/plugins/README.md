# Waste Recycling Optimizer — Plugin Extensions

This folder contains optional plugin extensions for Waste Recycling Optimizer.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 73-waste-recycling-optimizer`
