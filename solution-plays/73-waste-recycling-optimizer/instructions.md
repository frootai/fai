---
description: "Root coding instructions for Waste Recycling Optimizer (Play 73)"
applyTo: "**/*"
---

# Waste Recycling Optimizer — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Waste Recycling Optimizer solution play (Play 73). It implements a production-grade Waste Recycling Optimizer system on Azure using the FAI Protocol for AI primitive unification.
