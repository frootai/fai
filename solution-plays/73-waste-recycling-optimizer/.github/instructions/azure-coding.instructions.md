---
description: "Azure coding patterns and best practices for Waste Recycling Optimizer"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Waste Recycling Optimizer
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "73-waste-recycling-optimizer")
    # ... processing logic
