---
description: "Domain-specific coding patterns for Waste Recycling Optimizer (Play 73)"
applyTo: "**/*.{py,ts,js}"
---

# Waste Recycling Optimizer — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Waste Recycling Optimizer architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Waste Recycling Optimizer."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:73-waste-recycling-optimizer:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
