...
- **WAF Pillars**: reliability, cost-optimization, performance-efficiency, security
...
- [ ] Solution follows the **AI Waste Management** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Vision, Azure OpenAI, Azure IoT Hub, Azure Container Apps, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Waste & Recycling Optimizer
