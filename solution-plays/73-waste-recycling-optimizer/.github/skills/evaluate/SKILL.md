---
name: "evaluate"
description: "Evaluate Waste Recycling Optimizer (Play 73) quality using Azure AI Evaluation SDK"
---

# Evaluate — Waste Recycling Optimizer

## Overview
This skill runs the evaluation pipeline for the Waste Recycling Optimizer solution play, measuring quality metrics against production thresholds.
