...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-waste-recycling-optimizer-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="73-waste-recycling-optimizer"

echo "═══ Deploying Waste Recycling Optimizer ═══"
...
echo "═══ Waste Recycling Optimizer deployed successfully ═══"
