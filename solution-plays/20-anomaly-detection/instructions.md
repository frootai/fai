---
description: "Root coding instructions for Anomaly Detection (Play 20)"
applyTo: "**/*"
---

# Anomaly Detection — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Anomaly Detection solution play (Play 20). It implements a production-grade Anomaly Detection system on Azure using the FAI Protocol for AI primitive unification.
