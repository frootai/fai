---
name: "evaluate"
description: "Evaluate Anomaly Detection (Play 20) quality using Azure AI Evaluation SDK"
---

# Evaluate — Anomaly Detection

## Overview
This skill runs the evaluation pipeline for the Anomaly Detection solution play, measuring quality metrics against production thresholds.
