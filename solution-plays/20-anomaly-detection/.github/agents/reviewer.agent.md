...
- [ ] All required Azure services are provisioned: Azure Event Hubs, Azure Stream Analytics, Azure OpenAI, Azure Cosmos DB, Azure Functions, Azure SignalR
...
```markdown
## Review Report — Anomaly Detection
