---
description: "Domain-specific coding patterns for Anomaly Detection (Play 20)"
applyTo: "**/*.{py,ts,js}"
---

# Anomaly Detection — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Anomaly Detection architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Anomaly Detection."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:20-anomaly-detection:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
