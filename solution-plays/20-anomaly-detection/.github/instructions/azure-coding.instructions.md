---
description: "Azure coding patterns and best practices for Anomaly Detection"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Anomaly Detection
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "20-anomaly-detection")
    # ... processing logic
