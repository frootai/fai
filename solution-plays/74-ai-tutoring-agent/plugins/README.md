# Ai Tutoring Agent — Plugin Extensions

This folder contains optional plugin extensions for Ai Tutoring Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 74-ai-tutoring-agent`
