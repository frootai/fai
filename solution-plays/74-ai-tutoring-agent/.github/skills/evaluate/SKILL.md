---
name: "evaluate"
description: "Evaluate Ai Tutoring Agent (Play 74) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Tutoring Agent

## Overview
This skill runs the evaluation pipeline for the Ai Tutoring Agent solution play, measuring quality metrics against production thresholds.
