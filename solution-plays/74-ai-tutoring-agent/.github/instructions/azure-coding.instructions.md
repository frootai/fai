---
description: "Azure coding patterns and best practices for Ai Tutoring Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Tutoring Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "74-ai-tutoring-agent")
    # ... processing logic
