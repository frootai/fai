---
description: "Domain-specific coding patterns for Ai Tutoring Agent (Play 74)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Tutoring Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Tutoring Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Tutoring Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:74-ai-tutoring-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
