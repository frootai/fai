---
mode: "agent"
description: "Evaluate Ai Tutoring Agent (Play 74) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Tutoring Agent Quality

You are evaluating the FrootAI Ai Tutoring Agent solution play (Play 74).
