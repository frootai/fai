---
description: "Root coding instructions for Ai Tutoring Agent (Play 74)"
applyTo: "**/*"
---

# Ai Tutoring Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Tutoring Agent solution play (Play 74). It implements a production-grade Ai Tutoring Agent system on Azure using the FAI Protocol for AI primitive unification.
