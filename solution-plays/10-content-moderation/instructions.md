---
description: "Root coding instructions for Content Moderation (Play 10)"
applyTo: "**/*"
---

# Content Moderation — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Content Moderation solution play (Play 10). It implements a production-grade Content Moderation system on Azure using the FAI Protocol for AI primitive unification.
