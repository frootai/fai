---
description: "Domain-specific coding patterns for Content Moderation (Play 10)"
applyTo: "**/*.{py,ts,js}"
---

# Content Moderation — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Content Moderation architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Content Moderation."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:10-content-moderation:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
