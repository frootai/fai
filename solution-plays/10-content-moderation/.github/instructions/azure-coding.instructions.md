---
description: "Azure coding patterns and best practices for Content Moderation"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Content Moderation
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "10-content-moderation")
    # ... processing logic
