---
mode: "agent"
description: "Review Content Moderation (Play 10) code and architecture"
tools: ["terminal", "file"]
---

# Review Content Moderation Implementation

You are reviewing the FrootAI Content Moderation solution play (Play 10).
...
```markdown
## Review Report — Play 10: Content Moderation
