---
name: "evaluate"
description: "Evaluate Content Moderation (Play 10) quality using Azure AI Evaluation SDK"
---

# Evaluate — Content Moderation

## Overview
This skill runs the evaluation pipeline for the Content Moderation solution play, measuring quality metrics against production thresholds.
