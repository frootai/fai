...
- [ ] Solution follows the **Safety Gateway** pattern correctly
- [ ] All required Azure services are provisioned: Azure Content Safety, Azure API Management, Azure Functions, Azure OpenAI, Azure Monitor
...
```markdown
## Review Report — Content Moderation
