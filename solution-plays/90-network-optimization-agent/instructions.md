---
description: "Root coding instructions for Network Optimization Agent (Play 90)"
applyTo: "**/*"
---

# Network Optimization Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Network Optimization Agent solution play (Play 90). It implements a production-grade Network Optimization Agent system on Azure using the FAI Protocol for AI primitive unification.
