...
- **WAF Pillars**: reliability, performance-efficiency, security, cost-optimization, operational-excellence
...
- [ ] Solution follows the **Telecom Network Intelligence** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure Stream Analytics, Azure OpenAI, Azure Digital Twins, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Network Optimization Agent
