...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-network-optimization-agent-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="90-network-optimization-agent"

echo "═══ Deploying Network Optimization Agent ═══"
...
echo "═══ Network Optimization Agent deployed successfully ═══"
