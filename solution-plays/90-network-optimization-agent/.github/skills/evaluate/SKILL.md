---
name: "evaluate"
description: "Evaluate Network Optimization Agent (Play 90) quality using Azure AI Evaluation SDK"
---

# Evaluate — Network Optimization Agent

## Overview
This skill runs the evaluation pipeline for the Network Optimization Agent solution play, measuring quality metrics against production thresholds.
