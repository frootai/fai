---
description: "Domain-specific coding patterns for Network Optimization Agent (Play 90)"
applyTo: "**/*.{py,ts,js}"
---

# Network Optimization Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Network Optimization Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Network Optimization Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:90-network-optimization-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
