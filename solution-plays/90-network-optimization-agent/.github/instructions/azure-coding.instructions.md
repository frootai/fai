---
description: "Azure coding patterns and best practices for Network Optimization Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Network Optimization Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "90-network-optimization-agent")
    # ... processing logic
