# Network Optimization Agent — Plugin Extensions

This folder contains optional plugin extensions for Network Optimization Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 90-network-optimization-agent`
