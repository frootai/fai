---
description: "Root coding instructions for Document Intelligence (Play 06)"
applyTo: "**/*"
---

# Document Intelligence — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Document Intelligence solution play (Play 06). It implements a production-grade Document Intelligence system on Azure using the FAI Protocol for AI primitive unification.
