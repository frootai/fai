...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for OCR+LLM Extraction |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for OCR+LLM Extraction |
...
```markdown
## Tuning Report — Document Intelligence
