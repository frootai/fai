...
- [ ] Solution follows the **OCR+LLM Extraction** pattern correctly
- [ ] All required Azure services are provisioned: Azure Document Intelligence, Azure OpenAI, Azure Blob Storage, Azure Cosmos DB, Azure Key Vault
...
```markdown
## Review Report — Document Intelligence
