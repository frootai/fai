---
description: "Domain-specific coding patterns for Document Intelligence (Play 06)"
applyTo: "**/*.{py,ts,js}"
---

# Document Intelligence — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Document Intelligence architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Document Intelligence."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:06-document-intelligence:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
