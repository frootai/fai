---
description: "Azure coding patterns and best practices for Document Intelligence"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Document Intelligence
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "06-document-intelligence")
    # ... processing logic
