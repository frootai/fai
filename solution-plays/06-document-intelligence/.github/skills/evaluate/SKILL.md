---
name: "evaluate"
description: "Evaluate Document Intelligence (Play 06) quality using Azure AI Evaluation SDK"
---

# Evaluate — Document Intelligence

## Overview
This skill runs the evaluation pipeline for the Document Intelligence solution play, measuring quality metrics against production thresholds.
