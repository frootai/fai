---
mode: "agent"
description: "Deploy Document Intelligence (Play 06) to Azure"
tools: ["terminal", "file"]
---

# Deploy Document Intelligence to Azure

You are deploying the FrootAI Document Intelligence solution play (Play 06) to Azure.
