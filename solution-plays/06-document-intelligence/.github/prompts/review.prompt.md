---
mode: "agent"
description: "Review Document Intelligence (Play 06) code and architecture"
tools: ["terminal", "file"]
---

# Review Document Intelligence Implementation

You are reviewing the FrootAI Document Intelligence solution play (Play 06).
...
```markdown
## Review Report — Play 06: Document Intelligence
