---
description: "Azure coding patterns and best practices for Responsible Ai Dashboard"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Responsible Ai Dashboard
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "60-responsible-ai-dashboard")
    # ... processing logic
