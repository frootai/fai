...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-responsible-ai-dashboard-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="60-responsible-ai-dashboard"

echo "═══ Deploying Responsible Ai Dashboard ═══"
...
echo "═══ Responsible Ai Dashboard deployed successfully ═══"
