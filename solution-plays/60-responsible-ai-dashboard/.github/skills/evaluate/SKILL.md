---
name: "evaluate"
description: "Evaluate Responsible Ai Dashboard (Play 60) quality using Azure AI Evaluation SDK"
---

# Evaluate — Responsible Ai Dashboard

## Overview
This skill runs the evaluation pipeline for the Responsible Ai Dashboard solution play, measuring quality metrics against production thresholds.
