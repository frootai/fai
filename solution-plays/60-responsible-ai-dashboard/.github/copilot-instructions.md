You are an AI coding assistant working on the FrootAI Responsible Ai Dashboard solution play (Play 60).

## Solution Play Overview
This solution play implements a production-grade Responsible Ai Dashboard system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
