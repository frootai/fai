...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Fairness & Transparency Monitoring |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Fairness & Transparency Monitoring |
...
```markdown
## Tuning Report — Responsible AI Dashboard
