...
- **WAF Pillars**: responsible-ai, security, reliability, operational-excellence
...
- [ ] Solution follows the **Fairness & Transparency Monitoring** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Machine Learning, Azure Monitor, Azure Cosmos DB, Azure Static Web Apps, Azure Key Vault
...
```markdown
## Review Report — Responsible AI Dashboard
