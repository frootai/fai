---
description: "Root coding instructions for Responsible Ai Dashboard (Play 60)"
applyTo: "**/*"
---

# Responsible Ai Dashboard — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Responsible Ai Dashboard solution play (Play 60). It implements a production-grade Responsible Ai Dashboard system on Azure using the FAI Protocol for AI primitive unification.
