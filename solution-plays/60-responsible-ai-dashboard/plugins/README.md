# Responsible Ai Dashboard — Plugin Extensions

This folder contains optional plugin extensions for Responsible Ai Dashboard.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 60-responsible-ai-dashboard`
