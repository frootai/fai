---
name: "evaluate"
description: "Evaluate Agentic Rag (Play 21) quality using Azure AI Evaluation SDK"
---

# Evaluate — Agentic Rag

## Overview
This skill runs the evaluation pipeline for the Agentic Rag solution play, measuring quality metrics against production thresholds.
