...
- [ ] Solution follows the **Autonomous Retrieval Agent** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Container Apps, Azure Key Vault, Azure Cosmos DB, Azure Monitor
