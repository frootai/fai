---
description: "Domain-specific coding patterns for Agentic Rag (Play 21)"
applyTo: "**/*.{py,ts,js}"
---

# Agentic Rag — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Agentic Rag architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Agentic Rag."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:21-agentic-rag:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
