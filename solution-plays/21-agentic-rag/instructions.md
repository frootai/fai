---
description: "Root coding instructions for Agentic Rag (Play 21)"
applyTo: "**/*"
---

# Agentic Rag — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Agentic Rag solution play (Play 21). It implements a production-grade Agentic Rag system on Azure using the FAI Protocol for AI primitive unification.
