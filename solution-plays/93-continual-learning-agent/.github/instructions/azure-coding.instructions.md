---
description: "Azure coding patterns and best practices for Continual Learning Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Continual Learning Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "93-continual-learning-agent")
    # ... processing logic
