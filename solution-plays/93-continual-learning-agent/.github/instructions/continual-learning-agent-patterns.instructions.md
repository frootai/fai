---
description: "Domain-specific coding patterns for Continual Learning Agent (Play 93)"
applyTo: "**/*.{py,ts,js}"
---

# Continual Learning Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Continual Learning Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Continual Learning Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:93-continual-learning-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
