...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-continual-learning-agent-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="93-continual-learning-agent"

echo "═══ Deploying Continual Learning Agent ═══"
...
echo "═══ Continual Learning Agent deployed successfully ═══"
