---
name: "evaluate"
description: "Evaluate Continual Learning Agent (Play 93) quality using Azure AI Evaluation SDK"
---

# Evaluate — Continual Learning Agent

## Overview
This skill runs the evaluation pipeline for the Continual Learning Agent solution play, measuring quality metrics against production thresholds.
