---
description: "Root coding instructions for Continual Learning Agent (Play 93)"
applyTo: "**/*"
---

# Continual Learning Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Continual Learning Agent solution play (Play 93). It implements a production-grade Continual Learning Agent system on Azure using the FAI Protocol for AI primitive unification.
