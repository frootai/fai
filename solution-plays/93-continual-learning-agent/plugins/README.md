# Continual Learning Agent — Plugin Extensions

This folder contains optional plugin extensions for Continual Learning Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 93-continual-learning-agent`
