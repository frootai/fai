// COMPLIANCE: FedRAMP High + FISMA — Azure Government IL4/IL5
// Deploy on Azure Government with FIPS 140-2 encryption

// Citizen Services Chatbot (Play 84) — Azure Infrastructure
...
param prefix string = 'citizen-serv'

@description('Tags applied to all resources')
param tags object = {
  project: 'frootai'
  play: '84'
  playName: 'Citizen Services Chatbot'
