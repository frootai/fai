---
mode: "agent"
description: "Evaluate Citizen Services Chatbot (Play 84) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Citizen Services Chatbot Quality

You are evaluating the FrootAI Citizen Services Chatbot solution play (Play 84).
