---
description: "Domain-specific coding patterns for Citizen Services Chatbot (Play 84)"
applyTo: "**/*.{py,ts,js}"
---

# Citizen Services Chatbot — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Citizen Services Chatbot architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Citizen Services Chatbot."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:84-citizen-services-chatbot:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
