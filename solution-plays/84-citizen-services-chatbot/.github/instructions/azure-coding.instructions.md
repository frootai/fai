---
description: "Azure coding patterns and best practices for Citizen Services Chatbot"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Citizen Services Chatbot
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "84-citizen-services-chatbot")
    # ... processing logic
