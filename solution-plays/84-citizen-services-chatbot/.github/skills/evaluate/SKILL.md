---
name: "evaluate"
description: "Evaluate Citizen Services Chatbot (Play 84) quality using Azure AI Evaluation SDK"
---

# Evaluate — Citizen Services Chatbot

## Overview
This skill runs the evaluation pipeline for the Citizen Services Chatbot solution play, measuring quality metrics against production thresholds.
