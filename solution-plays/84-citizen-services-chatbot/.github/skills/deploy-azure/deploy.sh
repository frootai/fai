...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-citizen-services-chatbot-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="84-citizen-services-chatbot"

echo "═══ Deploying Citizen Services Chatbot ═══"
...
echo "═══ Citizen Services Chatbot deployed successfully ═══"
