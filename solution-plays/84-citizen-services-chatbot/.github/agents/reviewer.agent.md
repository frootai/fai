...
- [ ] Solution follows the **Municipal AI Assistant** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Translator, Azure Communication Services, Azure AI Search, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — Citizen Services Chatbot
