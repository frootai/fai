...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Municipal AI Assistant |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Municipal AI Assistant |
...
```markdown
## Tuning Report — Citizen Services Chatbot
