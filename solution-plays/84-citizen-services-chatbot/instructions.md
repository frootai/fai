---
description: "Root coding instructions for Citizen Services Chatbot (Play 84)"
applyTo: "**/*"
---

# Citizen Services Chatbot — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Citizen Services Chatbot solution play (Play 84). It implements a production-grade Citizen Services Chatbot system on Azure using the FAI Protocol for AI primitive unification.
