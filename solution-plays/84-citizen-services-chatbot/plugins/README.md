# Citizen Services Chatbot — Plugin Extensions

This folder contains optional plugin extensions for Citizen Services Chatbot.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 84-citizen-services-chatbot`
