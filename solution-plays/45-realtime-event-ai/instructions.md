---
description: "Root coding instructions for Realtime Event Ai (Play 45)"
applyTo: "**/*"
---

# Realtime Event Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Realtime Event Ai solution play (Play 45). It implements a production-grade Realtime Event Ai system on Azure using the FAI Protocol for AI primitive unification.
