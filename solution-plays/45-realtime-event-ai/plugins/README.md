# Realtime Event Ai — Plugin Extensions

This folder contains optional plugin extensions for Realtime Event Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 45-realtime-event-ai`
