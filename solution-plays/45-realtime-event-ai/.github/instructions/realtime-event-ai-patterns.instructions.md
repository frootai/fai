---
description: "Domain-specific coding patterns for Realtime Event Ai (Play 45)"
applyTo: "**/*.{py,ts,js}"
---

# Realtime Event Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Realtime Event Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Realtime Event Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:45-realtime-event-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
