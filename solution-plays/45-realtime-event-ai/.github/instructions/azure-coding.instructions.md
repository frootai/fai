---
description: "Azure coding patterns and best practices for Realtime Event Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Realtime Event Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "45-realtime-event-ai")
    # ... processing logic
