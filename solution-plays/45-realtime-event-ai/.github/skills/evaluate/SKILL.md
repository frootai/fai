---
name: "evaluate"
description: "Evaluate Realtime Event Ai (Play 45) quality using Azure AI Evaluation SDK"
---

# Evaluate — Realtime Event Ai

## Overview
This skill runs the evaluation pipeline for the Realtime Event Ai solution play, measuring quality metrics against production thresholds.
