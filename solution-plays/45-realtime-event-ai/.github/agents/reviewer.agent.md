...
- **WAF Pillars**: reliability, performance-efficiency, cost-optimization, security
...
- [ ] Solution follows the **Streaming AI Pipeline** pattern correctly
- [ ] All required Azure services are provisioned: Azure Event Hubs, Azure Functions, Azure OpenAI, Azure Cosmos DB, Azure SignalR, Azure Stream Analytics
...
```markdown
## Review Report — Real-Time Event AI
