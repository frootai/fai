...
|-----------|----------|-------------------|-----|
| model | gpt-4o-mini | gpt-4o-mini | Best quality/cost balance for Streaming AI Pipeline |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Streaming AI Pipeline |
...
```markdown
## Tuning Report — Real-Time Event AI
