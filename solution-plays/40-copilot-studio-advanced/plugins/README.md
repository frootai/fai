# Copilot Studio Advanced — Plugin Extensions

This folder contains optional plugin extensions for Copilot Studio Advanced.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 40-copilot-studio-advanced`
