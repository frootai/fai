---
description: "Root coding instructions for Copilot Studio Advanced (Play 40)"
applyTo: "**/*"
---

# Copilot Studio Advanced — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Copilot Studio Advanced solution play (Play 40). It implements a production-grade Copilot Studio Advanced system on Azure using the FAI Protocol for AI primitive unification.
