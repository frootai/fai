...
- [ ] Solution follows the **Enterprise Copilot Plugin** pattern correctly
- [ ] All required Azure services are provisioned: Microsoft Copilot Studio, Azure OpenAI, Dataverse, Microsoft Graph, Power Platform, Azure Key Vault
...
```markdown
## Review Report — Copilot Studio Advanced
