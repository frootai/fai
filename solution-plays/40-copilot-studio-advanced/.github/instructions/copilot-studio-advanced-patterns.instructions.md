---
description: "Domain-specific coding patterns for Copilot Studio Advanced (Play 40)"
applyTo: "**/*.{py,ts,js}"
---

# Copilot Studio Advanced — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Copilot Studio Advanced architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Copilot Studio Advanced."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:40-copilot-studio-advanced:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
