---
description: "Azure coding patterns and best practices for Copilot Studio Advanced"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Copilot Studio Advanced
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "40-copilot-studio-advanced")
    # ... processing logic
