---
name: "evaluate"
description: "Evaluate Copilot Studio Advanced (Play 40) quality using Azure AI Evaluation SDK"
---

# Evaluate — Copilot Studio Advanced

## Overview
This skill runs the evaluation pipeline for the Copilot Studio Advanced solution play, measuring quality metrics against production thresholds.
