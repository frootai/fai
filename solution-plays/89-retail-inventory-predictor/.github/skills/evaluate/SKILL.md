---
name: "evaluate"
description: "Evaluate Retail Inventory Predictor (Play 89) quality using Azure AI Evaluation SDK"
---

# Evaluate — Retail Inventory Predictor

## Overview
This skill runs the evaluation pipeline for the Retail Inventory Predictor solution play, measuring quality metrics against production thresholds.
