...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-retail-inventory-predictor-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="89-retail-inventory-predictor"

echo "═══ Deploying Retail Inventory Predictor ═══"
...
echo "═══ Retail Inventory Predictor deployed successfully ═══"
