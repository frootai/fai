---
description: "Domain-specific coding patterns for Retail Inventory Predictor (Play 89)"
applyTo: "**/*.{py,ts,js}"
---

# Retail Inventory Predictor — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Retail Inventory Predictor architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Retail Inventory Predictor."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:89-retail-inventory-predictor:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
