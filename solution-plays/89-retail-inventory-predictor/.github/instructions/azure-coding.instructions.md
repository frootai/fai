---
description: "Azure coding patterns and best practices for Retail Inventory Predictor"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Retail Inventory Predictor
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "89-retail-inventory-predictor")
    # ... processing logic
