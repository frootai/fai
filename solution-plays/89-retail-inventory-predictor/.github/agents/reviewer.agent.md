...
- [ ] Solution follows the **Demand Forecasting** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Machine Learning, Azure Cosmos DB, Azure Event Hubs, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Retail Inventory Predictor
