---
description: "Root coding instructions for Retail Inventory Predictor (Play 89)"
applyTo: "**/*"
---

# Retail Inventory Predictor — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Retail Inventory Predictor solution play (Play 89). It implements a production-grade Retail Inventory Predictor system on Azure using the FAI Protocol for AI primitive unification.
