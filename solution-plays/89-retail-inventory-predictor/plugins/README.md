# Retail Inventory Predictor — Plugin Extensions

This folder contains optional plugin extensions for Retail Inventory Predictor.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 89-retail-inventory-predictor`
