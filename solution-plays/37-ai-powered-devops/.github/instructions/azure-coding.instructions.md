---
description: "Azure coding patterns and best practices for Ai Powered Devops"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Powered Devops
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "37-ai-powered-devops")
    # ... processing logic
