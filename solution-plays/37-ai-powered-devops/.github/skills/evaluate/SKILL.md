---
name: "evaluate"
description: "Evaluate Ai Powered Devops (Play 37) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Powered Devops

## Overview
This skill runs the evaluation pipeline for the Ai Powered Devops solution play, measuring quality metrics against production thresholds.
