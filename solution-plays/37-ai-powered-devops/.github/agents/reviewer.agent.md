...
- **WAF Pillars**: operational-excellence, reliability, security, cost-optimization
...
- [ ] Solution follows the **Intelligent SRE** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Monitor, Azure DevOps, GitHub Actions, Azure Container Apps, Azure Log Analytics
...
```markdown
## Review Report — AI-Powered DevOps
