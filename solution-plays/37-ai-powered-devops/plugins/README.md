# Ai Powered Devops — Plugin Extensions

This folder contains optional plugin extensions for Ai Powered Devops.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 37-ai-powered-devops`
