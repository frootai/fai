---
description: "Root coding instructions for Ai Powered Devops (Play 37)"
applyTo: "**/*"
---

# Ai Powered Devops — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Powered Devops solution play (Play 37). It implements a production-grade Ai Powered Devops system on Azure using the FAI Protocol for AI primitive unification.
