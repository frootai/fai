# Ai Security Hardening — Plugin Extensions

This folder contains optional plugin extensions for Ai Security Hardening.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 30-ai-security-hardening`
