---
description: "Root coding instructions for Ai Security Hardening (Play 30)"
applyTo: "**/*"
---

# Ai Security Hardening — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Security Hardening solution play (Play 30). It implements a production-grade Ai Security Hardening system on Azure using the FAI Protocol for AI primitive unification.
