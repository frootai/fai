---
name: "evaluate"
description: "Evaluate Ai Security Hardening (Play 30) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Security Hardening

## Overview
This skill runs the evaluation pipeline for the Ai Security Hardening solution play, measuring quality metrics against production thresholds.
