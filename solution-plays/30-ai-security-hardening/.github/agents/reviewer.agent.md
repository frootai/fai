...
- [ ] Solution follows the **LLM Security Defense** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Content Safety, Azure OpenAI, Azure Container Apps, Azure Key Vault, Azure Monitor, Azure Policy
...
```markdown
## Review Report — AI Security Hardening
