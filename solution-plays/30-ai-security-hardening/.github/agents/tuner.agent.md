...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for LLM Security Defense |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for LLM Security Defense |
...
```markdown
## Tuning Report — AI Security Hardening
