---
description: "Domain-specific coding patterns for Ai Security Hardening (Play 30)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Security Hardening — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Security Hardening architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Security Hardening."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:30-ai-security-hardening:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
