---
description: "Azure coding patterns and best practices for Ai Security Hardening"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Security Hardening
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "30-ai-security-hardening")
    # ... processing logic
