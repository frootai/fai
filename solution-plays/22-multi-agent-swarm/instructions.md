---
description: "Root coding instructions for Multi Agent Swarm (Play 22)"
applyTo: "**/*"
---

# Multi Agent Swarm — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Multi Agent Swarm solution play (Play 22). It implements a production-grade Multi Agent Swarm system on Azure using the FAI Protocol for AI primitive unification.
