...
- [ ] Solution follows the **Distributed Agent Teams** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Container Apps, Azure Service Bus, Azure Cosmos DB, Azure Monitor, Azure Key Vault
...
```markdown
## Review Report — Multi-Agent Swarm
