---
name: "evaluate"
description: "Evaluate Multi Agent Swarm (Play 22) quality using Azure AI Evaluation SDK"
---

# Evaluate — Multi Agent Swarm

## Overview
This skill runs the evaluation pipeline for the Multi Agent Swarm solution play, measuring quality metrics against production thresholds.
