---
description: "Azure coding patterns and best practices for Multi Agent Swarm"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Multi Agent Swarm
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "22-multi-agent-swarm")
    # ... processing logic
