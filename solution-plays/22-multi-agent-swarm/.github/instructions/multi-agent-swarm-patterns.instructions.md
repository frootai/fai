---
description: "Domain-specific coding patterns for Multi Agent Swarm (Play 22)"
applyTo: "**/*.{py,ts,js}"
---

# Multi Agent Swarm — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Multi Agent Swarm architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Multi Agent Swarm."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:22-multi-agent-swarm:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
