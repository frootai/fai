# Multi Agent Swarm — Plugin Extensions

This folder contains optional plugin extensions for Multi Agent Swarm.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 22-multi-agent-swarm`
