---
description: "Root coding instructions for Model Serving Aks (Play 12)"
applyTo: "**/*"
---

# Model Serving Aks — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Model Serving Aks solution play (Play 12). It implements a production-grade Model Serving Aks system on Azure using the FAI Protocol for AI primitive unification.
