---
name: "evaluate"
description: "Evaluate Model Serving Aks (Play 12) quality using Azure AI Evaluation SDK"
---

# Evaluate — Model Serving Aks

## Overview
This skill runs the evaluation pipeline for the Model Serving Aks solution play, measuring quality metrics against production thresholds.
