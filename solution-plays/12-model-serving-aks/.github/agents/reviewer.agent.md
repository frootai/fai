...
- [ ] Solution follows the **GPU Cluster Inference** pattern correctly
- [ ] All required Azure services are provisioned: Azure Kubernetes Service, NVIDIA GPU Nodes (A100/H100), vLLM, Azure Container Registry, Azure OpenAI, Azure Monitor, Azure Key Vault
...
```markdown
## Review Report — Model Serving AKS
