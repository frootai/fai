---
mode: "agent"
description: "Evaluate Model Serving Aks (Play 12) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Model Serving Aks Quality

You are evaluating the FrootAI Model Serving Aks solution play (Play 12).
