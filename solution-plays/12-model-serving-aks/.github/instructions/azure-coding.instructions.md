---
description: "Azure coding patterns and best practices for Model Serving Aks"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Model Serving Aks
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "12-model-serving-aks")
    # ... processing logic
