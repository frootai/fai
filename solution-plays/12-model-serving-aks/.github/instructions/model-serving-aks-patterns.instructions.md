---
description: "Domain-specific coding patterns for Model Serving Aks (Play 12)"
applyTo: "**/*.{py,ts,js}"
---

# Model Serving Aks — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Model Serving Aks architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Model Serving Aks."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:12-model-serving-aks:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
