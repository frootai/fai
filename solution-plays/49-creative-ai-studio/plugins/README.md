# Creative Ai Studio — Plugin Extensions

This folder contains optional plugin extensions for Creative Ai Studio.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 49-creative-ai-studio`
