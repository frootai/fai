---
description: "Root coding instructions for Creative Ai Studio (Play 49)"
applyTo: "**/*"
---

# Creative Ai Studio — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Creative Ai Studio solution play (Play 49). It implements a production-grade Creative Ai Studio system on Azure using the FAI Protocol for AI primitive unification.
