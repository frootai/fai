---
name: "deploy-azure"
description: "Deploy Creative Ai Studio (Play 49) infrastructure and application to Azure"
---

# Deploy Azure — Creative Ai Studio

## Overview
This skill deploys the Creative Ai Studio solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=49
```
...
az deployment group create \
  ...
  --name "deploy-play-49-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-49* --query properties.outputs -o json)
