---
name: "evaluate"
description: "Evaluate Creative Ai Studio (Play 49) quality using Azure AI Evaluation SDK"
---

# Evaluate — Creative Ai Studio

## Overview
This skill runs the evaluation pipeline for the Creative Ai Studio solution play, measuring quality metrics against production thresholds.
