---
description: "Domain-specific coding patterns for Creative Ai Studio (Play 49)"
applyTo: "**/*.{py,ts,js}"
---

# Creative Ai Studio — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Creative Ai Studio architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Creative Ai Studio."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:49-creative-ai-studio:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
