---
description: "Azure coding patterns and best practices for Creative Ai Studio"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Creative Ai Studio
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "49-creative-ai-studio")
    # ... processing logic
