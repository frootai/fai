You are an AI coding assistant working on the FrootAI Creative Ai Studio solution play (Play 49).

## Solution Play Overview
This solution play implements a production-grade Creative Ai Studio system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
