# Fraud Detection Agent — Plugin Extensions

This folder contains optional plugin extensions for Fraud Detection Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 63-fraud-detection-agent`
