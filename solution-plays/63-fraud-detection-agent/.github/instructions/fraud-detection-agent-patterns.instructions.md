---
description: "Domain-specific coding patterns for Fraud Detection Agent (Play 63)"
applyTo: "**/*.{py,ts,js}"
---

# Fraud Detection Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Fraud Detection Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Fraud Detection Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:63-fraud-detection-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
