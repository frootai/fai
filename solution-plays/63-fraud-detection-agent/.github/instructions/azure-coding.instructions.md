---
description: "Azure coding patterns and best practices for Fraud Detection Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Fraud Detection Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "63-fraud-detection-agent")
    # ... processing logic
