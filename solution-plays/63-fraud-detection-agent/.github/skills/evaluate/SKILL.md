---
name: "evaluate"
description: "Evaluate Fraud Detection Agent (Play 63) quality using Azure AI Evaluation SDK"
---

# Evaluate — Fraud Detection Agent

## Overview
This skill runs the evaluation pipeline for the Fraud Detection Agent solution play, measuring quality metrics against production thresholds.
