...
|-----------|----------|-------------------|-----|
| model | gpt-4o-mini | gpt-4o-mini | Best quality/cost balance for Real-Time Transaction Analysis |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Real-Time Transaction Analysis |
...
```markdown
## Tuning Report — Fraud Detection Agent
