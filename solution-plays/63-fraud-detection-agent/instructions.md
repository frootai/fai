---
description: "Root coding instructions for Fraud Detection Agent (Play 63)"
applyTo: "**/*"
---

# Fraud Detection Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Fraud Detection Agent solution play (Play 63). It implements a production-grade Fraud Detection Agent system on Azure using the FAI Protocol for AI primitive unification.
