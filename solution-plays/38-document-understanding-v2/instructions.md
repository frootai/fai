---
description: "Root coding instructions for Document Understanding V2 (Play 38)"
applyTo: "**/*"
---

# Document Understanding V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Document Understanding V2 solution play (Play 38). It implements a production-grade Document Understanding V2 system on Azure using the FAI Protocol for AI primitive unification.
