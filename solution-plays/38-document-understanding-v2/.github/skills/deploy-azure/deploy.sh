...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-document-understanding-v2-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="38-document-understanding-v2"

echo "═══ Deploying Document Understanding V2 ═══"
...
echo "═══ Document Understanding V2 deployed successfully ═══"
