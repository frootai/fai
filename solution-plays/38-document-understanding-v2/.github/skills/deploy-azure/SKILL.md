---
name: "deploy-azure"
description: "Deploy Document Understanding V2 (Play 38) infrastructure and application to Azure"
---

# Deploy Azure — Document Understanding V2

## Overview
This skill deploys the Document Understanding V2 solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=38
```
...
az deployment group create \
  ...
  --name "deploy-play-38-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-38* --query properties.outputs -o json)
