---
name: "evaluate"
description: "Evaluate Document Understanding V2 (Play 38) quality using Azure AI Evaluation SDK"
---

# Evaluate — Document Understanding V2

## Overview
This skill runs the evaluation pipeline for the Document Understanding V2 solution play, measuring quality metrics against production thresholds.
