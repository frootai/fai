---
description: "Azure coding patterns and best practices for Document Understanding V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Document Understanding V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "38-document-understanding-v2")
    # ... processing logic
