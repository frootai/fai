---
description: "Domain-specific coding patterns for Document Understanding V2 (Play 38)"
applyTo: "**/*.{py,ts,js}"
---

# Document Understanding V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Document Understanding V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Document Understanding V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:38-document-understanding-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
