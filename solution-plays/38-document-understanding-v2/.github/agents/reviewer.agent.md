...
- [ ] Solution follows the **Advanced Document Processing** pattern correctly
- [ ] All required Azure services are provisioned: Azure AI Document Intelligence, Azure OpenAI, Azure Blob Storage, Azure Cosmos DB, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Document Understanding v2
