---
description: "Root coding instructions for Food Safety Inspector Ai (Play 79)"
applyTo: "**/*"
---

# Food Safety Inspector Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Food Safety Inspector Ai solution play (Play 79). It implements a production-grade Food Safety Inspector Ai system on Azure using the FAI Protocol for AI primitive unification.
