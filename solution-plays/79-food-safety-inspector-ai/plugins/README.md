# Food Safety Inspector Ai — Plugin Extensions

This folder contains optional plugin extensions for Food Safety Inspector Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 79-food-safety-inspector-ai`
