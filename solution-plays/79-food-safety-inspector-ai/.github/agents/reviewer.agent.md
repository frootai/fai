...
- [ ] Solution follows the **HACCP Compliance** pattern correctly
- [ ] All required Azure services are provisioned: Azure Document Intelligence, Azure OpenAI, Azure Cosmos DB, Azure Event Hubs, Azure IoT Hub, Azure Monitor
...
```markdown
## Review Report — Food Safety Inspector AI
