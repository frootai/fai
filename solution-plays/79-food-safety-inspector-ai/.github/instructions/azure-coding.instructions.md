---
description: "Azure coding patterns and best practices for Food Safety Inspector Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Food Safety Inspector Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "79-food-safety-inspector-ai")
    # ... processing logic
