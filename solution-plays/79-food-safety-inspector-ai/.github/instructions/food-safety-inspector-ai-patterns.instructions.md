---
description: "Domain-specific coding patterns for Food Safety Inspector Ai (Play 79)"
applyTo: "**/*.{py,ts,js}"
---

# Food Safety Inspector Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Food Safety Inspector Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Food Safety Inspector Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:79-food-safety-inspector-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
