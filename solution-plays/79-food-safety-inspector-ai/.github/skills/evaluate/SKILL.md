---
name: "evaluate"
description: "Evaluate Food Safety Inspector Ai (Play 79) quality using Azure AI Evaluation SDK"
---

# Evaluate — Food Safety Inspector Ai

## Overview
This skill runs the evaluation pipeline for the Food Safety Inspector Ai solution play, measuring quality metrics against production thresholds.
