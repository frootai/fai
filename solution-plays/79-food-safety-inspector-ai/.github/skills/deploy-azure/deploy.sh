...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-food-safety-inspector-ai-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="79-food-safety-inspector-ai"

echo "═══ Deploying Food Safety Inspector Ai ═══"
...
echo "═══ Food Safety Inspector Ai deployed successfully ═══"
