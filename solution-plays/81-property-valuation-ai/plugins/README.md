# Property Valuation Ai — Plugin Extensions

This folder contains optional plugin extensions for Property Valuation Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 81-property-valuation-ai`
