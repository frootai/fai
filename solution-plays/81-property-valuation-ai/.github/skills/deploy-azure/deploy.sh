#!/bin/bash
# Deploy Property Valuation Ai to Azure
# Usage: ./deploy.sh [dev|staging|prod]

set -euo pipefail

ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-property-valuation-ai-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="81-property-valuation-ai"

echo "═══ Deploying Property Valuation Ai ═══"
...
echo "═══ Property Valuation Ai deployed successfully ═══"
