---
name: "deploy-azure"
description: "Deploy Property Valuation Ai (Play 81) infrastructure and application to Azure"
---

# Deploy Azure — Property Valuation Ai

## Overview
This skill deploys the Property Valuation Ai solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=81
```
...
az deployment group create \
  ...
  --name "deploy-play-81-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-81* --query properties.outputs -o json)
