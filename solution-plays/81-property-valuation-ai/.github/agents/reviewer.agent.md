...
- [ ] Solution follows the **Automated Appraisal** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Cosmos DB, Azure Machine Learning, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Property Valuation AI
