---
description: "Azure coding patterns and best practices for Property Valuation Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Property Valuation Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "81-property-valuation-ai")
    # ... processing logic
