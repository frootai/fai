---
description: "Domain-specific coding patterns for Property Valuation Ai (Play 81)"
applyTo: "**/*.{py,ts,js}"
---

# Property Valuation Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Property Valuation Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Property Valuation Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:81-property-valuation-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
