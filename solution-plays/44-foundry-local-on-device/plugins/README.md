# Foundry Local On Device — Plugin Extensions

This folder contains optional plugin extensions for Foundry Local On Device.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 44-foundry-local-on-device`
