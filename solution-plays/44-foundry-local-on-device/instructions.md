---
description: "Root coding instructions for Foundry Local On Device (Play 44)"
applyTo: "**/*"
---

# Foundry Local On Device — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Foundry Local On Device solution play (Play 44). It implements a production-grade Foundry Local On Device system on Azure using the FAI Protocol for AI primitive unification.
