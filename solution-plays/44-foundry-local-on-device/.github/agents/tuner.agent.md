...
|-----------|----------|-------------------|-----|
| model | phi-4-mini | phi-4-mini | Best quality/cost balance for Air-Gapped Local Inference |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Air-Gapped Local Inference |
...
```markdown
## Tuning Report — Foundry Local On-Device
