...
- [ ] Solution follows the **Air-Gapped Local Inference** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure IoT Hub, Azure Monitor, Azure Key Vault, Azure Blob Storage, ONNX Runtime
...
```markdown
## Review Report — Foundry Local On-Device
