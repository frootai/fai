---
description: "Domain-specific coding patterns for Foundry Local On Device (Play 44)"
applyTo: "**/*.{py,ts,js}"
---

# Foundry Local On Device — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Foundry Local On Device architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Foundry Local On Device."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:44-foundry-local-on-device:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
