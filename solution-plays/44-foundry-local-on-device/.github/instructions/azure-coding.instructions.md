---
description: "Azure coding patterns and best practices for Foundry Local On Device"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Foundry Local On Device
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "44-foundry-local-on-device")
    # ... processing logic
