---
name: "evaluate"
description: "Evaluate Foundry Local On Device (Play 44) quality using Azure AI Evaluation SDK"
---

# Evaluate — Foundry Local On Device

## Overview
This skill runs the evaluation pipeline for the Foundry Local On Device solution play, measuring quality metrics against production thresholds.
