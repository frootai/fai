---
description: "Root coding instructions for It Ticket Resolution (Play 05)"
applyTo: "**/*"
---

# It Ticket Resolution — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI It Ticket Resolution solution play (Play 05). It implements a production-grade It Ticket Resolution system on Azure using the FAI Protocol for AI primitive unification.
