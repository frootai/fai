...
|-----------|----------|-------------------|-----|
| model | gpt-4o-mini | gpt-4o-mini | Best quality/cost balance for Event-Driven Automation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Event-Driven Automation |
...
```markdown
## Tuning Report — IT Ticket Resolution
