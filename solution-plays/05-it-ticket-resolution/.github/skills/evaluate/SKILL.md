---
name: "evaluate"
description: "Evaluate It Ticket Resolution (Play 05) quality using Azure AI Evaluation SDK"
---

# Evaluate — It Ticket Resolution

## Overview
This skill runs the evaluation pipeline for the It Ticket Resolution solution play, measuring quality metrics against production thresholds.
