---
description: "Domain-specific coding patterns for It Ticket Resolution (Play 05)"
applyTo: "**/*.{py,ts,js}"
---

# It Ticket Resolution — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a It Ticket Resolution architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for It Ticket Resolution."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:05-it-ticket-resolution:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
