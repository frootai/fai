---
description: "Azure coding patterns and best practices for It Ticket Resolution"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — It Ticket Resolution
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "05-it-ticket-resolution")
    # ... processing logic
