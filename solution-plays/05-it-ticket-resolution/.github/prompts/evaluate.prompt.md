---
mode: "agent"
description: "Evaluate It Ticket Resolution (Play 05) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate It Ticket Resolution Quality

You are evaluating the FrootAI It Ticket Resolution solution play (Play 05).
