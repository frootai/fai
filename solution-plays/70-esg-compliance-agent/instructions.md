---
description: "Root coding instructions for Esg Compliance Agent (Play 70)"
applyTo: "**/*"
---

# Esg Compliance Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Esg Compliance Agent solution play (Play 70). It implements a production-grade Esg Compliance Agent system on Azure using the FAI Protocol for AI primitive unification.
