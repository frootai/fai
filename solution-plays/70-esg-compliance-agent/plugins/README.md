# Esg Compliance Agent — Plugin Extensions

This folder contains optional plugin extensions for Esg Compliance Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 70-esg-compliance-agent`
