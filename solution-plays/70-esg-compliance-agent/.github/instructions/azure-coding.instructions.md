---
description: "Azure coding patterns and best practices for Esg Compliance Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Esg Compliance Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "70-esg-compliance-agent")
    # ... processing logic
