---
description: "Domain-specific coding patterns for Esg Compliance Agent (Play 70)"
applyTo: "**/*.{py,ts,js}"
---

# Esg Compliance Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Esg Compliance Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Esg Compliance Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:70-esg-compliance-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
