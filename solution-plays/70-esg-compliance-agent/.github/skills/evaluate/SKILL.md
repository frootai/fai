---
name: "evaluate"
description: "Evaluate Esg Compliance Agent (Play 70) quality using Azure AI Evaluation SDK"
---

# Evaluate — Esg Compliance Agent

## Overview
This skill runs the evaluation pipeline for the Esg Compliance Agent solution play, measuring quality metrics against production thresholds.
