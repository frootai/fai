You are an AI coding assistant working on the FrootAI Esg Compliance Agent solution play (Play 70).

## Solution Play Overview
This solution play implements a production-grade Esg Compliance Agent system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
