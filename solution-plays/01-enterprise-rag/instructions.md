---
description: "Root coding instructions for Enterprise Rag (Play 01)"
applyTo: "**/*"
---

# Enterprise Rag — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Enterprise Rag solution play (Play 01). It implements a production-grade Enterprise Rag system on Azure using the FAI Protocol for AI primitive unification.
