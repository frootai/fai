---
name: "evaluate"
description: "Evaluate Enterprise Rag (Play 01) quality using Azure AI Evaluation SDK"
---

# Evaluate — Enterprise Rag

## Overview
This skill runs the evaluation pipeline for the Enterprise Rag solution play, measuring quality metrics against production thresholds.
