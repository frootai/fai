---
description: "Azure coding patterns and best practices for Enterprise Rag"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Enterprise Rag
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "01-enterprise-rag")
    # ... processing logic
