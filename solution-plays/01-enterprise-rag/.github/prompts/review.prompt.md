---
mode: "agent"
description: "Review Enterprise Rag (Play 01) code and architecture"
tools: ["terminal", "file"]
---

# Review Enterprise Rag Implementation

You are reviewing the FrootAI Enterprise Rag solution play (Play 01).
...
```markdown
## Review Report — Play 01: Enterprise Rag
