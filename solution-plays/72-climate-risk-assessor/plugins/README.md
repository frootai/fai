# Climate Risk Assessor — Plugin Extensions

This folder contains optional plugin extensions for Climate Risk Assessor.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 72-climate-risk-assessor`
