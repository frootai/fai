---
description: "Root coding instructions for Climate Risk Assessor (Play 72)"
applyTo: "**/*"
---

# Climate Risk Assessor — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Climate Risk Assessor solution play (Play 72). It implements a production-grade Climate Risk Assessor system on Azure using the FAI Protocol for AI primitive unification.
