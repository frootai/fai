...
- [ ] Solution follows the **Scenario Modeling** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Machine Learning, Azure Cosmos DB, Azure AI Search, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Climate Risk Assessor
