---
name: "evaluate"
description: "Evaluate Climate Risk Assessor (Play 72) quality using Azure AI Evaluation SDK"
---

# Evaluate — Climate Risk Assessor

## Overview
This skill runs the evaluation pipeline for the Climate Risk Assessor solution play, measuring quality metrics against production thresholds.
