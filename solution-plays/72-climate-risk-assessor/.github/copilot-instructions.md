You are an AI coding assistant working on the FrootAI Climate Risk Assessor solution play (Play 72).

## Solution Play Overview
This solution play implements a production-grade Climate Risk Assessor system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
