---
description: "Domain-specific coding patterns for Climate Risk Assessor (Play 72)"
applyTo: "**/*.{py,ts,js}"
---

# Climate Risk Assessor — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Climate Risk Assessor architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Climate Risk Assessor."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:72-climate-risk-assessor:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
