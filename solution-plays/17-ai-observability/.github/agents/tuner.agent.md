...
|-----------|----------|-------------------|-----|
| model | gpt-4o-mini | gpt-4o-mini | Best quality/cost balance for Monitoring & Alerting |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Monitoring & Alerting |
...
```markdown
## Tuning Report — AI Observability
