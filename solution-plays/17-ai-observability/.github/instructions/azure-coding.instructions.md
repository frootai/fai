---
description: "Azure coding patterns and best practices for Ai Observability"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Observability
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "17-ai-observability")
    # ... processing logic
