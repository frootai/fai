---
description: "Domain-specific coding patterns for Ai Observability (Play 17)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Observability — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Observability architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Observability."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:17-ai-observability:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
