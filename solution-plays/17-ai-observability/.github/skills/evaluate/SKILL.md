---
name: "evaluate"
description: "Evaluate Ai Observability (Play 17) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Observability

## Overview
This skill runs the evaluation pipeline for the Ai Observability solution play, measuring quality metrics against production thresholds.
