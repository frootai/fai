---
description: "Root coding instructions for Ai Observability (Play 17)"
applyTo: "**/*"
---

# Ai Observability — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Observability solution play (Play 17). It implements a production-grade Ai Observability system on Azure using the FAI Protocol for AI primitive unification.
