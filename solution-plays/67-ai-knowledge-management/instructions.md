---
description: "Root coding instructions for Ai Knowledge Management (Play 67)"
applyTo: "**/*"
---

# Ai Knowledge Management — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Knowledge Management solution play (Play 67). It implements a production-grade Ai Knowledge Management system on Azure using the FAI Protocol for AI primitive unification.
