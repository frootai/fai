---
description: "Azure coding patterns and best practices for Ai Knowledge Management"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Knowledge Management
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "67-ai-knowledge-management")
    # ... processing logic
