---
description: "Domain-specific coding patterns for Ai Knowledge Management (Play 67)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Knowledge Management — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Knowledge Management architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Knowledge Management."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:67-ai-knowledge-management:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
