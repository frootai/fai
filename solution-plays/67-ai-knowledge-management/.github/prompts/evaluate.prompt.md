---
mode: "agent"
description: "Evaluate Ai Knowledge Management (Play 67) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Knowledge Management Quality

You are evaluating the FrootAI Ai Knowledge Management solution play (Play 67).
