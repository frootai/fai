---
name: "evaluate"
description: "Evaluate Ai Knowledge Management (Play 67) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Knowledge Management

## Overview
This skill runs the evaluation pipeline for the Ai Knowledge Management solution play, measuring quality metrics against production thresholds.
