...
- [ ] Solution follows the **Enterprise Knowledge Capture** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Cosmos DB, Azure Blob Storage, Microsoft Graph, Azure Monitor
...
```markdown
## Review Report — AI Knowledge Management
