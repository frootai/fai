---
description: "Azure coding patterns and best practices for Prompt Management"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Prompt Management
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "18-prompt-management")
    # ... processing logic
