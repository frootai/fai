---
description: "Domain-specific coding patterns for Prompt Management (Play 18)"
applyTo: "**/*.{py,ts,js}"
---

# Prompt Management — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Prompt Management architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Prompt Management."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:18-prompt-management:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
