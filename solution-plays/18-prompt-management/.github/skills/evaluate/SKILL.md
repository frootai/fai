---
name: "evaluate"
description: "Evaluate Prompt Management (Play 18) quality using Azure AI Evaluation SDK"
---

# Evaluate — Prompt Management

## Overview
This skill runs the evaluation pipeline for the Prompt Management solution play, measuring quality metrics against production thresholds.
