...
- [ ] Solution follows the **Prompt Versioning & A/B** pattern correctly
- [ ] All required Azure services are provisioned: Azure Prompt Flow, Git, GitHub Actions, Azure AI Foundry, Azure Cosmos DB, Azure App Service
...
```markdown
## Review Report — Prompt Management
