...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Prompt Versioning & A/B |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Prompt Versioning & A/B |
...
```markdown
## Tuning Report — Prompt Management
