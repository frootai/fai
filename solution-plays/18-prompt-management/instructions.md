---
description: "Root coding instructions for Prompt Management (Play 18)"
applyTo: "**/*"
---

# Prompt Management — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Prompt Management solution play (Play 18). It implements a production-grade Prompt Management system on Azure using the FAI Protocol for AI primitive unification.
