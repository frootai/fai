---
mode: "agent"
description: "Deploy Ai Data Pipeline (Play 27) to Azure"
tools: ["terminal", "file"]
---

# Deploy Ai Data Pipeline to Azure

You are deploying the FrootAI Ai Data Pipeline solution play (Play 27) to Azure.
