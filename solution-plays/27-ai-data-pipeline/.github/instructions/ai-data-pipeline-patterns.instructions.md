---
description: "Domain-specific coding patterns for Ai Data Pipeline (Play 27)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Data Pipeline — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Data Pipeline architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Data Pipeline."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:27-ai-data-pipeline:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
