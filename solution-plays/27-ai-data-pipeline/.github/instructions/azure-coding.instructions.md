---
description: "Azure coding patterns and best practices for Ai Data Pipeline"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Data Pipeline
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "27-ai-data-pipeline")
    # ... processing logic
