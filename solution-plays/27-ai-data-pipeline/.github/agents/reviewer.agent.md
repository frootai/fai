...
- [ ] Solution follows the **LLM-Augmented ETL** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Data Factory, Azure Blob Storage, Azure Event Hubs, Azure Cosmos DB, Azure Monitor
...
```markdown
## Review Report — AI Data Pipeline
