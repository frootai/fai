You are an AI coding assistant working on the FrootAI Ai Data Pipeline solution play (Play 27).

## Solution Play Overview
This solution play implements a production-grade Ai Data Pipeline system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
