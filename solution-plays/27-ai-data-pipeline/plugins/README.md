# Ai Data Pipeline — Plugin Extensions

This folder contains optional plugin extensions for Ai Data Pipeline.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 27-ai-data-pipeline`
