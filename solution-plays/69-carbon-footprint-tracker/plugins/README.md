# Carbon Footprint Tracker — Plugin Extensions

This folder contains optional plugin extensions for Carbon Footprint Tracker.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 69-carbon-footprint-tracker`
