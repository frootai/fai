You are an AI coding assistant working on the FrootAI Carbon Footprint Tracker solution play (Play 69).

## Solution Play Overview
This solution play implements a production-grade Carbon Footprint Tracker system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
