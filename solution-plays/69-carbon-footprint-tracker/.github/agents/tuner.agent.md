...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for ESG Carbon Accounting |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for ESG Carbon Accounting |
...
```markdown
## Tuning Report — Carbon Footprint Tracker
