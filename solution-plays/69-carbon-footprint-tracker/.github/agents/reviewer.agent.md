...
- **WAF Pillars**: security, reliability, operational-excellence, cost-optimization, responsible-ai
...
- [ ] Solution follows the **ESG Carbon Accounting** pattern correctly
- [ ] All required Azure services are provisioned: Azure Monitor, Azure OpenAI, Azure Cosmos DB, Azure Event Hubs, Azure Functions, Azure Key Vault
...
```markdown
## Review Report — Carbon Footprint Tracker
