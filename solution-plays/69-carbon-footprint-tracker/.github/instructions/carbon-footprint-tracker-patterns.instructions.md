---
description: "Domain-specific coding patterns for Carbon Footprint Tracker (Play 69)"
applyTo: "**/*.{py,ts,js}"
---

# Carbon Footprint Tracker — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Carbon Footprint Tracker architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Carbon Footprint Tracker."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:69-carbon-footprint-tracker:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
