---
description: "Azure coding patterns and best practices for Carbon Footprint Tracker"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Carbon Footprint Tracker
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "69-carbon-footprint-tracker")
    # ... processing logic
