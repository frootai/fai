...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-carbon-footprint-tracker-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="69-carbon-footprint-tracker"

echo "═══ Deploying Carbon Footprint Tracker ═══"
...
echo "═══ Carbon Footprint Tracker deployed successfully ═══"
