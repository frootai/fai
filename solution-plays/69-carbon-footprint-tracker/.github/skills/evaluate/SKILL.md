---
name: "evaluate"
description: "Evaluate Carbon Footprint Tracker (Play 69) quality using Azure AI Evaluation SDK"
---

# Evaluate — Carbon Footprint Tracker

## Overview
This skill runs the evaluation pipeline for the Carbon Footprint Tracker solution play, measuring quality metrics against production thresholds.
