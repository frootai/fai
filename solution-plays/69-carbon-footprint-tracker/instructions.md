---
description: "Root coding instructions for Carbon Footprint Tracker (Play 69)"
applyTo: "**/*"
---

# Carbon Footprint Tracker — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Carbon Footprint Tracker solution play (Play 69). It implements a production-grade Carbon Footprint Tracker system on Azure using the FAI Protocol for AI primitive unification.
