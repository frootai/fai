---
mode: "agent"
description: "Evaluate Agent Evaluation Platform (Play 98) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Agent Evaluation Platform Quality

You are evaluating the FrootAI Agent Evaluation Platform solution play (Play 98).
