...
- **WAF Pillars**: security, operational-excellence, reliability, cost-optimization
...
- [ ] Solution follows the **AI Quality Benchmarking** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Container Apps, Azure Cosmos DB, Azure Machine Learning, Azure Functions, Azure Monitor
...
```markdown
## Review Report — Agent Evaluation Platform
