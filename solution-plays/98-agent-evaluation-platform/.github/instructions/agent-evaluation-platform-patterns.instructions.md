---
description: "Domain-specific coding patterns for Agent Evaluation Platform (Play 98)"
applyTo: "**/*.{py,ts,js}"
---

# Agent Evaluation Platform — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Agent Evaluation Platform architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Agent Evaluation Platform."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:98-agent-evaluation-platform:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
