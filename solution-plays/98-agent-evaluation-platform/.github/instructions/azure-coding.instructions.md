---
description: "Azure coding patterns and best practices for Agent Evaluation Platform"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Agent Evaluation Platform
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "98-agent-evaluation-platform")
    # ... processing logic
