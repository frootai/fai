You are an AI coding assistant working on the FrootAI Agent Evaluation Platform solution play (Play 98).

## Solution Play Overview
This solution play implements a production-grade Agent Evaluation Platform system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
