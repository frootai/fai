---
name: "evaluate"
description: "Evaluate Agent Evaluation Platform (Play 98) quality using Azure AI Evaluation SDK"
---

# Evaluate — Agent Evaluation Platform

## Overview
This skill runs the evaluation pipeline for the Agent Evaluation Platform solution play, measuring quality metrics against production thresholds.
