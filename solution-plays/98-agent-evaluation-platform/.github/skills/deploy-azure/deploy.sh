...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-agent-evaluation-platform-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="98-agent-evaluation-platform"

echo "═══ Deploying Agent Evaluation Platform ═══"
...
echo "═══ Agent Evaluation Platform deployed successfully ═══"
