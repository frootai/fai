---
description: "Root coding instructions for Agent Evaluation Platform (Play 98)"
applyTo: "**/*"
---

# Agent Evaluation Platform — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Agent Evaluation Platform solution play (Play 98). It implements a production-grade Agent Evaluation Platform system on Azure using the FAI Protocol for AI primitive unification.
