# Autonomous Coding Agent — Plugin Extensions

This folder contains optional plugin extensions for Autonomous Coding Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 51-autonomous-coding-agent`
