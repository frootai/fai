---
name: "deploy-azure"
description: "Deploy Autonomous Coding Agent (Play 51) infrastructure and application to Azure"
---

# Deploy Azure — Autonomous Coding Agent

## Overview
This skill deploys the Autonomous Coding Agent solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
...
az group create --name $RESOURCE_GROUP --location $LOCATION --tags project=frootai environment=${ENVIRONMENT:-dev} play=51
```
...
az deployment group create \
  ...
  --name "deploy-play-51-$(date +%Y%m%d%H%M)"
```

## Step 4: Configure Application
```bash
# Get deployment outputs
OUTPUTS=$(az deployment group show --resource-group $RESOURCE_GROUP --name deploy-play-51* --query properties.outputs -o json)
