---
name: "evaluate"
description: "Evaluate Autonomous Coding Agent (Play 51) quality using Azure AI Evaluation SDK"
---

# Evaluate — Autonomous Coding Agent

## Overview
This skill runs the evaluation pipeline for the Autonomous Coding Agent solution play, measuring quality metrics against production thresholds.
