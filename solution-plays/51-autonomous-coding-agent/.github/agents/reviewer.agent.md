...
- [ ] Solution follows the **Issue-to-PR Pipeline** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, GitHub Actions, Azure Container Apps, Azure Monitor, Azure Key Vault, Azure Cosmos DB
...
```markdown
## Review Report — Autonomous Coding Agent
