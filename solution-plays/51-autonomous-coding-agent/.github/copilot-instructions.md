You are an AI coding assistant working on the FrootAI Autonomous Coding Agent solution play (Play 51).

## Solution Play Overview
This solution play implements a production-grade Autonomous Coding Agent system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
