---
description: "Azure coding patterns and best practices for Autonomous Coding Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Autonomous Coding Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "51-autonomous-coding-agent")
    # ... processing logic
