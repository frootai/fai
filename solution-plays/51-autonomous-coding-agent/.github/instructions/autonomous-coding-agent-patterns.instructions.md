---
description: "Domain-specific coding patterns for Autonomous Coding Agent (Play 51)"
applyTo: "**/*.{py,ts,js}"
---

# Autonomous Coding Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Autonomous Coding Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Autonomous Coding Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:51-autonomous-coding-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
