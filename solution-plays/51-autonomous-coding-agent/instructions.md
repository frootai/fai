---
description: "Root coding instructions for Autonomous Coding Agent (Play 51)"
applyTo: "**/*"
---

# Autonomous Coding Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Autonomous Coding Agent solution play (Play 51). It implements a production-grade Autonomous Coding Agent system on Azure using the FAI Protocol for AI primitive unification.
