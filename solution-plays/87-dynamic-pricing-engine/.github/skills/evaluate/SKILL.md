---
name: "evaluate"
description: "Evaluate Dynamic Pricing Engine (Play 87) quality using Azure AI Evaluation SDK"
---

# Evaluate — Dynamic Pricing Engine

## Overview
This skill runs the evaluation pipeline for the Dynamic Pricing Engine solution play, measuring quality metrics against production thresholds.
