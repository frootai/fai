---
description: "Domain-specific coding patterns for Dynamic Pricing Engine (Play 87)"
applyTo: "**/*.{py,ts,js}"
---

# Dynamic Pricing Engine — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Dynamic Pricing Engine architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Dynamic Pricing Engine."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:87-dynamic-pricing-engine:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
