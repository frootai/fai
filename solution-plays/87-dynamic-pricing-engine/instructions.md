---
description: "Root coding instructions for Dynamic Pricing Engine (Play 87)"
applyTo: "**/*"
---

# Dynamic Pricing Engine — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Dynamic Pricing Engine solution play (Play 87). It implements a production-grade Dynamic Pricing Engine system on Azure using the FAI Protocol for AI primitive unification.
