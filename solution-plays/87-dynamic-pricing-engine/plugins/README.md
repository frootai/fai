# Dynamic Pricing Engine — Plugin Extensions

This folder contains optional plugin extensions for Dynamic Pricing Engine.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 87-dynamic-pricing-engine`
