# Exam Generation Engine — Plugin Extensions

This folder contains optional plugin extensions for Exam Generation Engine.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 75-exam-generation-engine`
