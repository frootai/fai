---
description: "Root coding instructions for Exam Generation Engine (Play 75)"
applyTo: "**/*"
---

# Exam Generation Engine — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Exam Generation Engine solution play (Play 75). It implements a production-grade Exam Generation Engine system on Azure using the FAI Protocol for AI primitive unification.
