---
description: "Domain-specific coding patterns for Exam Generation Engine (Play 75)"
applyTo: "**/*.{py,ts,js}"
---

# Exam Generation Engine — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Exam Generation Engine architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Exam Generation Engine."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:75-exam-generation-engine:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
