---
description: "Azure coding patterns and best practices for Exam Generation Engine"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Exam Generation Engine
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "75-exam-generation-engine")
    # ... processing logic
