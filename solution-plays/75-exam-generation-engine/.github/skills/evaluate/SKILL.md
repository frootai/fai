---
name: "evaluate"
description: "Evaluate Exam Generation Engine (Play 75) quality using Azure AI Evaluation SDK"
---

# Evaluate — Exam Generation Engine

## Overview
This skill runs the evaluation pipeline for the Exam Generation Engine solution play, measuring quality metrics against production thresholds.
