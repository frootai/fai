...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Assessment Automation |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Assessment Automation |
...
```markdown
## Tuning Report — Exam Generation Engine
