...
- [ ] Solution follows the **Adaptive Learning Platform** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure Cosmos DB, Azure Static Web Apps, Azure Blob Storage, Azure Functions, Azure Monitor
...
```markdown
## Review Report — AI Training Curriculum
