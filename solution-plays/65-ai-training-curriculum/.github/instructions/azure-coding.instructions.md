---
description: "Azure coding patterns and best practices for Ai Training Curriculum"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Training Curriculum
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "65-ai-training-curriculum")
    # ... processing logic
