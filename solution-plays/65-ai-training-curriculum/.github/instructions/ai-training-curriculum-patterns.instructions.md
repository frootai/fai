---
description: "Domain-specific coding patterns for Ai Training Curriculum (Play 65)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Training Curriculum — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Training Curriculum architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Training Curriculum."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:65-ai-training-curriculum:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
