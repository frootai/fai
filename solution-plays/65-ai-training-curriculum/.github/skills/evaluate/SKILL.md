---
name: "evaluate"
description: "Evaluate Ai Training Curriculum (Play 65) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Training Curriculum

## Overview
This skill runs the evaluation pipeline for the Ai Training Curriculum solution play, measuring quality metrics against production thresholds.
