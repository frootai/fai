---
description: "Root coding instructions for Ai Training Curriculum (Play 65)"
applyTo: "**/*"
---

# Ai Training Curriculum — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Training Curriculum solution play (Play 65). It implements a production-grade Ai Training Curriculum system on Azure using the FAI Protocol for AI primitive unification.
