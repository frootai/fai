# Ai Training Curriculum — Plugin Extensions

This folder contains optional plugin extensions for Ai Training Curriculum.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 65-ai-training-curriculum`
