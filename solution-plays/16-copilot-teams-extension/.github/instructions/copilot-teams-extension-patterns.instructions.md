---
description: "Domain-specific coding patterns for Copilot Teams Extension (Play 16)"
applyTo: "**/*.{py,ts,js}"
---

# Copilot Teams Extension — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Copilot Teams Extension architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Copilot Teams Extension."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:16-copilot-teams-extension:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
