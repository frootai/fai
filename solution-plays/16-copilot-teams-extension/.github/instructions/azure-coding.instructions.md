---
description: "Azure coding patterns and best practices for Copilot Teams Extension"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Copilot Teams Extension
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "16-copilot-teams-extension")
    # ... processing logic
