---
name: "evaluate"
description: "Evaluate Copilot Teams Extension (Play 16) quality using Azure AI Evaluation SDK"
---

# Evaluate — Copilot Teams Extension

## Overview
This skill runs the evaluation pipeline for the Copilot Teams Extension solution play, measuring quality metrics against production thresholds.
