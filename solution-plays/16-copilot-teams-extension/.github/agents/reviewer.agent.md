...
- [ ] Solution follows the **M365 Copilot Plugin** pattern correctly
- [ ] All required Azure services are provisioned: Microsoft 365 Copilot, Microsoft Graph API, Azure Functions, Azure App Registration, Azure OpenAI, Azure Key Vault
...
```markdown
## Review Report — Copilot Teams Extension
