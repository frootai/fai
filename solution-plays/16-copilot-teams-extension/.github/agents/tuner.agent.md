...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for M365 Copilot Plugin |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for M365 Copilot Plugin |
...
```markdown
## Tuning Report — Copilot Teams Extension
