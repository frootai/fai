---
description: "Root coding instructions for Copilot Teams Extension (Play 16)"
applyTo: "**/*"
---

# Copilot Teams Extension — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Copilot Teams Extension solution play (Play 16). It implements a production-grade Copilot Teams Extension system on Azure using the FAI Protocol for AI primitive unification.
