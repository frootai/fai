# Edge Ai Deployment — Plugin Extensions

This folder contains optional plugin extensions for Edge Ai Deployment.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 34-edge-ai-deployment`
