---
description: "Root coding instructions for Edge Ai Deployment (Play 34)"
applyTo: "**/*"
---

# Edge Ai Deployment — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Edge Ai Deployment solution play (Play 34). It implements a production-grade Edge Ai Deployment system on Azure using the FAI Protocol for AI primitive unification.
