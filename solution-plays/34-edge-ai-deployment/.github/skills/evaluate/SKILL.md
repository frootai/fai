---
name: "evaluate"
description: "Evaluate Edge Ai Deployment (Play 34) quality using Azure AI Evaluation SDK"
---

# Evaluate — Edge Ai Deployment

## Overview
This skill runs the evaluation pipeline for the Edge Ai Deployment solution play, measuring quality metrics against production thresholds.
