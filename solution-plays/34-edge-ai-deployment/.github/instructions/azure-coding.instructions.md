---
description: "Azure coding patterns and best practices for Edge Ai Deployment"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Edge Ai Deployment
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "34-edge-ai-deployment")
    # ... processing logic
