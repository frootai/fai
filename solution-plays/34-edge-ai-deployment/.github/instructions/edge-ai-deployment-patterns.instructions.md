---
description: "Domain-specific coding patterns for Edge Ai Deployment (Play 34)"
applyTo: "**/*.{py,ts,js}"
---

# Edge Ai Deployment — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Edge Ai Deployment architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Edge Ai Deployment."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:34-edge-ai-deployment:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
