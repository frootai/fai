...
- [ ] Solution follows the **On-Device Inference** pattern correctly
- [ ] All required Azure services are provisioned: Azure IoT Hub, ONNX Runtime, Azure Container Instances, Azure Monitor, Azure Key Vault, Azure Blob Storage
...
```markdown
## Review Report — Edge AI Deployment
