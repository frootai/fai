...
|-----------|----------|-------------------|-----|
| model | phi-4-mini | phi-4-mini | Best quality/cost balance for On-Device Inference |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for On-Device Inference |
...
```markdown
## Tuning Report — Edge AI Deployment
