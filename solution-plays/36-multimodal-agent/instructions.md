---
description: "Root coding instructions for Multimodal Agent (Play 36)"
applyTo: "**/*"
---

# Multimodal Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Multimodal Agent solution play (Play 36). It implements a production-grade Multimodal Agent system on Azure using the FAI Protocol for AI primitive unification.
