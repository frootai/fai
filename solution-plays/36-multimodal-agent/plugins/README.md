# Multimodal Agent — Plugin Extensions

This folder contains optional plugin extensions for Multimodal Agent.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 36-multimodal-agent`
