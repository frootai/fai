---
name: "evaluate"
description: "Evaluate Multimodal Agent (Play 36) quality using Azure AI Evaluation SDK"
---

# Evaluate — Multimodal Agent

## Overview
This skill runs the evaluation pipeline for the Multimodal Agent solution play, measuring quality metrics against production thresholds.
