---
description: "Domain-specific coding patterns for Multimodal Agent (Play 36)"
applyTo: "**/*.{py,ts,js}"
---

# Multimodal Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Multimodal Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Multimodal Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:36-multimodal-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
