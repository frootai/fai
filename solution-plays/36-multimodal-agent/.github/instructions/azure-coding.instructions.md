---
description: "Azure coding patterns and best practices for Multimodal Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Multimodal Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "36-multimodal-agent")
    # ... processing logic
