---
description: "Domain-specific coding patterns for Edge Ai Phi4 (Play 19)"
applyTo: "**/*.{py,ts,js}"
---

# Edge Ai Phi4 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Edge Ai Phi4 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Edge Ai Phi4."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:19-edge-ai-phi4:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
