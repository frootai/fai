...
- [ ] All required Azure services are provisioned: Azure IoT Hub, Azure Container Instances, ONNX Runtime, Azure Blob Storage, Azure Monitor, Azure Key Vault
