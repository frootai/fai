---
name: "evaluate"
description: "Evaluate Edge Ai Phi4 (Play 19) quality using Azure AI Evaluation SDK"
---

# Evaluate — Edge Ai Phi4

## Overview
This skill runs the evaluation pipeline for the Edge Ai Phi4 solution play, measuring quality metrics against production thresholds.
