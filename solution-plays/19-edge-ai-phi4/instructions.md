---
description: "Root coding instructions for Edge Ai Phi4 (Play 19)"
applyTo: "**/*"
---

# Edge Ai Phi4 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Edge Ai Phi4 solution play (Play 19). It implements a production-grade Edge Ai Phi4 system on Azure using the FAI Protocol for AI primitive unification.
