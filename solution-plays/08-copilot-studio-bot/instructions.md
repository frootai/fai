---
description: "Root coding instructions for Copilot Studio Bot (Play 08)"
applyTo: "**/*"
---

# Copilot Studio Bot — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Copilot Studio Bot solution play (Play 08). It implements a production-grade Copilot Studio Bot system on Azure using the FAI Protocol for AI primitive unification.
