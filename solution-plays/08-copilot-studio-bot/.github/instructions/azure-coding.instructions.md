---
description: "Azure coding patterns and best practices for Copilot Studio Bot"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Copilot Studio Bot
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "08-copilot-studio-bot")
    # ... processing logic
