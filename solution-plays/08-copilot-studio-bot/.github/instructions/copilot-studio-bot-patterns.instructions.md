---
description: "Domain-specific coding patterns for Copilot Studio Bot (Play 08)"
applyTo: "**/*.{py,ts,js}"
---

# Copilot Studio Bot — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Copilot Studio Bot architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Copilot Studio Bot."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:08-copilot-studio-bot:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
