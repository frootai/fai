You are an AI coding assistant working on the FrootAI Copilot Studio Bot solution play (Play 08).

## Solution Play Overview
This solution play implements a production-grade Copilot Studio Bot system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
