---
mode: "agent"
description: "Evaluate Copilot Studio Bot (Play 08) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Copilot Studio Bot Quality

You are evaluating the FrootAI Copilot Studio Bot solution play (Play 08).
