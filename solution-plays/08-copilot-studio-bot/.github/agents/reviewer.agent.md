...
- [ ] Solution follows the **Low-Code Bot** pattern correctly
- [ ] All required Azure services are provisioned: Microsoft Copilot Studio, Dataverse, SharePoint, Power Platform, Azure OpenAI
...
```markdown
## Review Report — Copilot Studio Bot
