---
name: "evaluate"
description: "Evaluate Copilot Studio Bot (Play 08) quality using Azure AI Evaluation SDK"
---

# Evaluate — Copilot Studio Bot

## Overview
This skill runs the evaluation pipeline for the Copilot Studio Bot solution play, measuring quality metrics against production thresholds.
