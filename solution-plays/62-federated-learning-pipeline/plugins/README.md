# Federated Learning Pipeline — Plugin Extensions

This folder contains optional plugin extensions for Federated Learning Pipeline.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 62-federated-learning-pipeline`
