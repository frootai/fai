---
description: "Root coding instructions for Federated Learning Pipeline (Play 62)"
applyTo: "**/*"
---

# Federated Learning Pipeline — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Federated Learning Pipeline solution play (Play 62). It implements a production-grade Federated Learning Pipeline system on Azure using the FAI Protocol for AI primitive unification.
