---
description: "Azure coding patterns and best practices for Federated Learning Pipeline"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Federated Learning Pipeline
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "62-federated-learning-pipeline")
    # ... processing logic
