...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-federated-learning-pipeline-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="62-federated-learning-pipeline"

echo "═══ Deploying Federated Learning Pipeline ═══"
...
echo "═══ Federated Learning Pipeline deployed successfully ═══"
