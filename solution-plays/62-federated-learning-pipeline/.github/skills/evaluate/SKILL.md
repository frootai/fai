---
name: "evaluate"
description: "Evaluate Federated Learning Pipeline (Play 62) quality using Azure AI Evaluation SDK"
---

# Evaluate — Federated Learning Pipeline

## Overview
This skill runs the evaluation pipeline for the Federated Learning Pipeline solution play, measuring quality metrics against production thresholds.
