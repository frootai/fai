// COMPLIANCE: FedRAMP Moderate — Data sovereignty US only
// Deploy on Azure Government with CUI handling controls

// Policy Impact Analyzer (Play 85) — Azure Infrastructure
...
param prefix string = 'policy-impac'

@description('Tags applied to all resources')
param tags object = {
  project: 'frootai'
  play: '85'
  playName: 'Policy Impact Analyzer'
