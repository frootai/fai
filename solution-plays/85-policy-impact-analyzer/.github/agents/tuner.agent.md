...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Regulatory Intelligence |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Regulatory Intelligence |
...
```markdown
## Tuning Report — Policy Impact Analyzer
