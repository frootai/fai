---
description: "Domain-specific coding patterns for Policy Impact Analyzer (Play 85)"
applyTo: "**/*.{py,ts,js}"
---

# Policy Impact Analyzer — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Policy Impact Analyzer architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Policy Impact Analyzer."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:85-policy-impact-analyzer:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
