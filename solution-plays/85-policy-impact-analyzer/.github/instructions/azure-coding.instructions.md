---
description: "Azure coding patterns and best practices for Policy Impact Analyzer"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Policy Impact Analyzer
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "85-policy-impact-analyzer")
    # ... processing logic
