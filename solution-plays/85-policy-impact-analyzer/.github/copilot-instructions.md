You are an AI coding assistant working on the FrootAI Policy Impact Analyzer solution play (Play 85).

## Solution Play Overview
This solution play implements a production-grade Policy Impact Analyzer system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
