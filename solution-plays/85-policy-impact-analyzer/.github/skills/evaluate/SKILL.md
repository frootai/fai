---
name: "evaluate"
description: "Evaluate Policy Impact Analyzer (Play 85) quality using Azure AI Evaluation SDK"
---

# Evaluate — Policy Impact Analyzer

## Overview
This skill runs the evaluation pipeline for the Policy Impact Analyzer solution play, measuring quality metrics against production thresholds.
