---
description: "Root coding instructions for Policy Impact Analyzer (Play 85)"
applyTo: "**/*"
---

# Policy Impact Analyzer — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Policy Impact Analyzer solution play (Play 85). It implements a production-grade Policy Impact Analyzer system on Azure using the FAI Protocol for AI primitive unification.
