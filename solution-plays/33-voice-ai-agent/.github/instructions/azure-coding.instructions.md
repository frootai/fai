---
description: "Azure coding patterns and best practices for Voice Ai Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Voice Ai Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "33-voice-ai-agent")
    # ... processing logic
