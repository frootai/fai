---
description: "Domain-specific coding patterns for Voice Ai Agent (Play 33)"
applyTo: "**/*.{py,ts,js}"
---

# Voice Ai Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Voice Ai Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Voice Ai Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:33-voice-ai-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
