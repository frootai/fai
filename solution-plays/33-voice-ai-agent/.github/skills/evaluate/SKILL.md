---
name: "evaluate"
description: "Evaluate Voice Ai Agent (Play 33) quality using Azure AI Evaluation SDK"
---

# Evaluate — Voice Ai Agent

## Overview
This skill runs the evaluation pipeline for the Voice Ai Agent solution play, measuring quality metrics against production thresholds.
