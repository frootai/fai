---
description: "Root coding instructions for Voice Ai Agent (Play 33)"
applyTo: "**/*"
---

# Voice Ai Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Voice Ai Agent solution play (Play 33). It implements a production-grade Voice Ai Agent system on Azure using the FAI Protocol for AI primitive unification.
