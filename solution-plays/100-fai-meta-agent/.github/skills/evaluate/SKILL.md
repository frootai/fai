---
name: "evaluate"
description: "Evaluate Fai Meta Agent (Play 100) quality using Azure AI Evaluation SDK"
---

# Evaluate — Fai Meta Agent

## Overview
This skill runs the evaluation pipeline for the Fai Meta Agent solution play, measuring quality metrics against production thresholds.
