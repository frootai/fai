---
name: "deploy-azure"
description: "Deploy Fai Meta Agent (Play 100) infrastructure and application to Azure"
---

# Deploy Azure — Fai Meta Agent

## Overview
This skill deploys the Fai Meta Agent solution play to Azure using Bicep infrastructure-as-code and Azure Developer CLI.
