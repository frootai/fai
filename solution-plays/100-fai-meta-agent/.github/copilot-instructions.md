You are an AI coding assistant working on the FrootAI Fai Meta Agent solution play (Play 100).

## Solution Play Overview
This solution play implements a production-grade Fai Meta Agent system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
