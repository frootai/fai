...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Self-Orchestrating Super-Agent |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Self-Orchestrating Super-Agent |
