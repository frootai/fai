---
description: "Domain-specific coding patterns for Fai Meta Agent (Play 100)"
applyTo: "**/*.{py,ts,js}"
---

# Fai Meta Agent — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Fai Meta Agent architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Fai Meta Agent."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:100-fai-meta-agent:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
