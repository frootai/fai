---
description: "Azure coding patterns and best practices for Fai Meta Agent"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Fai Meta Agent
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "100-fai-meta-agent")
    # ... processing logic
