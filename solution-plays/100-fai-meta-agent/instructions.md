---
description: "Root coding instructions for Fai Meta Agent (Play 100)"
applyTo: "**/*"
---

# Fai Meta Agent — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Fai Meta Agent solution play (Play 100). It implements a production-grade Fai Meta Agent system on Azure using the FAI Protocol for AI primitive unification.
