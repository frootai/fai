---
description: "Azure coding patterns and best practices for Ai Landing Zone Advanced"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Landing Zone Advanced
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "11-ai-landing-zone-advanced")
    # ... processing logic
