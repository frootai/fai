---
description: "Domain-specific coding patterns for Ai Landing Zone Advanced (Play 11)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Landing Zone Advanced — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Landing Zone Advanced architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Landing Zone Advanced."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:11-ai-landing-zone-advanced:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
