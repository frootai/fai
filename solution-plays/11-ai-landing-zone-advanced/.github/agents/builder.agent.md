...
You are the **Builder Agent** for Landing Zone Advanced (Play 11). implements multi-region Bicep, MG hierarchy, Policy.
...
Before working, `read_file .github/skills/deploy-ai-landing-zone-advanced/SKILL.md`.
