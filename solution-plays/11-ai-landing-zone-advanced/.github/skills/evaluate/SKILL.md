---
name: "evaluate"
description: "Evaluate Ai Landing Zone Advanced (Play 11) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Landing Zone Advanced

## Overview
This skill runs the evaluation pipeline for the Ai Landing Zone Advanced solution play, measuring quality metrics against production thresholds.
