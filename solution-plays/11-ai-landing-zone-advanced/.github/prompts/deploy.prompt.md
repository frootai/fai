---
mode: "agent"
description: "Deploy Ai Landing Zone Advanced (Play 11) to Azure"
tools: ["terminal", "file"]
---

# Deploy Ai Landing Zone Advanced to Azure

You are deploying the FrootAI Ai Landing Zone Advanced solution play (Play 11) to Azure.
