---
description: "Root coding instructions for Ai Landing Zone Advanced (Play 11)"
applyTo: "**/*"
---

# Ai Landing Zone Advanced — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Landing Zone Advanced solution play (Play 11). It implements a production-grade Ai Landing Zone Advanced system on Azure using the FAI Protocol for AI primitive unification.
