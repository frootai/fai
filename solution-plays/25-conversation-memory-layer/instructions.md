---
description: "Root coding instructions for Conversation Memory Layer (Play 25)"
applyTo: "**/*"
---

# Conversation Memory Layer — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Conversation Memory Layer solution play (Play 25). It implements a production-grade Conversation Memory Layer system on Azure using the FAI Protocol for AI primitive unification.
