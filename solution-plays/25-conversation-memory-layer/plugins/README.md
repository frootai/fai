# Conversation Memory Layer — Plugin Extensions

This folder contains optional plugin extensions for Conversation Memory Layer.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 25-conversation-memory-layer`
