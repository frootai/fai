---
description: "Azure coding patterns and best practices for Conversation Memory Layer"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Conversation Memory Layer
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "25-conversation-memory-layer")
    # ... processing logic
