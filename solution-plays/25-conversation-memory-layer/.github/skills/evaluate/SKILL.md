---
name: "evaluate"
description: "Evaluate Conversation Memory Layer (Play 25) quality using Azure AI Evaluation SDK"
---

# Evaluate — Conversation Memory Layer

## Overview
This skill runs the evaluation pipeline for the Conversation Memory Layer solution play, measuring quality metrics against production thresholds.
