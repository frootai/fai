...
ENVIRONMENT=${1:-dev}
RESOURCE_GROUP="rg-frootai-conversation-memory-layer-${ENVIRONMENT}"
LOCATION="eastus2"
PLAY="25-conversation-memory-layer"

echo "═══ Deploying Conversation Memory Layer ═══"
...
echo "═══ Conversation Memory Layer deployed successfully ═══"
