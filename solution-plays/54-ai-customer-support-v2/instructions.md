---
description: "Root coding instructions for Ai Customer Support V2 (Play 54)"
applyTo: "**/*"
---

# Ai Customer Support V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Ai Customer Support V2 solution play (Play 54). It implements a production-grade Ai Customer Support V2 system on Azure using the FAI Protocol for AI primitive unification.
