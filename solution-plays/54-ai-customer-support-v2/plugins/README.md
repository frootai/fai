# Ai Customer Support V2 — Plugin Extensions

This folder contains optional plugin extensions for Ai Customer Support V2.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 54-ai-customer-support-v2`
