---
description: "Azure coding patterns and best practices for Ai Customer Support V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Ai Customer Support V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "54-ai-customer-support-v2")
    # ... processing logic
