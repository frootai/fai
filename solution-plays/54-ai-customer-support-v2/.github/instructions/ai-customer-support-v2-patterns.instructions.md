---
description: "Domain-specific coding patterns for Ai Customer Support V2 (Play 54)"
applyTo: "**/*.{py,ts,js}"
---

# Ai Customer Support V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Ai Customer Support V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Ai Customer Support V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:54-ai-customer-support-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
