---
mode: "agent"
description: "Evaluate Ai Customer Support V2 (Play 54) quality metrics"
tools: ["terminal", "file"]
---

# Evaluate Ai Customer Support V2 Quality

You are evaluating the FrootAI Ai Customer Support V2 solution play (Play 54).
