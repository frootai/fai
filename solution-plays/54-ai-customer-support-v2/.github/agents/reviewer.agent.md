...
- [ ] Solution follows the **Multi-Channel Support** pattern correctly
- [ ] All required Azure services are provisioned: Azure OpenAI, Azure AI Search, Azure Communication Services, Azure Cosmos DB, Azure Functions, Azure Monitor
...
```markdown
## Review Report — AI Customer Support v2
