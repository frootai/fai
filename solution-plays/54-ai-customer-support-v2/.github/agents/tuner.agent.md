...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Multi-Channel Support |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Multi-Channel Support |
...
```markdown
## Tuning Report — AI Customer Support v2
