---
name: "evaluate"
description: "Evaluate Ai Customer Support V2 (Play 54) quality using Azure AI Evaluation SDK"
---

# Evaluate — Ai Customer Support V2

## Overview
This skill runs the evaluation pipeline for the Ai Customer Support V2 solution play, measuring quality metrics against production thresholds.
