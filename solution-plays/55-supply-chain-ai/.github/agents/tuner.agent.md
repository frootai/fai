...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Demand Forecasting & Optimization |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Demand Forecasting & Optimization |
