---
name: "evaluate"
description: "Evaluate Supply Chain Ai (Play 55) quality using Azure AI Evaluation SDK"
---

# Evaluate — Supply Chain Ai

## Overview
This skill runs the evaluation pipeline for the Supply Chain Ai solution play, measuring quality metrics against production thresholds.
