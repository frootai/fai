---
description: "Domain-specific coding patterns for Supply Chain Ai (Play 55)"
applyTo: "**/*.{py,ts,js}"
---

# Supply Chain Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Supply Chain Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Supply Chain Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:55-supply-chain-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
