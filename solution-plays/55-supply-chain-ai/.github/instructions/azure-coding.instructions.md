---
description: "Azure coding patterns and best practices for Supply Chain Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Supply Chain Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "55-supply-chain-ai")
    # ... processing logic
