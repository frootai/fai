---
description: "Root coding instructions for Supply Chain Ai (Play 55)"
applyTo: "**/*"
---

# Supply Chain Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Supply Chain Ai solution play (Play 55). It implements a production-grade Supply Chain Ai system on Azure using the FAI Protocol for AI primitive unification.
