# Supply Chain Ai — Plugin Extensions

This folder contains optional plugin extensions for Supply Chain Ai.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 55-supply-chain-ai`
