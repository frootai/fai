---
description: "Root coding instructions for Call Center Voice Ai (Play 04)"
applyTo: "**/*"
---

# Call Center Voice Ai — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Call Center Voice Ai solution play (Play 04). It implements a production-grade Call Center Voice Ai system on Azure using the FAI Protocol for AI primitive unification.
