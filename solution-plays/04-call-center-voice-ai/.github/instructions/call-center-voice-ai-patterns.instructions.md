---
description: "Domain-specific coding patterns for Call Center Voice Ai (Play 04)"
applyTo: "**/*.{py,ts,js}"
---

# Call Center Voice Ai — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Call Center Voice Ai architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Call Center Voice Ai."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:04-call-center-voice-ai:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
