---
description: "Azure coding patterns and best practices for Call Center Voice Ai"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Call Center Voice Ai
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "04-call-center-voice-ai")
    # ... processing logic
