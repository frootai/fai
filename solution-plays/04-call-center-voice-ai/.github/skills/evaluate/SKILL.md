---
name: "evaluate"
description: "Evaluate Call Center Voice Ai (Play 04) quality using Azure AI Evaluation SDK"
---

# Evaluate — Call Center Voice Ai

## Overview
This skill runs the evaluation pipeline for the Call Center Voice Ai solution play, measuring quality metrics against production thresholds.
