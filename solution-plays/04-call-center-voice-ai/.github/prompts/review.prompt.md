---
mode: "agent"
description: "Review Call Center Voice Ai (Play 04) code and architecture"
tools: ["terminal", "file"]
---

# Review Call Center Voice Ai Implementation

You are reviewing the FrootAI Call Center Voice Ai solution play (Play 04).
...
```markdown
## Review Report — Play 04: Call Center Voice Ai
