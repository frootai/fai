---
mode: "agent"
description: "Test Call Center Voice Ai (Play 04) implementation"
tools: ["terminal", "file"]
---

# Test Call Center Voice Ai Implementation

You are testing the FrootAI Call Center Voice Ai solution play (Play 04).
