...
- [ ] Solution follows the **Voice Pipeline** pattern correctly
- [ ] All required Azure services are provisioned: Azure Communication Services, Azure AI Speech, Azure OpenAI, Azure Container Apps, Azure Content Safety
...
```markdown
## Review Report — Call Center Voice AI
