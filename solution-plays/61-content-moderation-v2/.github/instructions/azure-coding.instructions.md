---
description: "Azure coding patterns and best practices for Content Moderation V2"
applyTo: "**/*.{py,ts,js,bicep,json}"
---

# Azure Coding Patterns — Content Moderation V2
...
async def process_request(request_id: str, data: dict):
    ...
    span.set_attribute("play.id", "61-content-moderation-v2")
    # ... processing logic
