---
description: "Domain-specific coding patterns for Content Moderation V2 (Play 61)"
applyTo: "**/*.{py,ts,js}"
---

# Content Moderation V2 — Domain Patterns & Best Practices

## Architecture Pattern
This play implements a Content Moderation V2 architecture with these core components:
...
class ProcessingPipeline:
    """Multi-stage processing pipeline for Content Moderation V2."""
...
class ResponseCache:
    ...
    def _cache_key(self, request: dict) -> str:
        ...
        return f"play:61-content-moderation-v2:" + hashlib.sha256(normalized.encode()).hexdigest()[:16]
