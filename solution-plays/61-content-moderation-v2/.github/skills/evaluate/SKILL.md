---
name: "evaluate"
description: "Evaluate Content Moderation V2 (Play 61) quality using Azure AI Evaluation SDK"
---

# Evaluate — Content Moderation V2

## Overview
This skill runs the evaluation pipeline for the Content Moderation V2 solution play, measuring quality metrics against production thresholds.
