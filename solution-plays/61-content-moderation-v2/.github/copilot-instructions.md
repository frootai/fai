You are an AI coding assistant working on the FrootAI Content Moderation V2 solution play (Play 61).

## Solution Play Overview
This solution play implements a production-grade Content Moderation V2 system on Azure, following the FrootAI FAI Protocol and Well-Architected Framework (WAF) principles across all six pillars: Reliability, Security, Cost Optimization, Operational Excellence, Performance Efficiency, and Responsible AI.
