...
|-----------|----------|-------------------|-----|
| model | gpt-4o | gpt-4o | Best quality/cost balance for Cultural-Aware Safety |
| temperature | 0.1-0.3 | ≤0.3 | Lower = more deterministic, crucial for Cultural-Aware Safety |
...
```markdown
## Tuning Report — Content Moderation v2
