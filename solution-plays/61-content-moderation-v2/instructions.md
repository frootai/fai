---
description: "Root coding instructions for Content Moderation V2 (Play 61)"
applyTo: "**/*"
---

# Content Moderation V2 — Coding Standards & Project Instructions

## Project Overview
This is the FrootAI Content Moderation V2 solution play (Play 61). It implements a production-grade Content Moderation V2 system on Azure using the FAI Protocol for AI primitive unification.
