# Content Moderation V2 — Plugin Extensions

This folder contains optional plugin extensions for Content Moderation V2.

## Available Plugins
- See `plugin.json` in the play root for the plugin manifest
- Install via: `npx frootai install 61-content-moderation-v2`
