...
const components = [
  { name: "MCP Server", version: "v2.2.0", pkg: "frootai-mcp", status: "✅ Live", link: "https://www.npmjs.com/package/frootai-mcp" },
  ...
  { name: "Agent Card (A2A)", version: "v2.2.0", pkg: "agent-card.json", status: "✅ Published", link: "https://github.com/gitpavleenbali/frootai/blob/main/mcp-server/agent-card.json" },
];
