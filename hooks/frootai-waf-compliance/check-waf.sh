#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────
# FrootAI WAF Compliance Checker
...
if [ -z "$DIFF_CONTENT" ] && [ -z "$STAGED_CONTENT" ]; then
  echo "🏛️  FrootAI WAF Compliance: no changes to scan."
  exit 0
fi
...
if [ -z "$ADDED_LINES" ]; then
  echo "🏛️  FrootAI WAF Compliance: no added lines to scan."
  exit 0
fi
...
echo ""
echo "🏛️  FrootAI WAF Compliance Report"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
