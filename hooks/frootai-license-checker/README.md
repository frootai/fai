...
- name: License Compliance Check
  run: bash .github/hooks/frootai-license-checker/check-licenses.sh
  env:
    CHECKER_MODE: block
...
CHECKER_MODE=block bash .github/hooks/frootai-license-checker/check-licenses.sh
```
...
```bash
cp -r hooks/frootai-license-checker .github/hooks/
```
