---
name: frootai-evaluate-07-multi-agent-service
description: 'Runs quality evaluation for Play 07-multi-agent-service against fai-manifest.json guardrails — groundedness, coherence, safety.'
---
...
Perform the primary operation: runs quality evaluation for play 07-multi-agent-service against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-07-multi-agent-service
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-07-multi-agent-service/"]
  }
}
```
