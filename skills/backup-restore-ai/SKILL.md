...
## Overview
Set up backup and restore procedures for AI application data and configurations. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the backup restore ai pattern:
