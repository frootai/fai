...
7. Run `az monitor log-analytics query` to validate events flow end-to-end
8. Enable Cosmos backup policy — continuous backup with 30-day PITR for disaster recovery
