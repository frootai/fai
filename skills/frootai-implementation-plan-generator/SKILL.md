---
name: frootai-implementation-plan-generator
...
npx frootai skill run frootai-implementation-plan-generator
```
...
{
  "primitives": {
    "skills": ["skills/frootai-implementation-plan-generator/"]
  }
}
```
