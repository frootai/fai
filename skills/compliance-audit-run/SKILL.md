...
## Overview
Run a compliance audit against HIPAA/FedRAMP/SOC2 requirements for AI systems. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the compliance audit run pattern:
