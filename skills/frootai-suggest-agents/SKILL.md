---
name: frootai-suggest-agents
description: 'Discovers and recommends relevant FrootAI agents based on user task description.'
---

# Fai Suggest Agents

Discovers and recommends relevant FrootAI agents based on user task description.

## Overview

This skill provides a structured, repeatable procedure for discovers and recommends relevant frootai agents based on user task description.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: discovers and recommends relevant frootai agents based on user task description..
...
npx frootai skill run frootai-suggest-agents
```
...
{
  "primitives": {
    "skills": ["skills/frootai-suggest-agents/"]
  }
}
```
