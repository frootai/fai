...
## Overview
Configure Azure Content Safety API with custom categories and thresholds. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the content safety configure pattern:
