...
## Overview
Migrate data and embeddings between vector databases with zero downtime. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the database migrate ai pattern:
