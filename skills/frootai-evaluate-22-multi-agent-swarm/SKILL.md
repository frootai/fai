---
name: frootai-evaluate-22-multi-agent-swarm
description: 'Runs quality evaluation for Play 22-multi-agent-swarm against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 22 Multi Agent Swarm

Runs quality evaluation for Play 22-multi-agent-swarm against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 22-multi-agent-swarm against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 22-multi-agent-swarm against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-22-multi-agent-swarm
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-22-multi-agent-swarm/"]
  }
}
```
