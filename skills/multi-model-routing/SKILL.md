...
## Overview
Implement model routing logic: cheap model for simple, capable for complex tasks. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the multi model routing pattern:
