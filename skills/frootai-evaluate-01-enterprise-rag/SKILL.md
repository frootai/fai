---
name: frootai-evaluate-01-enterprise-rag
description: 'Runs quality evaluation for Play 01-enterprise-rag against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 01 Enterprise Rag

Runs quality evaluation for Play 01-enterprise-rag against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 01-enterprise-rag against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 01-enterprise-rag against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-01-enterprise-rag
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-01-enterprise-rag/"]
  }
}
```
