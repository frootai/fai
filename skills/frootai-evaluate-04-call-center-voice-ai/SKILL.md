---
name: frootai-evaluate-04-call-center-voice-ai
description: 'Runs quality evaluation for Play 04-call-center-voice-ai against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 04 Call Center Voice Ai

Runs quality evaluation for Play 04-call-center-voice-ai against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 04-call-center-voice-ai against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 04-call-center-voice-ai against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-04-call-center-voice-ai
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-04-call-center-voice-ai/"]
  }
}
```
