...
## Overview
Create a reusable Bicep module with parameters, outputs, and conditions. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the bicep module create pattern:
