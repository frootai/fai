---
name: frootai-tune-06-document-intelligence
...
npx frootai skill run frootai-tune-06-document-intelligence
```
...
{
  "primitives": {
    "skills": ["skills/frootai-tune-06-document-intelligence/"]
  }
}
```
