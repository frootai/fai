---
name: frootai-evaluate-11-ai-landing-zone-advanced
description: 'Runs quality evaluation for Play 11-ai-landing-zone-advanced against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 11 Ai Landing Zone Advanced

Runs quality evaluation for Play 11-ai-landing-zone-advanced against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 11-ai-landing-zone-advanced against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 11-ai-landing-zone-advanced against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-11-ai-landing-zone-advanced
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-11-ai-landing-zone-advanced/"]
  }
}
```
