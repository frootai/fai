---
name: frootai-evaluate-14-cost-optimized-ai-gateway
...
npx frootai skill run frootai-evaluate-14-cost-optimized-ai-gateway
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-14-cost-optimized-ai-gateway/"]
  }
}
```
