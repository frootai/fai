---
name: frootai-deploy-22-multi-agent-swarm
description: 'Deploys Play 22-multi-agent-swarm to Azure with Bicep validation, what-if check, and post-deploy health verification.'
---

# Fai Deploy 22 Multi Agent Swarm

Deploys Play 22-multi-agent-swarm to Azure with Bicep validation, what-if check, and post-deploy health verification.

## Overview

This skill provides a structured, repeatable procedure for deploys play 22-multi-agent-swarm to azure with bicep validation, what-if check, and post-deploy health verification.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: deploys play 22-multi-agent-swarm to azure with bicep validation, what-if check, and post-deploy health verification..
...
npx frootai skill run frootai-deploy-22-multi-agent-swarm
```
...
{
  "primitives": {
    "skills": ["skills/frootai-deploy-22-multi-agent-swarm/"]
  }
}
```
