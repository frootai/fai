---
name: frootai-evaluate-06-document-intelligence
description: 'Runs quality evaluation for Play 06-document-intelligence against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 06 Document Intelligence

Runs quality evaluation for Play 06-document-intelligence against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 06-document-intelligence against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 06-document-intelligence against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-06-document-intelligence
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-06-document-intelligence/"]
  }
}
```
