...
## Overview
Test a RAG pipeline end-to-end with relevance and groundedness metrics. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the rag pipeline test pattern:
