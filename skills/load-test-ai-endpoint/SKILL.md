...
## Overview
Load test an AI endpoint with k6/Locust for p95 latency and error rates. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the load test ai endpoint pattern:
