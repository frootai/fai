---
name: frootai-tune-16-copilot-teams-extension
...
npx frootai skill run frootai-tune-16-copilot-teams-extension
```
...
{
  "primitives": {
    "skills": ["skills/frootai-tune-16-copilot-teams-extension/"]
  }
}
```
