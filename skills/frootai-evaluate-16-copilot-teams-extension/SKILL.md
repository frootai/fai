---
name: frootai-evaluate-16-copilot-teams-extension
description: 'Runs quality evaluation for Play 16-copilot-teams-extension against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 16 Copilot Teams Extension

Runs quality evaluation for Play 16-copilot-teams-extension against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 16-copilot-teams-extension against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 16-copilot-teams-extension against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-16-copilot-teams-extension
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-16-copilot-teams-extension/"]
  }
}
```
