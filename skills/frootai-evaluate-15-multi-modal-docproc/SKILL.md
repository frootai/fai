---
name: frootai-evaluate-15-multi-modal-docproc
description: 'Runs quality evaluation for Play 15-multi-modal-docproc against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 15 Multi Modal Docproc

Runs quality evaluation for Play 15-multi-modal-docproc against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 15-multi-modal-docproc against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 15-multi-modal-docproc against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-15-multi-modal-docproc
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-15-multi-modal-docproc/"]
  }
}
```
