---
name: frootai-tune-23-browser-automation-agent
description: 'Tunes configuration for Play 23-browser-automation-agent — model selection, token budgets, guardrail thresholds, cost optimization.'
---

# Fai Tune 23 Browser Automation Agent

Tunes configuration for Play 23-browser-automation-agent — model selection, token budgets, guardrail thresholds, cost optimization.

## Overview

This skill provides a structured, repeatable procedure for tunes configuration for play 23-browser-automation-agent — model selection, token budgets, guardrail thresholds, cost optimization.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: tunes configuration for play 23-browser-automation-agent — model selection, token budgets, guardrail thresholds, cost optimization..
...
npx frootai skill run frootai-tune-23-browser-automation-agent
```
...
{
  "primitives": {
    "skills": ["skills/frootai-tune-23-browser-automation-agent/"]
  }
}
```
