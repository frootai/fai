...
## Overview
Create and populate a vector search index in Azure AI Search or Cosmos DB. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the vector index create pattern:
