...
## Overview
Select and configure the optimal embedding model for vector search. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the embedding model select pattern:
