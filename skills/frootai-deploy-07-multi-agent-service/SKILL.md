---
name: frootai-deploy-07-multi-agent-service
...
npx frootai skill run frootai-deploy-07-multi-agent-service
```
...
{
  "primitives": {
    "skills": ["skills/frootai-deploy-07-multi-agent-service/"]
  }
}
```
