---
name: frootai-deploy-03-deterministic-agent
...
npx frootai skill run frootai-deploy-03-deterministic-agent
```
...
{
  "primitives": {
    "skills": ["skills/frootai-deploy-03-deterministic-agent/"]
  }
}
```
