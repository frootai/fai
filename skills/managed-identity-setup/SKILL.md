...
## Overview
Set up Managed Identity with RBAC role assignments for Azure services. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the managed identity setup pattern:
