...
## Overview
Set up SLA monitoring with availability, latency, and quality metrics. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the sla monitor setup pattern:
