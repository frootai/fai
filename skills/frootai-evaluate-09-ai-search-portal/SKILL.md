---
name: frootai-evaluate-09-ai-search-portal
description: 'Runs quality evaluation for Play 09-ai-search-portal against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 09 Ai Search Portal

Runs quality evaluation for Play 09-ai-search-portal against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 09-ai-search-portal against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 09-ai-search-portal against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-09-ai-search-portal
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-09-ai-search-portal/"]
  }
}
```
