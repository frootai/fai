---
name: frootai-azure-ai-search-index
description: 'Creates and configures Azure AI Search vector indexes with HNSW and hybrid search.'
---

# Fai Azure Ai Search Index

Creates and configures Azure AI Search vector indexes with HNSW and hybrid search.

## Overview

This skill provides a structured, repeatable procedure for creates and configures azure ai search vector indexes with hnsw and hybrid search.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: creates and configures azure ai search vector indexes with hnsw and hybrid search..
...
npx frootai skill run frootai-azure-ai-search-index
```
...
{
  "primitives": {
    "skills": ["skills/frootai-azure-ai-search-index/"]
  }
}
```
