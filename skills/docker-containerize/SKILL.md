...
## Overview
Containerize an AI application with multi-stage Docker build and health checks. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the docker containerize pattern:
