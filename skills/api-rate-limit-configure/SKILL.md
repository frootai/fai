...
## Overview
Configure API rate limiting with Azure APIM policies and retry headers. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the api rate limit configure pattern:
