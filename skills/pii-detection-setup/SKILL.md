...
## Overview
Set up PII detection and masking with Azure AI Language service. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the pii detection setup pattern:
