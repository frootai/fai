...
## Overview
Integrate Azure Key Vault for secret management with Managed Identity. This skill provides a production-grade, step-by-step procedure for implementing this capability in FrootAI solution plays.
...
## Step 3: Implement
Apply the key vault integrate pattern:
