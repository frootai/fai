---
name: frootai-evaluate-17-ai-observability
description: 'Runs quality evaluation for Play 17-ai-observability against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 17 Ai Observability

Runs quality evaluation for Play 17-ai-observability against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 17-ai-observability against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 17-ai-observability against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-17-ai-observability
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-17-ai-observability/"]
  }
}
```
