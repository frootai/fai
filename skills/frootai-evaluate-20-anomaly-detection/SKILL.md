---
name: frootai-evaluate-20-anomaly-detection
description: 'Runs quality evaluation for Play 20-anomaly-detection against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 20 Anomaly Detection

Runs quality evaluation for Play 20-anomaly-detection against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 20-anomaly-detection against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 20-anomaly-detection against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-20-anomaly-detection
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-20-anomaly-detection/"]
  }
}
```
