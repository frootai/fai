---
name: frootai-evaluate-03-deterministic-agent
description: 'Runs quality evaluation for Play 03-deterministic-agent against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 03 Deterministic Agent

Runs quality evaluation for Play 03-deterministic-agent against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 03-deterministic-agent against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 03-deterministic-agent against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-03-deterministic-agent
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-03-deterministic-agent/"]
  }
}
```
