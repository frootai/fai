---
name: frootai-play-initializer
description: 'Scaffolds a complete FrootAI solution play with DevKit, TuneKit, SpecKit, infrastructure templates, and fai-manifest.json — the full FAI Protocol structure ready for development.'
---

# FrootAI Play Initializer

Initialize a new FrootAI solution play with the complete FAI Protocol structure. This skill generates all required files and folders for a production-ready solution play.
...
## Notes
- Every play MUST have a `fai-manifest.json` — this is what makes it a FrootAI play, not just a folder
