---
name: frootai-evaluate-12-model-serving-aks
description: 'Runs quality evaluation for Play 12-model-serving-aks against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 12 Model Serving Aks

Runs quality evaluation for Play 12-model-serving-aks against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 12-model-serving-aks against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 12-model-serving-aks against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-12-model-serving-aks
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-12-model-serving-aks/"]
  }
}
```
