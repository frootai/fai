---
name: frootai-azure-resource-health
description: 'Diagnoses Azure resource health issues with metrics analysis and remediation steps.'
---

# Fai Azure Resource Health

Diagnoses Azure resource health issues with metrics analysis and remediation steps.
...
npx frootai skill run frootai-azure-resource-health
```
...
{
  "primitives": {
    "skills": ["skills/frootai-azure-resource-health/"]
  }
}
```
