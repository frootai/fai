---
name: frootai-eval-runner
description: 'name: frootai-eval-runner'
---
...
This skill provides a structured, repeatable procedure for name: frootai-eval-runner. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: name: frootai-eval-runner.
...
npx frootai skill run frootai-eval-runner
```
...
{
  "primitives": {
    "skills": ["skills/frootai-eval-runner/"]
  }
}
```
