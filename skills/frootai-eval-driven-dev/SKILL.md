---
name: frootai-eval-driven-dev
description: 'Implements test-driven AI development — define eval metrics first, then build to pass them.'
---

# Fai Eval Driven Dev

Implements test-driven AI development — define eval metrics first, then build to pass them.

## Overview

This skill provides a structured, repeatable procedure for implements test-driven ai development — define eval metrics first, then build to pass them.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: implements test-driven ai development — define eval metrics first, then build to pass them..
...
npx frootai skill run frootai-eval-driven-dev
```
...
{
  "primitives": {
    "skills": ["skills/frootai-eval-driven-dev/"]
  }
}
```
