---
name: frootai-evaluate-08-copilot-studio-bot
description: 'Runs quality evaluation for Play 08-copilot-studio-bot against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 08 Copilot Studio Bot

Runs quality evaluation for Play 08-copilot-studio-bot against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 08-copilot-studio-bot against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 08-copilot-studio-bot against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-08-copilot-studio-bot
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-08-copilot-studio-bot/"]
  }
}
```
