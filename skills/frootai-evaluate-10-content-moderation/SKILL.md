---
name: frootai-evaluate-10-content-moderation
description: 'Runs quality evaluation for Play 10-content-moderation against fai-manifest.json guardrails — groundedness, coherence, safety.'
---

# Fai Evaluate 10 Content Moderation

Runs quality evaluation for Play 10-content-moderation against fai-manifest.json guardrails — groundedness, coherence, safety.

## Overview

This skill provides a structured, repeatable procedure for runs quality evaluation for play 10-content-moderation against fai-manifest.json guardrails — groundedness, coherence, safety.. It can be used standalone as a LEGO block or auto-wired inside solution plays via the FAI Protocol.
...
Perform the primary operation: runs quality evaluation for play 10-content-moderation against fai-manifest.json guardrails — groundedness, coherence, safety..
...
npx frootai skill run frootai-evaluate-10-content-moderation
```
...
{
  "primitives": {
    "skills": ["skills/frootai-evaluate-10-content-moderation/"]
  }
}
```
