---
name: frootai-tune-11-ai-landing-zone-advanced
...
npx frootai skill run frootai-tune-11-ai-landing-zone-advanced
```
...
{
  "primitives": {
    "skills": ["skills/frootai-tune-11-ai-landing-zone-advanced/"]
  }
}
```
