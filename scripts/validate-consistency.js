...
const expectedURLs = {
  ...
  'GitHub repo': 'https://github.com/gitpavleenbali/frootai',
  'Docker image': 'ghcr.io/gitpavleenbali/frootai-mcp',
};
...
if (mcpPkg?.repository?.url !== 'https://github.com/gitpavleenbali/frootai') {
  check('npm repository', mcpPkg?.repository?.url || 'missing', 'https://github.com/gitpavleenbali/frootai', 'mcp-server/package.json');
}
