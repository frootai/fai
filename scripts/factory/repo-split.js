...
const IP_CLASSIFICATION = {
  ...
  'vscode-extension/':    { class: 'private',   rationale: 'VS Code extension — premium developer experience', license: 'Proprietary' },
  'npm-mcp/':             { class: 'private',   rationale: 'MCP server — 25+ tools, knowledge bundling intelligence', license: 'Proprietary' },
  'npm-sdk/':             { class: 'private',   rationale: 'JavaScript SDK — consumption wrapper', license: 'Proprietary' },
  'python-mcp/':          { class: 'private',   rationale: 'Python MCP server', license: 'Proprietary' },
  'python-sdk/':          { class: 'private',   rationale: 'Python SDK — consumption wrapper + FAI Engine port', license: 'Proprietary' },
  'cli/':                 { class: 'private',   rationale: 'FAI CLI — developer tooling', license: 'Proprietary' },
  'sdk/':                 { class: 'private',   rationale: 'SDK shared utilities', license: 'Proprietary' },
  ...
  'functions/':           { class: 'private',   rationale: 'Azure Functions — chatbot backend', license: 'Proprietary' },
  'config/':              { class: 'private',   rationale: 'Internal configuration', license: 'Proprietary' },
  ...
  'marketplace/':         { class: 'private',   rationale: 'Marketplace UI/generation', license: 'Proprietary' },
