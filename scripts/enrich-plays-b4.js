#!/usr/bin/env node
/**
 * enrich-plays-b4.js — Batch B4: Enrich solution plays 31-40
 * Run: node scripts/enrich-plays-b4.js
 */
const fs = require("fs");
...
// Play metadata for enrichment — B4 (plays 31-40)
const playMeta = {
  "31-low-code-ai-builder": {
    name: "Low-Code AI Builder", pattern: "Visual Pipeline Designer", model: "gpt-4o",
    services: ["Azure OpenAI", "Azure Container Apps", "Azure Cosmos DB", "Azure Static Web Apps", "Azure Functions", "Azure Monitor"],
    waf: ["security", "reliability", "cost-optimization", "operational-excellence"],
    knowledge: ["O2-Agent-Coding", "O3-MCP-Tools-Functions", "T3-Production-Patterns", "F4-GitHub-Agentic-OS"],
    domain: "drag-and-drop AI pipeline design, template library, visual agent workflow builder, one-click deployment, component marketplace, no-code/low-code AI configuration",
    tuning: "pipeline_templates, deployment_targets (container_apps/functions/static), evaluation_thresholds, component_registry, auto_scaling_rules, template_versioning",
  },
  "32-ai-powered-testing": {
    name: "AI-Powered Testing", pattern: "Autonomous Test Generation", model: "gpt-4o",
    services: ["Azure OpenAI", "GitHub Actions", "Azure Container Apps", "Azure Monitor", "Azure DevOps"],
    waf: ["security", "operational-excellence", "reliability"],
    knowledge: ["O2-Agent-Coding", "T3-Production-Patterns", "F4-GitHub-Agentic-OS"],
    domain: "unit test generation, integration test scaffolding, E2E test automation, mutation testing, polyglot support (Python/TypeScript/C#), coverage analysis, flaky test detection, test prioritization",
    tuning: "coverage_targets (80-95%), mutation_rules, framework_configs (pytest/jest/xunit), max_test_generation_per_file, flaky_detection_threshold, test_timeout_seconds",
  },
  "33-voice-ai-agent": {
    name: "Voice AI Agent", pattern: "Real-Time Voice Pipeline", model: "gpt-4o",
    services: ["Azure AI Speech", "Azure OpenAI", "Azure Communication Services", "Azure Container Apps", "Azure Content Safety", "Azure Monitor"],
    waf: ["security", "reliability", "performance-efficiency", "responsible-ai"],
    knowledge: ["F1-GenAI-Foundations", "O2-Agent-Coding", "T3-Production-Patterns"],
    domain: "speech-to-text streaming, text-to-speech synthesis, real-time intent recognition, conversational state management, DTMF handling, call transfer, multi-language support, voice biometrics",
    tuning: "voice_models (neural/standard), intent_thresholds, fallback_chains, latency_target_ms (<500), speech_language, speaking_rate, silence_timeout_ms, barge_in_enabled",
  },
  "34-edge-ai-deployment": {
    name: "Edge AI Deployment", pattern: "On-Device Inference", model: "phi-4-mini",
    services: ["Azure IoT Hub", "ONNX Runtime", "Azure Container Instances", "Azure Monitor", "Azure Key Vault", "Azure Blob Storage"],
    ...
    domain: "ONNX quantization (INT4/INT8/FP16), IoT Hub device management, OTA model updates, offline inference capability, edge-cloud sync, device fleet management, battery optimization, hardware abstraction",
    tuning: "quantization_level, sync_schedule, fallback_to_cloud_threshold, max_memory_mb, inference_batch_size, model_cache_size_mb, telemetry_interval_seconds, device_group_policy",
  },
  "35-ai-compliance-engine": {
    name: "AI Compliance Engine", pattern: "Regulatory Automation", model: "gpt-4o",
    services: ["Azure OpenAI", "Azure Policy", "Azure Key Vault", "Azure Monitor", "Azure Cosmos DB", "Azure AI Search"],
    ...
    domain: "GDPR data mapping, HIPAA audit trails, SOC 2 evidence collection, EU AI Act risk classification, automated compliance reporting, policy violation detection, remediation workflows, evidence retention",
    tuning: "compliance_frameworks (GDPR/HIPAA/SOC2/EU_AI_Act), audit_schedules, risk_thresholds (low/medium/high/critical), evidence_retention_days, remediation_sla_hours, scan_frequency",
  },
  "36-multimodal-agent": {
    name: "Multimodal Agent", pattern: "Vision+Text+Code Analysis", model: "gpt-4o",
    services: ["Azure OpenAI (GPT-4o Vision)", "Azure AI Vision", "Azure Blob Storage", "Azure Container Apps", "Azure Monitor"],
    waf: ["security", "reliability", "performance-efficiency", "cost-optimization"],
    knowledge: ["O2-Agent-Coding", "F1-GenAI-Foundations", "T3-Production-Patterns"],
    domain: "image analysis, screenshot understanding, diagram interpretation, code-from-image extraction, multi-modal routing (text vs vision vs code), document layout analysis, chart data extraction",
    tuning: "vision_prompts, image_resolution (low/high/auto), multi_modal_routing_rules, max_image_size_mb, code_extraction_language, chart_data_output_format, vision_model_version",
  },
  "37-ai-powered-devops": {
    name: "AI-Powered DevOps", pattern: "Intelligent SRE", model: "gpt-4o",
    services: ["Azure OpenAI", "Azure Monitor", "Azure DevOps", "GitHub Actions", "Azure Container Apps", "Azure Log Analytics"],
    waf: ["operational-excellence", "reliability", "security", "cost-optimization"],
    knowledge: ["T3-Production-Patterns", "O2-Agent-Coding", "O3-MCP-Tools-Functions"],
    domain: "incident triage with AI classification, automated runbook execution, deployment risk scoring, predictive scaling, change impact analysis, post-mortem generation, SLO/SLI monitoring",
    tuning: "severity_rules (P0-P4), runbook_config, scaling_thresholds (CPU/memory/queue_depth), risk_score_weights, incident_response_sla_minutes, change_window_enabled",
  },
  "38-document-understanding-v2": {
    name: "Document Understanding v2", pattern: "Advanced Document Processing", model: "gpt-4o",
    services: ["Azure AI Document Intelligence", "Azure OpenAI", "Azure Blob Storage", "Azure Cosmos DB", "Azure Functions", "Azure Monitor"],
    waf: ["security", "reliability", "performance-efficiency", "cost-optimization"],
    knowledge: ["F1-GenAI-Foundations", "T3-Production-Patterns", "R2-RAG-Architecture"],
    domain: "multi-page PDF processing, cross-page table relationships, handwriting recognition, entity linking across documents, invoice/receipt parsing, contract clause extraction, layout analysis",
    tuning: "extraction_schemas, confidence_thresholds (0.7-0.95), entity_types, page_batch_size, cross_reference_enabled, handwriting_model_version, output_format (JSON/CSV)",
  },
  "39-ai-meeting-assistant": {
    name: "AI Meeting Assistant", pattern: "Meeting Intelligence", model: "gpt-4o",
    services: ["Azure AI Speech", "Azure OpenAI", "Microsoft Graph", "Azure Container Apps", "Azure Cosmos DB", "Azure Monitor"],
    waf: ["security", "reliability", "cost-optimization", "responsible-ai"],
    knowledge: ["F1-GenAI-Foundations", "O6-Copilot-Ecosystem", "T3-Production-Patterns"],
    domain: "real-time transcription, speaker diarization, action item extraction, decision tracking, follow-up scheduling via Graph API, meeting summary generation, sentiment analysis, topic segmentation",
    tuning: "transcription_config (language/accuracy), action_item_rules, follow_up_scheduling_enabled, summary_length (short/detailed), sentiment_enabled, diarization_speaker_count, pii_redaction_in_transcript",
  },
  "40-copilot-studio-advanced": {
    name: "Copilot Studio Advanced", pattern: "Enterprise Copilot Plugin", model: "gpt-4o",
    services: ["Microsoft Copilot Studio", "Azure OpenAI", "Dataverse", "Microsoft Graph", "Power Platform", "Azure Key Vault"],
    waf: ["security", "reliability", "cost-optimization", "operational-excellence"],
    knowledge: ["O6-Copilot-Ecosystem", "F4-GitHub-Agentic-OS", "O2-Agent-Coding"],
    domain: "declarative agents with TypeSpec, API plugins for M365, SSO/OAuth2 integration, Graph API data grounding, adaptive card responses, multi-turn conversation management, permission scoping, admin controls",
    tuning: "agent_config (declarative_schema), permission_scopes, adaptive_card_templates, multi_turn_rules, escalation_triggers, graph_api_batch_size, admin_policy_overrides, token_refresh_interval",
  },
};
