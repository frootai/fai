#!/usr/bin/env node
/**
 * enrich-plays-b1.js — Batch B1: Enrich solution plays 01-10
 * 
 * Enriches builder.agent.md, reviewer.agent.md, tuner.agent.md,
 * copilot-instructions.md, *-patterns.instructions.md, and agent.md
 * to production quality (200+ lines each).
 * 
 * Run: node scripts/enrich-plays-b1.js
 */
const fs = require("fs");
...
// Play metadata for enrichment
const playMeta = {
    "01-enterprise-rag": {
        name: "Enterprise RAG Q&A", pattern: "RAG", model: "gpt-4o",
        ...
        tuning: "temperature=0.1, top-k=5, chunk_size=512, hybrid_weight=0.6, reranker=semantic, relevance_threshold=0.78",
    },
    "02-ai-landing-zone": {
        name: "AI Landing Zone", pattern: "Infrastructure", model: "gpt-4o",
        services: ["Azure VNet", "Azure Private Endpoints", "Azure Key Vault", "Azure RBAC", "Azure Policy", "Azure Monitor", "GPU Quota"],
        waf: ["security", "reliability", "cost-optimization", "operational-excellence"],
        knowledge: ["O5-GPU-Infra", "T3-Production-Patterns"],
        domain: "networking, identity, private endpoints, managed identity, hub-spoke topology, GPU quota management",
        tuning: "VNet CIDR, subnet configuration, service SKUs, GPU quota, region selection, NSG rules",
    },
    "03-deterministic-agent": {
        name: "Deterministic Agent", pattern: "Zero-Temperature Agent", model: "gpt-4o",
        services: ["Azure Container Apps", "Azure OpenAI", "Azure Content Safety", "Azure Key Vault", "Azure Monitor"],
        waf: ["security", "reliability", "responsible-ai"],
        knowledge: ["R3-Deterministic-AI", "O2-Agent-Coding"],
        domain: "zero-temperature inference, seed pinning, structured JSON output, anti-sycophancy, confidence scoring, multi-layer guardrails",
        tuning: "temperature=0, seed=42, JSON schema validation, confidence_threshold=0.7, max_retries=3",
    },
    "04-call-center-voice-ai": {
        name: "Call Center Voice AI", pattern: "Voice Pipeline", model: "gpt-4o",
        services: ["Azure Communication Services", "Azure AI Speech", "Azure OpenAI", "Azure Container Apps", "Azure Content Safety"],
        waf: ["security", "reliability", "cost-optimization", "responsible-ai"],
        knowledge: ["F1-GenAI-Foundations", "R2-RAG-Architecture"],
        domain: "speech-to-text, text-to-speech, real-time streaming, intent recognition, call routing, escalation, PII redaction",
        tuning: "speech_language, speech_speed, grounding_prompts, fallback_chains, latency_targets, audio_encoding",
    },
    "05-it-ticket-resolution": {
        name: "IT Ticket Resolution", pattern: "Event-Driven Automation", model: "gpt-4o-mini",
        services: ["Azure Logic Apps", "Azure OpenAI", "Azure App Service", "Azure Service Bus", "ServiceNow MCP"],
        waf: ["security", "reliability", "cost-optimization"],
        knowledge: ["R2-RAG-Architecture", "O1-Semantic-Kernel"],
        domain: "ticket classification, routing, auto-resolution, ITSM integration, ServiceNow, confidence scoring, escalation",
        tuning: "classification_prompts, routing_rules, confidence_thresholds, escalation_criteria, batch_size",
    },
    "06-document-intelligence": {
        name: "Document Intelligence", pattern: "OCR+LLM Extraction", model: "gpt-4o",
        services: ["Azure Document Intelligence", "Azure OpenAI", "Azure Blob Storage", "Azure Cosmos DB", "Azure Key Vault"],
        waf: ["security", "reliability", "cost-optimization", "performance-efficiency"],
        knowledge: ["F1-GenAI-Foundations", "T3-Production-Patterns"],
        domain: "OCR, form extraction, table recognition, handwriting, multi-page PDF, structured JSON output, PII masking",
        tuning: "extraction_prompts, confidence_thresholds, field_schemas, document_classification_rules, page_ranges",
    },
    "07-multi-agent-service": {
        name: "Multi-Agent Service", pattern: "Supervisor-Specialist", model: "gpt-4o",
        services: ["Azure OpenAI", "Azure Container Apps", "Azure Cosmos DB", "Dapr", "Azure Service Bus", "Azure Monitor"],
        waf: ["security", "reliability", "cost-optimization", "operational-excellence"],
        knowledge: ["O2-Agent-Coding", "O3-MCP-Tools-Functions", "T3-Production-Patterns"],
        domain: "supervisor agent, specialist delegation, shared state, handoff protocol, tool routing, loop prevention, memory management",
        tuning: "supervisor_routing, tool_schemas, agent_memory, max_iterations=10, delegation_rules, conflict_policy",
    },
    "08-copilot-studio-bot": {
        name: "Copilot Studio Bot", pattern: "Low-Code Bot", model: "gpt-4o-mini",
        services: ["Microsoft Copilot Studio", "Dataverse", "SharePoint", "Power Platform", "Azure OpenAI"],
        waf: ["security", "reliability", "cost-optimization"],
        knowledge: ["O6-Copilot-Ecosystem", "F4-GitHub-Agentic-OS"],
        domain: "low-code chatbot, topic design, knowledge grounding, Dataverse entities, SharePoint integration, guardrails",
        tuning: "topic_design, knowledge_sources, guardrails, multi-turn_rules, escalation_triggers, permission_scoping",
    },
    "09-ai-search-portal": {
        name: "AI Search Portal", pattern: "Hybrid Search", model: "gpt-4o",
        services: ["Azure AI Search", "Azure OpenAI", "Azure App Service", "Azure Blob Storage", "Azure Monitor"],
        waf: ["security", "reliability", "performance-efficiency", "cost-optimization"],
        knowledge: ["R2-RAG-Architecture", "T3-Production-Patterns"],
        domain: "semantic ranking, hybrid search, scoring profiles, faceted navigation, auto-suggest, answer generation",
        tuning: "hybrid_weights, semantic_config, scoring_profiles, index_schema, relevance_threshold, result_count",
    },
    "10-content-moderation": {
        name: "Content Moderation", pattern: "Safety Gateway", model: "gpt-4o-mini",
        services: ["Azure Content Safety", "Azure API Management", "Azure Functions", "Azure OpenAI", "Azure Monitor"],
        waf: ["security", "responsible-ai", "reliability"],
        knowledge: ["T2-Responsible-AI", "T3-Production-Patterns"],
        domain: "content filtering, severity scoring, custom categories, blocklists, human review, appeal workflows, multi-modal analysis",
        tuning: "severity_levels, custom_categories, blocklists, appeal_workflow, human_review_threshold, multi-modal_config",
    },
};
