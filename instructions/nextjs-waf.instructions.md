...
# Nextjs Waf — WAF-Aligned Coding Standards

> Next.js 16 App Router standards — Server Components by default, streaming with Suspense, Turbopack, Tailwind v4, static export for frootai.dev, and production optimization patterns.
