---
description: "Azure DevOps standards — YAML pipelines, environments, service connections, test management, boards."
...
Azure DevOps provides YAML pipelines, environments, service connections, test management, boards. Available tiers/modes: Pipelines, Repos, Boards, Artifacts, Test Plans.
...
## Key Patterns: multi-stage YAML, variable groups, deployment jobs, approval gates, DORA metrics
