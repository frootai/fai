---
description: "Azure Functions standards — serverless compute, triggers, bindings, durable functions, cold start optimization."
...
Azure Functions provides serverless compute, triggers, bindings, durable functions, cold start optimization. Available tiers/modes: Consumption, Premium, Dedicated, Container Apps hosting.
...
## Key Patterns: idempotent handlers, poison message handling, connection pooling, Durable Functions
