...
# Testing Best Practices — WAF-Aligned Coding Standards

> Polyglot testing standards — unit, integration, and E2E testing patterns for AI applications. Covers pytest, Vitest, xUnit, Playwright, mock strategies for LLM APIs, evaluation pipelines, and CI/CD test gates.
