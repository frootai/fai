---
description: "Azure Static Web Apps standards — static hosting, serverless API, authentication, CI/CD, custom domains."
...
Azure Static Web Apps provides static hosting, serverless API, authentication, CI/CD, custom domains. Available tiers/modes: Free, Standard tiers, linked APIs, Managed Functions.
...
## Key Patterns: Next.js/Nuxt/SvelteKit SSG, API routes, Easy Auth, split environments, preview PRs
