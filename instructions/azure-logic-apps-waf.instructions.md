---
description: "Azure Logic Apps standards — workflow automation, connectors, error handling, B2B integration."
...
Azure Logic Apps provides workflow automation, connectors, error handling, B2B integration. Available tiers/modes: Standard (stateful/stateless), Consumption, ISE (deprecated).
...
## Key Patterns: retry policies, runAfter, scope-based error handling, batching, concurrency control
