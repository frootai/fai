---
description: "Azure Cosmos DB standards — global distribution, partitioning, consistency, RU optimization, vector search."
...
Azure Cosmos DB provides global distribution, partitioning, consistency, RU optimization, vector search. Available tiers/modes: NoSQL API, Gremlin, MongoDB vCore, PostgreSQL.
...
## Key Patterns: partition key design, cross-partition queries, change feed, TTL, serverless vs provisioned
