---
description: "Azure Cache for Redis standards — caching patterns, data structures, pub/sub, clustering, security."
...
Azure Cache for Redis provides caching patterns, data structures, pub/sub, clustering, security. Available tiers/modes: Enterprise, Premium (clustering), Standard, Basic.
...
## Key Patterns: cache-aside, semantic cache, session store, pub/sub, Streams, eviction policies
