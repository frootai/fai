...
export const metadata: Metadata = {
  ...
  keywords: ["FrootAI", "AI", "MCP", "solution plays", "agents", "RAG", "Azure", "LLM", "enterprise AI", "VS Code"],
  ...
  twitter: { card: "summary_large_image", title: "FrootAI", description: "22 MCP tools, 20 solution plays, 18 knowledge modules.", images: ["/img/frootai-og.png"] },
